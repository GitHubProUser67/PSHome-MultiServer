...
namespace Blaze2SDK
{
    public static class Blaze2
    {
        ...
        static readonly TdfLegacyEncoder encoder;
        static readonly TdfLegacyDecoder decoder;
        ...
        {
            var blaze2Settings = new BlazeServerConfiguration(name, endPoint, encoder, decoder)
            {
