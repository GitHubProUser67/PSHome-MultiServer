...
namespace Blaze2SDK.Components
{
    public static class ClubsComponentBase
    {
            ...
            >
        {
            ...
            public virtual Task OnFindClubsAsyncNotificationAsync(FindClubsAsyncResult notification)
            {
                CustomLogger.LoggerAccessor.LogWarn(
                    $"[Blaze2SDK] - {GetType().FullName}: OnFindClubsAsyncNotificationAsync NOT IMPLEMENTED!"
                );
            ...
            {
                CustomLogger.LoggerAccessor.LogWarn(
                    $"[Blaze2SDK] - {GetType().FullName}: OnNewClubTickerMessageNotificationAsync NOT IMPLEMENTED!"
                );
                return Task.CompletedTask;
            }
        ...
        public class Proxy
            : BlazeProxyComponent<ClubsComponentCommand, ClubsComponentNotification, Blaze2RpcError>
        {
            public Proxy()
                : base(ClubsComponentBase.Id, ClubsComponentBase.Name) { }
