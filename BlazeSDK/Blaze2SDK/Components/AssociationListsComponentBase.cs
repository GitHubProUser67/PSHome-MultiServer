...
namespace Blaze2SDK.Components
{
    public static class AssociationListsComponentBase
    {
            ...
            >
        {
            ...
            public virtual Task<UpdateListResponse> AddUsersToListAsync(
                UpdateList request,
            ...
            public virtual Task<UpdateListResponse> RemoveUsersFromListAsync(
                UpdateList request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> ClearListAsync(
                ClearList request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<UpdateListResponse> SetUsersToListAsync(
                UpdateList request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<AssociationListInfo> GetListForUserAsync(
            ...
            public virtual Task<AssociationListCollectionInfo> GetListsAsync(
            ...
            public static Task NotifyListMemberUpdatedAsync(
                BlazeServerConnection connection,
                MemberInfo notification,
                bool waitUntilFree = false
            )
            {
                return connection.NotifyAsync(
                    AssociationListsComponentBase.Id,
                    (ushort)AssociationListsComponentNotification.NotifyListMemberUpdated,
                    notification,
                    waitUntilFree
                );
            }

            public static Task NotifyListMemberRemovedAsync(
                BlazeServerConnection connection,
                AssociationListInfo notification,
                bool waitUntilFree = false
            )
            {
                return connection.NotifyAsync(
                    AssociationListsComponentBase.Id,
                    (ushort)AssociationListsComponentNotification.NotifyListMemberRemoved,
                    notification,
                    waitUntilFree
                );
            }
            ...
            >
        {
            ...
            {
                return Connection.SendRequest<UpdateList, UpdateListResponse, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.addUsersToList,
                    request
                );
            }
            ...
            {
                return Connection.SendRequestAsync<UpdateList, UpdateListResponse, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.addUsersToList,
                    request
                );
            ...
            public UpdateListResponse RemoveUsersFromList(UpdateList request)
            {
                return Connection.SendRequest<UpdateList, UpdateListResponse, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.removeUsersFromList,
                    request
                );
            }
            ...
            {
                return Connection.SendRequest<ClearList, NullStruct, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.clearList,
                    request
                );
            }
            ...
            {
                return Connection.SendRequestAsync<ClearList, NullStruct, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.clearList,
                    request
                );
            ...
            public UpdateListResponse SetUsersToList(UpdateList request)
            {
                return Connection.SendRequest<UpdateList, UpdateListResponse, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.setUsersToList,
                    request
                );
            }
            ...
            {
                return Connection.SendRequest<GetListForUser, AssociationListInfo, NullStruct>(
                    this,
            ...
            {
                return Connection.SendRequestAsync<GetListForUser, AssociationListInfo, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.getListForUser,
                    request
                );
            ...
            {
                return Connection.SendRequest<SubscriptionInfo, NullStruct, NullStruct>(
                    this,
            ...
            {
                return Connection.SendRequestAsync<SubscriptionInfo, NullStruct, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.subscribeToLists,
                    request
                );
            ...
            public virtual Task OnNotifyListMemberUpdatedAsync(MemberInfo notification)
            {
                CustomLogger.LoggerAccessor.LogWarn(
                    $"[Blaze2SDK] - {GetType().FullName}: OnNotifyListMemberUpdatedAsync NOT IMPLEMENTED!"
                );
            ...
            {
                CustomLogger.LoggerAccessor.LogWarn(
                    $"[Blaze2SDK] - {GetType().FullName}: OnNotifyListMemberRemovedAsync NOT IMPLEMENTED!"
                );
                return Task.CompletedTask;
            }
            ...
            >
        {
            ...
            {
                return context.ClientConnection.SendRequestAsync<ClearList, NullStruct, NullStruct>(
                    this,
                    (ushort)AssociationListsComponentCommand.clearList,
                    request
                );
            ...
            public virtual Task<AssociationListInfo> OnNotifyListMemberRemovedAsync(
                AssociationListInfo notification
            )
            {
                return Task.FromResult(notification);
        ...
        public static Type GetNotificationType(
            ...
            notification switch
            {
                ...
                AssociationListsComponentNotification.NotifyListMemberRemoved =>
                    typeof(AssociationListInfo),
                _ => typeof(NullStruct),
            };
