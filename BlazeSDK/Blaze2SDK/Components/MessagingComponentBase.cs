    ...
    public static class MessagingComponentBase
    {
        ...
        public class Server
            : BlazeServerComponent<
                MessagingComponentCommand,
                MessagingComponentNotification,
                Blaze2RpcError
            >
        {
            public Server()
                : base(MessagingComponentBase.Id, MessagingComponentBase.Name) { }
            ...
            public virtual Task<FetchMessageResponse> FetchMessagesAsync(
            ...
            public virtual Task<PurgeMessageResponse> PurgeMessagesAsync(
            ...
            public virtual Task<TouchMessageResponse> TouchMessagesAsync(
            ...
            public virtual Task<NullStruct> GetMessagesAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public static Task NotifyMessageAsync(
            ...
            )
            {
                return connection.NotifyAsync(
                    ...
                    (ushort)MessagingComponentNotification.NotifyMessage,
                    notification,
                    waitUntilFree
                );
            }

            public override Type GetCommandRequestType(MessagingComponentCommand command) =>
                MessagingComponentBase.GetCommandRequestType(command);

            public override Type GetCommandResponseType(MessagingComponentCommand command) =>
                MessagingComponentBase.GetCommandResponseType(command);

            public override Type GetCommandErrorResponseType(MessagingComponentCommand command) =>
                MessagingComponentBase.GetCommandErrorResponseType(command);

            public override Type GetNotificationType(MessagingComponentNotification notification) =>
                MessagingComponentBase.GetNotificationType(notification);
        }
            ...
            >
        {
            ...
            {
                return Connection.SendRequest<ClientMessage, SendMessageResponse, NullStruct>(
                    this,
                    (ushort)MessagingComponentCommand.sendMessage,
                    request
                );
            }
            ...
            {
                return Connection.SendRequestAsync<ClientMessage, SendMessageResponse, NullStruct>(
                    this,
                    (ushort)MessagingComponentCommand.sendMessage,
                    request
                );
            ...
            public FetchMessageResponse FetchMessages(FetchMessageRequest request)
            {
                return Connection.SendRequest<
                    ...
                    NullStruct
                >(this, (ushort)MessagingComponentCommand.fetchMessages, request);
            }
            ...
            public PurgeMessageResponse PurgeMessages(PurgeMessageRequest request)
            {
                return Connection.SendRequest<
                    ...
                    NullStruct
                >(this, (ushort)MessagingComponentCommand.purgeMessages, request);
            }
            ...
            public TouchMessageResponse TouchMessages(TouchMessageRequest request)
            {
                return Connection.SendRequest<
                    TouchMessageRequest,
                    TouchMessageResponse,
                    NullStruct
                >(this, (ushort)MessagingComponentCommand.touchMessages, request);
            }
            ...
            public NullStruct GetMessages()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)MessagingComponentCommand.getMessages,
                    new NullStruct()
                );
            }
            ...
            public virtual Task OnNotifyMessageAsync(ServerMessage notification)
            {
                CustomLogger.LoggerAccessor.LogWarn(
                    $"[Blaze2SDK] - {GetType().FullName}: OnNotifyMessageAsync NOT IMPLEMENTED!"
                );
            ...
            >
        {
            ...
            )
            {
                return context.ClientConnection.SendRequestAsync<
                    ...
                    SendMessageResponse,
                    NullStruct
                >(this, (ushort)MessagingComponentCommand.sendMessage, request);
            }
            ...
            )
            {
                return context.ClientConnection.SendRequestAsync<
                    ...
                    NullStruct,
                    NullStruct
                >(this, (ushort)MessagingComponentCommand.getMessages, request);
            }
        ...
        public static Type GetCommandRequestType(MessagingComponentCommand command) =>
            command switch
            {
        ...
        public static Type GetCommandResponseType(MessagingComponentCommand command) =>
            command switch
            {
        ...
        public static Type GetCommandErrorResponseType(MessagingComponentCommand command) =>
            command switch
            {
        ...
        public static Type GetNotificationType(MessagingComponentNotification notification) =>
            notification switch
            {
