...
namespace Blaze2SDK.Components
{
    public static class AuthenticationComponentBase
    {
            ...
            >
        {
            ...
            public virtual Task<NullStruct> UpdateAccountAsync(
            ...
            public virtual Task<Entitlements> GetEntitlementsAsync(
            ...
            public virtual Task<NullStruct> GetUseCountAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> DecrementUseCountAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> GetAuthTokenAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> GetHandoffTokenAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> ListEntitlement2Async(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> StressLoginAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<NullStruct> GetPersonaAsync(
                NullStruct request,
                BlazeRpcContext context
            )
            {
            ...
            public virtual Task<PersonaDetails> DisablePersonaAsync(
            ...
            public virtual Task<SessionInfo> Ps3AssociateAccountAsync(
            ...
            >
        {
            ...
            public NullStruct UpdateAccount(UpdateAccountRequest request)
            {
                return Connection.SendRequest<UpdateAccountRequest, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.updateAccount,
                    request
                );
            }
            ...
            {
                return Connection.SendRequest<Entitlement, NullStruct, NullStruct>(
                    this,
            ...
            {
                return Connection.SendRequestAsync<Entitlement, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.grantEntitlement,
                    request
                );
            ...
            public Entitlements GetEntitlements(ListEntitlementsRequest request)
            {
                return Connection.SendRequest<ListEntitlementsRequest, Entitlements, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.getEntitlements,
                    request
                );
            }
            ...
            public Task<Entitlements> GetEntitlementsAsync(ListEntitlementsRequest request)
            {
                return Connection.SendRequestAsync<
                    ...
                    Entitlements,
                    NullStruct
                >(this, (ushort)AuthenticationComponentCommand.getEntitlements, request);
            }
            ...
            public NullStruct DecrementUseCount()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.decrementUseCount,
                    new NullStruct()
                );
            }
            ...
            public NullStruct GetHandoffToken()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.getHandoffToken,
                    new NullStruct()
                );
            }
            ...
            public NullStruct ListEntitlement2()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.listEntitlement2,
                    new NullStruct()
                );
            }
            ...
            public NullStruct StressLogin()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.stressLogin,
                    new NullStruct()
                );
            }
            ...
            {
                return Connection.SendRequest<PersonaRequest, PersonaDetails, NullStruct>(
                    this,
            ...
            {
                return Connection.SendRequestAsync<PersonaRequest, PersonaDetails, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.disablePersona,
                    request
                );
            ...
            public NullStruct XboxAssociateAccount()
            {
                return Connection.SendRequest<NullStruct, NullStruct, NullStruct>(
                    this,
                    (ushort)AuthenticationComponentCommand.xboxAssociateAccount,
                    new NullStruct()
                );
            }
            ...
            public Task<SessionInfo> Ps3AssociateAccountAsync(
                ConsoleAssociateAccountRequest request
            )
            {
                return Connection.SendRequestAsync<
            ...
            >
        {
            ...
            )
            {
                return context.ClientConnection.SendRequestAsync<
                    ...
                    NullStruct,
                    NullStruct
                >(this, (ushort)AuthenticationComponentCommand.listEntitlement2, request);
            }
            ...
            )
            {
                return context.ClientConnection.SendRequestAsync<
                    ...
                    NullStruct,
                    NullStruct
                >(this, (ushort)AuthenticationComponentCommand.stressLogin, request);
            }
