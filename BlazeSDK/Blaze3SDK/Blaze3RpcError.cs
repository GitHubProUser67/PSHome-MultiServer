namespace Blaze3SDK
{
    public enum Blaze3RpcError : int
    {
        ...
        // CardHouse
        CARDHOUSE_ERR_NO_PLAYER_INFO = 67684,
        CARDHOUSE_ERR_CARDS_UNASSIGNED = 133220,
        CARDHOUSE_ERR_PERMISSION_DENIED = 198756,
        CARDHOUSE_ERR_NO_CARD_EXISTS = 264292,
        CARDHOUSE_ERR_NOT_ENOUGH_CREDITS = 329828,
        CARDHOUSE_ERR_WAITING_FOR_COMPLETION = 395364,
        CARDHOUSE_ERR_RESERVED_007 = 460900,
        CARDHOUSE_ERR_CARD_ESCROWED = 526436,
        CARDHOUSE_ERR_BAD_POSITION = 591972,
        CARDHOUSE_ERR_NO_APPLYING_CARD = 657508,
        CARDHOUSE_ERR_NO_APPLIED_CARD = 723044,
        CARDHOUSE_ERR_PERM_APPLYING_CARD = 788580,
        CARDHOUSE_ERR_PERM_APPLIED_CARD = 854116,
        CARDHOUSE_ERR_CARD_MISMATCH = 919652,
        CARDHOUSE_ERR_ESCROW_FULL = 985188,
        CARDHOUSE_ERR_NO_SUCH_TRADE = 1050724,
        CARDHOUSE_ERR_TRADE_CANCELED = 1116260,
        CARDHOUSE_ERR_TRADE_CLOSED = 1181796,
        CARDHOUSE_ERR_TRADE_YOUR_CARD = 1247332,
        CARDHOUSE_ERR_TRADE_INACTIVE = 1312868,
        CARDHOUSE_ERR_NO_EVENT_EXISTS = 1378404,
        CARDHOUSE_ERR_PLAYER_ALREADY_IN_SWAP = 1443940,
        CARDHOUSE_ERR_PLAYER_OFFLINE = 1509476,
        CARDHOUSE_ERR_ONLINE_SWAP_CANCELED = 1575012,
        CARDHOUSE_ERR_TRADE_CARD_ALREADY_TRADED = 1640548,
        CARDHOUSE_ERR_TRADE_MISMATCH = 1706084,
        CARDHOUSE_ERR_NO_OFFER_EXISTS = 1771620,
        CARDHOUSE_ERR_OFFER_ACCEPTED = 1837156,
        CARDHOUSE_ERR_OFFER_REJECTED = 1902692,
        CARDHOUSE_ERR_OFFER_WITHDRAWN = 1968228,
        CARDHOUSE_ERR_PROFANITY_FILTER = 2033764,
        CARDHOUSE_ERR_UNASSIGNED_FULL = 2099300,
        CARDHOUSE_ERR_MAX_WATCHLIST = 2164836,
        CARDHOUSE_ERR_NO_TRANSACTION = 2230372,
        CARDHOUSE_ERR_NAME_EXISTS = 2295908,
        CARDHOUSE_ERR_PACK_LIMIT_REACHED = 2361444,
        CARDHOUSE_ERR_DELETE_LAST_SQUAD = 2623588,
        CARDHOUSE_ERR_INVALID_PARAM = 5900388,
        CARDHOUSE_ERR_EMPTY_RESULT = 5965924,
        CARDHOUSE_ERR_INVALID_USER_ID = 6031460,
        CARDHOUSE_ERR_INVALID_EVENT_ID = 6096996,
        CARDHOUSE_ERR_NOT_IMPLEMENTED = 6162532,
        CARDHOUSE_ERR_NO_POLE_DATA = 6228068,
        CARDHOUSE_ERR_NO_TOURNAMENT_DATA = 6293604,
        CARDHOUSE_ERR_TROPHY_EXISTS = 6359140,
        CARDHOUSE_ERR_NOT_ELIGIBLE_ERROR = 6424676,
        CARDHOUSE_ERR_UNKNOWN = 6490212,
        CARDHOUSE_ERR_DISCONNECT = 13109348,
        CARDHOUSE_ERR_DATABASE_ERROR = 19662948,
        CARDHOUSE_ERR_SERVER_FULL = 26216548,
        CARDHOUSE_ERR_ALREADY_LOGGEDIN_ON_CONSOLE = 27527268,
    }
}
