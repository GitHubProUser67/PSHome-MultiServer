...
namespace Blaze3SDK.Blaze
{
    public class NetworkAddress : TdfUnion
    {
        ...
        public XboxClientAddress? XboxClientAddress
        {
            get { return mXboxClientAddress; }
            set { SetValue(value); }
        }

        [TdfUnion(1)]
        private XboxServerAddress? mXboxServerAddress;
        public XboxServerAddress? XboxServerAddress
        {
            get { return mXboxServerAddress; }
            set { SetValue(value); }
        }
        ...
        public HostNameAddress? HostNameAddress
        {
            get { return mHostNameAddress; }
            set { SetValue(value); }
        }
    }
}
