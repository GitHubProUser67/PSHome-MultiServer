namespace CastleLibrary.NetHasher.CRC
{
    ...
    {
        private const ushort _ccittInitialValue = 7439;

        private static readonly ushort[] _ccitt_hash =
        [
            0,
            0x1021,
            0x2042,
        ...
        public static ushort Create(byte[] data, int offset, int length)
        {
            ...
            var crc = _ccittInitialValue;

            for (var i = offset; i < length; i++)
                crc = (ushort)((crc << 8) ^ _ccitt_hash[(crc >> 8) ^ data[i]]);
