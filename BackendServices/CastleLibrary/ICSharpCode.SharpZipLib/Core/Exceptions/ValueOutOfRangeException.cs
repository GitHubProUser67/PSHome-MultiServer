...
namespace CastleLibrary.ICSharpCode.SharpZipLib.Core.Exceptions
{
    /// <summary>
    ...
    public class ValueOutOfRangeException : StreamDecodingException
    {
        ...
        public ValueOutOfRangeException(string nameOfValue)
            : base($"[ValueOutOfRangeException] - {nameOfValue} out of range") { }
        ...
        public ValueOutOfRangeException(
            ...
            : base($"[ValueOutOfRangeException] - {nameOfValue} out of range: {value}, should be {minValue}..{maxValue}") { }
