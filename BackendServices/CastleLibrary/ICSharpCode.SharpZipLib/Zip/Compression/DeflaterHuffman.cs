    ...
    public class DeflaterHuffman
    {
        ...
        private class Tree
        {
            ...
            public void CheckEmpty()
            {
                ...
                if (!empty)
                    throw new SharpZipBaseException("[DeflaterHuffman] - !Empty");
            }
            ...
            public void BuildTree()
            {
                ...
                */
                ...
                if (heap[0] != childs.Length / 2 - 1)
                    throw new SharpZipBaseException("[DeflaterHuffman] - Heap invariant violated");
