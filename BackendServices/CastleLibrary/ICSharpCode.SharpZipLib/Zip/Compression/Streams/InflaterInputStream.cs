...
namespace CastleLibrary.ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
    ...
    public class InflaterInputBuffer : IDisposable
    {
        ...
        private readonly bool isRawDataOwnedByArrayPool = false;
    ...
    public class InflaterInputStream : Stream
    {
        ...
        protected void Fill()
        {
            ...
            if (inputBuffer.Available <= 0)
            {
                inputBuffer.Fill();
                if (inputBuffer.Available <= 0)
                    throw new SharpZipBaseException("[InflaterInputStream] - Unexpected EOF");
            }
        ...
        {
            throw new NotSupportedException("[InflaterInputStream] - Seek not supported");
        }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            if (inf.IsNeedingDictionary)
                throw new SharpZipBaseException("[InflaterInputStream] - Need a dictionary");
            ...
            while (true)
            {
                ...
                if (inf.IsNeedingInput)
                    ...
                    throw new ZipException("[InflaterInputStream] - Invalid input data");
            }
