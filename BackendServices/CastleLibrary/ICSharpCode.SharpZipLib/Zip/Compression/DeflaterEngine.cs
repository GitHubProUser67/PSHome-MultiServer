    ...
    public class DeflaterEngine
    {
        ...
        public void SetInput(byte[] buffer, int offset, int count)
        {
            ...
            if (inputOff < inputEnd)
                throw new InvalidOperationException("[DeflaterEngine] - Old input was not completely processed");
        ...
        private int InsertString()
        {
            ...
            int hash =
                (
                    (ins_h << DeflaterConstants.HASH_SHIFT)
                    ^ window[strstart + (DeflaterConstants.MIN_MATCH - 1)]
        ...
        private bool FindLongestMatch(int curMatch)
        {
            ...
            do
            {
                ...
                if (
                    window[match + matchLen] != scan_end
                ...
                (curMatch = (prev[curMatch & DeflaterConstants.WMASK] & ushort.MaxValue)) > limit
                && 0 != --chainLength
            );
        ...
        private bool DeflateFast(bool flush, bool finish)
        {
            ...
            while (lookahead >= DeflaterConstants.MIN_LOOKAHEAD || flush)
            {
                ...
                int hashHead;
                if (
                    lookahead >= DeflaterConstants.MIN_MATCH
