    ...
    public class WebSecurityUtils
    {
        public static string CalcuateSVOMac(string clientSVOMac)
        {
            ...
            return CastleLibrary
                .NetHasher.DotNetHasher.ComputeMD5String(
                    Encoding.ASCII.GetBytes($"{clientSVOMac}sp9ck0348sld00000000000000000000")
                )
                .ToLower();
        }
        ...
        public static string CalcuateOTGSecuredHash(string keytohash)
        {
            return CastleLibrary
                .NetHasher.DotNetHasher.ComputeMD5String(
                    Encoding.ASCII.GetBytes(keytohash),
                    Encoding.ASCII.GetBytes("ca91f51f-a7f5-4b95-814a-5796cfff586c")
                )
                .ToLower();
        }
    }
