    ...
    internal class AppLoader
    {
        ...
        )
        {
            ...
            LoggerAccessor.LogInfo(
                "[PS3 Creator] - AppLoader - ERK:  " + calculatedKey.BytesToHexStr()
            );
            LoggerAccessor.LogInfo(
                "[PS3 Creator] - AppLoader - IV:   " + calculatedIV.BytesToHexStr()
            );
            LoggerAccessor.LogInfo(
                "[PS3 Creator] - AppLoader - HASH: " + calculatedHash.BytesToHexStr()
            );
#endif
...
#if DEBUG
                    LoggerAccessor.LogInfo(
                        "[PS3 Creator] - AppLoader - MODE: Decryption Algorithm NONE"
                    );
#endif
                    break;
                case 0x02:
...
#if DEBUG
                    LoggerAccessor.LogInfo(
                        "[PS3 Creator] - AppLoader - MODE: Decryption Algorithm AESCBC128"
                    );
#endif
                    break;
                default:
