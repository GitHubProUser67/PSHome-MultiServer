...
namespace Org.BouncyCastle.Tls
{
    ...
    public class TlsSrpKeyExchange : AbstractTlsKeyExchange
    {
        ...
        public override byte[] GenerateServerKeyExchange()
        {
            ...
            ServerSrpParams srpParams = new ServerSrpParams(
                ng[0],
                ng[1],
                m_srpLoginParameters.Salt,
                B
            );
            ...
            {
                TlsUtilities.GenerateServerKeyExchangeSignature(
                    m_context,
                    m_serverCredentials,
                    digestBuffer
                );
        ...
        public override void ProcessServerKeyExchange(Stream input)
        {
            ...
            {
                TlsUtilities.VerifyServerKeyExchangeSignature(
                    m_context,
                    input,
                    m_serverCertificate,
                    digestBuffer
        ...
        public override void ProcessClientKeyExchange(Stream input)
        {
             ...
             * A % N = 0.
             */
            m_srpPeerCredentials = ValidatePublicValue(
                m_srpLoginParameters.Config.GetExplicitNG()[0],
                TlsSrpUtilities.ReadSrpParameter(input)
            );

            m_context.SecurityParameters.m_srpIdentity = Arrays.Clone(
                m_srpLoginParameters.Identity
            );
        }
