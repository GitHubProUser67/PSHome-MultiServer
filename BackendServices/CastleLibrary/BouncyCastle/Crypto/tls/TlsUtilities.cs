...
namespace Org.BouncyCastle.Tls
{
    public abstract class TlsUtilities
    {
        ...
        private static readonly Dictionary<string, SignatureAndHashAlgorithm> CertSigAlgOids =
            CreateCertSigAlgOids();
        private static readonly List<SignatureAndHashAlgorithm> DefaultSupportedSigAlgs =
        ...
        )
        {
            AddCertSigAlgOid(
                d,
                oid,
                SignatureAndHashAlgorithm.GetInstance(hashAlgorithm, signatureAlgorithm)
            );
        }
        ...
        private static Dictionary<string, SignatureAndHashAlgorithm> CreateCertSigAlgOids()
        {
            ...
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.DsaWithSha224,
                HashAlgorithm.sha224,
                SignatureAlgorithm.dsa
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.DsaWithSha256,
                HashAlgorithm.sha256,
                SignatureAlgorithm.dsa
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.DsaWithSha384,
                HashAlgorithm.sha384,
                SignatureAlgorithm.dsa
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.DsaWithSha512,
            ...
            AddCertSigAlgOid(
                d,
                X9ObjectIdentifiers.ECDsaWithSha1,
                HashAlgorithm.sha1,
            ...
            AddCertSigAlgOid(
                d,
                X9ObjectIdentifiers.ECDsaWithSha256,
                HashAlgorithm.sha256,
                SignatureAlgorithm.ecdsa
            );
            AddCertSigAlgOid(
            ...
            AddCertSigAlgOid(
                d,
                X9ObjectIdentifiers.IdDsaWithSha1,
                HashAlgorithm.sha1,
                SignatureAlgorithm.dsa
            );
            ...
            AddCertSigAlgOid(
                ...
                SignatureAndHashAlgorithm.mldsa65
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_ml_dsa_87,
                SignatureAndHashAlgorithm.mldsa87
            );

            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_128s,
                SignatureAndHashAlgorithm.slhdsa_sha2_128s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_128f,
                SignatureAndHashAlgorithm.slhdsa_sha2_128f
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_192s,
                SignatureAndHashAlgorithm.slhdsa_sha2_192s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_192f,
                SignatureAndHashAlgorithm.slhdsa_sha2_192f
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_256s,
                SignatureAndHashAlgorithm.slhdsa_sha2_256s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_sha2_256f,
                SignatureAndHashAlgorithm.slhdsa_sha2_256f
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_128s,
                SignatureAndHashAlgorithm.slhdsa_shake_128s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_128f,
                SignatureAndHashAlgorithm.slhdsa_shake_128f
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_192s,
                SignatureAndHashAlgorithm.slhdsa_shake_192s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_192f,
                SignatureAndHashAlgorithm.slhdsa_shake_192f
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_256s,
                SignatureAndHashAlgorithm.slhdsa_shake_256s
            );
            AddCertSigAlgOid(
                d,
                NistObjectIdentifiers.id_slh_dsa_shake_256f,
                SignatureAndHashAlgorithm.slhdsa_shake_256f
            );
        ...
        private static List<SignatureAndHashAlgorithm> CreateDefaultSupportedSigAlgs()
        {
            ...
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha384, SignatureAlgorithm.rsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha512, SignatureAlgorithm.rsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha256, SignatureAlgorithm.dsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha384, SignatureAlgorithm.dsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha512, SignatureAlgorithm.dsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(
                    HashAlgorithm.sha224,
            ...
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha224, SignatureAlgorithm.rsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha224, SignatureAlgorithm.dsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.ecdsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.rsa)
            );
            result.Add(
                SignatureAndHashAlgorithm.GetInstance(HashAlgorithm.sha1, SignatureAlgorithm.dsa)
            );
            return result;
        }
        ...
        {
            return ProtocolVersion.TLSv10.IsEqualOrEarlierVersionOf(
                version.GetEquivalentTlsVersion()
            );
        }
        ...
        {
            return ProtocolVersion.TLSv11.IsEqualOrEarlierVersionOf(
                version.GetEquivalentTlsVersion()
            );
        }
        ...
        {
            return ProtocolVersion.TLSv12.IsEqualOrEarlierVersionOf(
                version.GetEquivalentTlsVersion()
            );
        }
        ...
        {
            return ProtocolVersion.TLSv13.IsEqualOrEarlierVersionOf(
                version.GetEquivalentTlsVersion()
            );
        }
        ...
        {
            return new byte[] { (byte)version.MajorVersion, (byte)version.MinorVersion };
        }
        ...
        public static T ReadBerEncoding<T>(
            byte[] berEncoding,
            Func<Asn1Encodable, T> optionalConstructor
        )
            where T : Asn1Encodable
        {
            var asn1Object = ReadAsn1Object(berEncoding);
            return optionalConstructor(asn1Object)
                ?? throw new TlsFatalAlert(AlertDescription.decode_error);
        }

        public static T ReadDerEncoding<T>(
            byte[] derEncoding,
            Func<Asn1Encodable, T> optionalConstructor
        )
            where T : Asn1Encodable
        ...
        public static SignatureAndHashAlgorithm GetDefaultSignatureAlgorithm(
            short signatureAlgorithm
        )
        {
            /*
        ...
        {
            SignatureAndHashAlgorithm sigAndHashAlg = GetDefaultSignatureAlgorithm(
                signatureAlgorithm
            );

            return null == sigAndHashAlg
                ? new List<SignatureAndHashAlgorithm>()
                : VectorOfOne(sigAndHashAlg);
        }
        ...
        public static byte[] GetExtensionData(
        ...
        public static TlsSession ImportSession(
            byte[] sessionID,
        ...
        {
            return null != version
                && ProtocolVersion.TLSv12.IsEqualOrEarlierVersionOf(
                    version.GetEquivalentTlsVersion()
                );
        }
        ...
        )
        {
            ...
            )
            {
                throw new ArgumentException(
                    "must have length from 1 to (2^15 - 1)",
        ...
        /// <exception cref="IOException"/>
        public static IList<SignatureAndHashAlgorithm> ParseSupportedSignatureAlgorithms(
            Stream input
        )
        {
            // supported_signature_algorithms
        ...
        /// <exception cref="IOException"/>
        internal static void Verify12SignatureAlgorithm(
        ...
        )
        {
            if (signatureAlgorithm != null)
            {
                ...
                if (
                    SignatureScheme.IsMLDsaScheme(signatureScheme)
        ...
        public static byte[] Clone(byte[] data) =>
            null == data ? null
            : data.Length == 0 ? EmptyBytes
            : (byte[])data.Clone();

        public static string[] Clone(string[] s) =>
            null == s ? null
            : s.Length < 1 ? EmptyStrings
            : (string[])s.Clone();
        ...
        )
        {
            ...
            if (sigAlgOid != null)
            {
                ...
                {
                    RsassaPssParameters pssParams = RsassaPssParameters.GetInstance(
        ...
        public static byte[] CalculateExporterSeed(
            SecurityParameters securityParameters,
            byte[] context
        )
        {
            byte[] cr = securityParameters.ClientRandom,
                sr = securityParameters.ServerRandom;
            if (null == context)
                return Arrays.Concatenate(cr, sr);

            if (!IsValidUint16(context.Length))
                throw new ArgumentException(
                    "must have length less than 2^16 (or be null)",
                    "context"
                );
        ...
        {
            TlsSecret finishedKey = TlsCryptoUtilities.HkdfExpandLabel(
                baseKey,
                prfCryptoHashAlgorithm,
                "finished",
                EmptyBytes,
        ...
        internal static TlsSecret CalculateMasterSecret(
            TlsContext context,
            TlsSecret preMasterSecret
        )
        {
        ...
        )
        {
            ...
            TlsSecret binderKey = DeriveSecret(
                pskCryptoHashAlgorithm,
                prfHashLength,
                earlySecret,
                label,
                emptyTranscriptHash
        ...
        )
        {
            ...
            return Prf(securityParameters, master_secret, asciiLabel, prfHash, verify_data_length)
                .Extract();
        }
        ...
        )
        {
            ...
            TlsSecret handshakeSecret = DeriveSecret(
                    securityParameters,
                    earlySecret,
                    "derived",
                    emptyTranscriptHash
            ...
            TlsSecret masterSecret = DeriveSecret(
                    securityParameters,
                    handshakeSecret,
                    "derived",
                    emptyTranscriptHash
        ...
        )
        {
            ...
            securityParameters.m_trafficSecretClient = DeriveSecret(
                securityParameters,
                phaseSecret,
                clientLabel,
                transcriptHash
            ...
            if (null != serverLabel)
            {
                securityParameters.m_trafficSecretServer = DeriveSecret(
                    securityParameters,
                    phaseSecret,
                    serverLabel,
                    transcriptHash
        ...
        )
        {
            ...
            securityParameters.m_exporterMasterSecret = DeriveSecret(
                securityParameters,
                phaseSecret,
                "exp master",
                serverFinishedTranscriptHash
        ...
        )
        {
            ...
            securityParameters.m_earlyExporterMasterSecret = DeriveSecret(
                securityParameters,
                phaseSecret,
                "e exp master",
                clientHelloTranscriptHash
        ...
        private static void Update13TrafficSecret(TlsContext context, bool forServer)
        {
            ...
            else
            {
                ...
                securityParameters.m_trafficSecretClient = Update13TrafficSecret(
                    securityParameters,
                    current
                );
            }
        ...
        {
            return TlsCryptoUtilities.HkdfExpandLabel(
                secret,
                securityParameters.PrfCryptoHashAlgorithm,
                "traffic upd",
                EmptyBytes,
                securityParameters.PrfHashLength
            );
        }
        ...
        public static DerObjectIdentifier GetOidForHashAlgorithm(short hashAlgorithm)
        {
            switch (hashAlgorithm)
            {
                ...
                default:
                    throw new ArgumentException(
                        "invalid HashAlgorithm: " + HashAlgorithm.GetText(hashAlgorithm)
                    );
            }
        }
        ...
        )
        {
            ...
            TlsHash h =
                algorithm == null ? new CombinedHash(crypto) : CreateHash(crypto, algorithm);
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    hash = handshakeHash.GetFinalHash(
                        SignatureScheme.GetCryptoHashAlgorithm(clientAuthAlgorithm)
                    );
                }
        ...
        )
        {
            SignatureAndHashAlgorithm signatureAndHashAlgorithm =
                credentialedSigner.SignatureAndHashAlgorithm;
            ...
            byte[] signature = Generate13CertificateVerify(
                context.Crypto,
                credentialedSigner,
                contextString,
                handshakeHash,
        ...
        )
        {
            ...
            if (null == sigAndHashAlg)
            {
                ...
                CheckClientCertificateType(
                    certificateRequest,
                    GetLegacyClientCertType(signatureAlgorithm),
            ...
            else
            {
                ...
                VerifySupportedSignatureAlgorithm(
                    securityParameters.ServerSigAlgs,
                    sigAndHashAlg,
                    AlertDescription.illegal_parameter
                );
                ...
                CheckClientCertificateType(
                    certificateRequest,
                    SignatureAlgorithm.GetClientCertificateType(signatureAlgorithm),
                    AlertDescription.illegal_parameter
                );
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        hash = handshakeHash.GetFinalHash(
                            SignatureScheme.GetCryptoHashAlgorithm(sigAndHashAlg)
                        );
                    }
                    else
                    {
        ...
        )
        {
            ...
            try
            {
                ...
                SignatureAndHashAlgorithm algorithm = SignatureScheme.GetSignatureAndHashAlgorithm(
                    signatureScheme
                );
                VerifySupportedSignatureAlgorithm(
                    supportedAlgorithms,
        ...
        )
        {
             ...
             * RFC 5246 4.7. digitally-signed element needs SignatureAndHashAlgorithm from TLS 1.2
             */
            SignatureAndHashAlgorithm algorithm = GetSignatureAndHashAlgorithm(
        ...
        )
        {
            ...
            else
            {
                ...
                if (
                    !IsValidSignatureAlgorithmForServerKeyExchange(
                        signatureAlgorithm,
                ...
                VerifySupportedSignatureAlgorithm(
                    securityParameters.ClientSigAlgs,
                    sigAndHashAlg,
                    AlertDescription.illegal_parameter
                );
            }
        ...
        {
            int cryptoHashAlgorithm = SignatureScheme.GetCryptoHashAlgorithm(
                signatureAndHashAlgorithm
            );
        ...
        {
            foreach (
                SignatureAndHashAlgorithm signatureAndHashAlgorithm in supportedSignatureAlgorithms
            )
            {
                int cryptoHashAlgorithm = SignatureScheme.GetCryptoHashAlgorithm(
                    signatureAndHashAlgorithm
        ...
        public static bool IsAeadCipherSuite(int cipherSuite) =>
            CipherType.aead == GetCipherType(cipherSuite);

        /// <exception cref="IOException"/>
        public static bool IsBlockCipherSuite(int cipherSuite) =>
            CipherType.block == GetCipherType(cipherSuite);

        /// <exception cref="IOException"/>
        public static bool IsStreamCipherSuite(int cipherSuite) =>
            CipherType.stream == GetCipherType(cipherSuite);
        ...
        public static bool IsValidCipherSuiteForSignatureAlgorithms(
            int cipherSuite,
            IList<short> sigAlgs
        )
        {
        ...
        )
        {
            ...
            return IsValidSignatureAlgorithmForServerKeyExchange(
                signatureAlgorithm,
                keyExchangeAlgorithm
            );
        }
        ...
        {
            return ChooseSignatureAndHashAlgorithm(
                context.ServerVersion,
                sigHashAlgs,
                signatureAlgorithm
            );
        ...
        )
        {
            ...
            int count = 0,
                limit = System.Math.Min(ordered.Length, unordered.Length);
            int[] candidates = new int[limit];
            for (int i = 0; i < ordered.Length; ++i)
            {
                int candidate = ordered[i];
                if (
                    !Contains(candidates, 0, count, candidate)
                    && Arrays.Contains(unordered, candidate)
                )
                {
        ...
        private static TlsKeyExchange CreateKeyExchangeClient(TlsClient client, int keyExchange)
        {
            ...
            {
                case KeyExchangeAlgorithm.DH_anon:
                    return factory.CreateDHanonKeyExchangeClient(
                        keyExchange,
                ...
                case KeyExchangeAlgorithm.DHE_DSS:
                case KeyExchangeAlgorithm.DHE_RSA:
                    return factory.CreateDheKeyExchangeClient(
                        keyExchange,
                        client.GetDHGroupVerifier()
                    );
                ...
                case KeyExchangeAlgorithm.DHE_PSK:
                    return factory.CreatePskKeyExchangeClient(
                        keyExchange,
                        client.GetPskIdentity(),
                        client.GetDHGroupVerifier()
                    );
                ...
                case KeyExchangeAlgorithm.SRP_DSS:
                case KeyExchangeAlgorithm.SRP_RSA:
                    return factory.CreateSrpKeyExchangeClient(
                        keyExchange,
                        client.GetSrpIdentity(),
        ...
        private static TlsKeyExchange CreateKeyExchangeServer(TlsServer server, int keyExchange)
        {
            ...
            switch (keyExchange)
            {
                ...
                case KeyExchangeAlgorithm.ECDH_anon:
                    return factory.CreateECDHanonKeyExchangeServer(
                        keyExchange,
                ...
                case KeyExchangeAlgorithm.ECDHE_ECDSA:
                case KeyExchangeAlgorithm.ECDHE_RSA:
                    return factory.CreateECDheKeyExchangeServer(
                        keyExchange,
                        server.GetECDHConfig()
                    );
                ...
                case KeyExchangeAlgorithm.DHE_PSK:
                    return factory.CreatePskKeyExchangeServer(
                        keyExchange,
                        server.GetPskIdentityManager(),
                        server.GetDHConfig(),
                        null
                    );
                ...
                case KeyExchangeAlgorithm.SRP_DSS:
                case KeyExchangeAlgorithm.SRP_RSA:
                    return factory.CreateSrpKeyExchangeServer(
                        keyExchange,
                        server.GetSrpLoginParameters()
                    );
        ...
        {
            SecurityParameters securityParameters = clientContext.SecurityParameters;
            TlsKeyExchange keyExchange = CreateKeyExchangeClient(
                client,
        ...
        {
            SecurityParameters securityParameters = serverContext.SecurityParameters;
            TlsKeyExchange keyExchange = CreateKeyExchangeServer(
                server,
                securityParameters.KeyExchangeAlgorithm
            );
        ...
        internal static TlsCipher InitCipher(TlsContext context)
        {
            ...
            return context.Crypto.CreateCipher(
        ...
        private static void CheckSigAlgOfClientCerts(
            TlsContext context,
            TlsCertificate[] clientCertPath
        )
        {
            SecurityParameters securityParameters = context.SecurityParameters;
            ...
            for (int i = 0; i < trustAnchorPos; ++i)
            {
                ...
                else if (null == serverSigAlgsCert)
                {
                    ...
                    if (null != clientCertTypes)
                    {
                        ...
                        {
                            short signatureAlgorithm = GetLegacySignatureAlgorithmClientCert(
                                clientCertTypes[j]
                            );
        ...
        private static void CheckSigAlgOfServerCerts(
            TlsContext context,
            TlsCertificate[] serverCertPath
        )
        {
            SecurityParameters securityParameters = context.SecurityParameters;
             ...
             */
            if (
                clientSigAlgs == clientSigAlgsCert
                || IsTlsV13(securityParameters.NegotiatedVersion)
            )
            {
                clientSigAlgs = null;
            }
            ...
            for (int i = 0; i < trustAnchorPos; ++i)
            {
                ...
                else
                {
                     ...
                     */
                    valid =
                        ContainsSignatureAlgorithm(clientSigAlgsCert, sigAndHashAlg)
                        || (
                            null != clientSigAlgs
                            && ContainsSignatureAlgorithm(clientSigAlgs, sigAndHashAlg)
                        );
                }
        ...
        )
        {
             ...
             */
            byte[] tlsFeatures = serverCertificate
                .GetCertificateAt(0)
                .GetExtension(TlsObjectIdentifiers.id_pe_tlsfeature);
            if (tlsFeatures != null)
            {
                // TODO[tls] Proper ASN.1 type class for this extension?
                Asn1Sequence tlsFeaturesSeq = ReadDerEncoding(
                    derEncoding: tlsFeatures,
                    Asn1Sequence.GetOptional
                );
                ...
                {
                    if (
                        tlsFeature.TryGetIntValueExact(out int extensionType)
                        && IsValidUint16(extensionType)
                    )
                    {
                        if (
        ...
        )
        {
            ...
            if (null != sigAlgOid)
            {
                ...
                if (null != pssParams)
                {
                    ...
                    {
                        if (
                            issuerCert.SupportsSignatureAlgorithmCA(
        ...
        )
        {
            ...
            certificateRequest = NormalizeCertificateRequest(
                certificateRequest,
                validClientCertificateTypes
            );
        ...
        /// <exception cref="IOException"/>
        internal static TlsCredentialedAgreement RequireAgreementCredentials(
        ...
        /// <exception cref="IOException"/>
        internal static TlsCredentialedDecryptor RequireDecryptorCredentials(
            TlsCredentials credentials
        )
        {
        ...
        )
        {
            SecurityParameters securityParameters = clientContext.SecurityParameters;
            if (
                KeyExchangeAlgorithm.IsAnonymous(securityParameters.KeyExchangeAlgorithm)
        ...
        )
        {
             ...
             */
            if (
                !IsTlsV13(clientContext.ClientVersion)
            ...
            var supportedGroups = TlsExtensionsUtilities.GetSupportedGroupsExtension(
                clientExtensions
            );
        ...
        private static void CollectKeyShares(
            ...
            Dictionary<int, TlsAgreement> clientAgreements,
            List<KeyShareEntry> clientShares
        )
        {
            ...
            {
                if (
                    !keyShareGroups.Contains(supportedGroup)
        ...
        internal static TlsAgreement CreateKeyShare(
            TlsCrypto crypto,
            int keyShareGroup,
            bool isServer
        )
        ...
        private static TlsAgreement CreateKeyShareSimple(
            TlsCrypto crypto,
            int keyShareGroup,
            bool isServer
        )
            ...
            if (crypto.HasNamedGroup(keyShareGroup))
            {
                ...
                else if (NamedGroup.RefersToASpecificFiniteField(keyShareGroup))
                {
                    if (crypto.HasDHAgreement())
                        return crypto
                            .CreateDHDomain(new TlsDHConfig(keyShareGroup, padded: true))
                            .CreateDH();
                }
                else if (NamedGroup.RefersToASpecificKem(keyShareGroup))
                {
                    if (crypto.HasKemAgreement())
                        return crypto
                            .CreateKemDomain(new TlsKemConfig(keyShareGroup, isServer))
                            .CreateKem();
                }
            }
            return null;
        ...
        internal static KeyShareEntry FindEarlyKeyShare(
        ...
        internal static KeyShareEntry GetRetryKeyShare(
            IList<KeyShareEntry> clientShares,
            int keyShareGroup
        )
        {
        ...
        internal static void WriteEncryptedPms(
            TlsContext context,
            byte[] encryptedPms,
            Stream output
        )
        ...
        )
        {
            return ValidateCredentials(
                clientAuthentication.GetClientCredentials(certificateRequest)
            );
        }
        ...
        {
            securityParameters.m_clientSigAlgs =
                TlsExtensionsUtilities.GetSignatureAlgorithmsExtension(clientExtensions);
            securityParameters.m_clientSigAlgsCert =
                TlsExtensionsUtilities.GetSignatureAlgorithmsCertExtension(clientExtensions);
        }
        ...
        )
        {
            ...
            securityParameters.m_serverSigAlgsCert =
                certificateRequest.SupportedSignatureAlgorithmsCert;
        ...
        internal static void NegotiatedCipherSuite(
            SecurityParameters securityParameters,
            int cipherSuite
        )
        {
            ...
            switch (prfAlgorithm)
            {
                ...
                default:
                {
                    ...
                    securityParameters.m_prfHashLength = TlsCryptoUtilities.GetHashOutputSize(
                        prfCryptoHashAlgorithm
                    );
                    break;
                }
        ...
        internal static void NegotiatedVersionDtlsClient(
            TlsClientContext clientContext,
            TlsClient client
        )
        {
        ...
        internal static void NegotiatedVersionTlsClient(
            TlsClientContext clientContext,
            TlsClient client
        )
        {
        ...
        )
        {
            foreach (int extensionType in extensions.Keys)
            {
                if (!IsPermittedExtensionType13(handshakeType, extensionType))
                    throw new TlsFatalAlert(
                        alertDescription,
                        "Invalid extension: " + ExtensionType.GetText(extensionType)
                    );
            }
        }
        ...
        public static bool IsTimeout(SocketException e) =>
            SocketError.TimedOut == e.SocketErrorCode;
        ...
        )
        {
            ...
            TlsExtensionsUtilities.AddPreSharedKeyClientHello(
                clientExtensions,
                new OfferedPsks(identities)
            );
        }
        ...
        )
        {
            ...
            TlsExtensionsUtilities.AddPskKeyExchangeModesExtension(
                clientExtensions,
                pskKeyExchangeModes
            );

            return new OfferedPsks.BindersConfig(
                pskExternals,
                pskKeyExchangeModes,
                pskEarlySecrets,
                bindersSize
        ...
        )
        {
            ...
            if (count < clientBinders.m_psks.Length)
            {
                ...
                result = new OfferedPsks.BindersConfig(
                    psks,
                    clientBinders.m_pskKeyExchangeModes,
                    earlySecrets,
                    bindersSize
                );
            }
        ...
        {
            OfferedPsks offeredPsks = TlsExtensionsUtilities.GetPreSharedKeyClientHello(
                clientHelloExtensions
            );
            if (null != offeredPsks)
            {
                short[] pskKeyExchangeModes =
                    TlsExtensionsUtilities.GetPskKeyExchangeModesExtension(clientHelloExtensions);
                if (IsNullOrEmpty(pskKeyExchangeModes))
                ...
                short selectedMode = SelectPreSharedKeyMode(
                    pskKeyExchangeModes,
                    serverSupportedModes,
                    useServerOrder
                );
                ...
                if (PskKeyExchangeMode.psk_dhe_ke == selectedMode)
                {
                    ...
                    if (null != psk)
                    {
                        int index = offeredPsks.GetIndexOfIdentity(
                            new PskIdentity(psk.Identity, 0L)
                        );
                        if (index >= 0)
                        {
                            /*
                            ...
                            int pskCryptoHashAlgorithm = TlsCryptoUtilities.GetHashForPrf(
                                psk.PrfAlgorithm
                            );
                            ...
                            byte[] transcriptHash;
                            {
                                ...
                                {
                                    transcriptHash = handshakeHash.GetFinalHash(
                                        pskCryptoHashAlgorithm
                                    );
                                }
                                else
                            ...
                            byte[] calculatedBinder = CalculatePskBinder(
                                crypto,
                                isExternalPsk,
                                pskCryptoHashAlgorithm,
                                earlySecret,
                            ...
                            return new OfferedPsks.SelectedConfig(
                                index,
                                psk,
                                pskKeyExchangeModes,
                                earlySecret
        ...
        private static short SelectPreSharedKeyMode(
            short[] clientSupportedModes,
            short[] serverSupportedModes,
            bool useServerOrder
        )
        {
        ...
        /// <exception cref="IOException"/>
        internal static short ProcessMaxFragmentLengthExtension(
            IDictionary<int, byte[]> clientExtensions,
            IDictionary<int, byte[]> serverExtensions,
            short alertDescription
        )
        {
            short maxFragmentLength = TlsExtensionsUtilities.GetMaxFragmentLengthExtension(
                serverExtensions
            );
            if (maxFragmentLength >= 0)
            {
                if (
                    !MaxFragmentLength.IsValid(maxFragmentLength)
                    || (
                        clientExtensions != null
                        && maxFragmentLength
                            != TlsExtensionsUtilities.GetMaxFragmentLengthExtension(
                                clientExtensions
                            )
                    )
                )
        ...
        /// <exception cref="IOException"/>
        internal static short ProcessClientCertificateTypeExtension(
            IDictionary<int, byte[]> clientExtensions,
            IDictionary<int, byte[]> serverExtensions,
            short alertDescription
        )
        {
            short serverValue = TlsExtensionsUtilities.GetClientCertificateTypeExtensionServer(
                serverExtensions
            );
            if (serverValue < 0)
            ...
            if (!CertificateType.IsValid(serverValue))
                throw new TlsFatalAlert(
                    alertDescription,
                    "Unknown value for client_certificate_type"
                );

            short[] clientValues = TlsExtensionsUtilities.GetClientCertificateTypeExtensionClient(
                clientExtensions
            );
            if (clientValues == null || !Arrays.Contains(clientValues, serverValue))
                throw new TlsFatalAlert(
                    alertDescription,
                    "Invalid selection for client_certificate_type"
                );
        ...
        /// <exception cref="IOException"/>
        internal static short ProcessClientCertificateTypeExtension13(
            IDictionary<int, byte[]> clientExtensions,
            IDictionary<int, byte[]> serverExtensions,
            short alertDescription
        )
        {
            short certificateType = ProcessClientCertificateTypeExtension(
                clientExtensions,
                serverExtensions,
                alertDescription
            );
        ...
        /// <exception cref="IOException"/>
        internal static short ProcessServerCertificateTypeExtension(
            IDictionary<int, byte[]> clientExtensions,
            IDictionary<int, byte[]> serverExtensions,
            short alertDescription
        )
        {
            short serverValue = TlsExtensionsUtilities.GetServerCertificateTypeExtensionServer(
                serverExtensions
            );
            if (serverValue < 0)
                return CertificateType.X509;
            ...
            if (!CertificateType.IsValid(serverValue))
                throw new TlsFatalAlert(
                    alertDescription,
                    "Unknown value for server_certificate_type"
                );

            short[] clientValues = TlsExtensionsUtilities.GetServerCertificateTypeExtensionClient(
                clientExtensions
            );
            if (clientValues == null || !Arrays.Contains(clientValues, serverValue))
                throw new TlsFatalAlert(
                    alertDescription,
                    "Invalid selection for server_certificate_type"
                );
        ...
        /// <exception cref="IOException"/>
        internal static short ProcessServerCertificateTypeExtension13(
            IDictionary<int, byte[]> clientExtensions,
            IDictionary<int, byte[]> serverExtensions,
            short alertDescription
        )
        {
            short certificateType = ProcessServerCertificateTypeExtension(
                clientExtensions,
                serverExtensions,
                alertDescription
            );
        ...
        /// <exception cref="IOException"/>
        private static short ValidateCertificateType13(
