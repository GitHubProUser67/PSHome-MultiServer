...
namespace Org.BouncyCastle.Tls
{
    ...
    public class TlsDHKeyExchange : AbstractTlsKeyExchange
    {
        ...
        {
            m_dhPeerCertificate = serverCertificate
                .GetCertificateAt(0)
                .CheckUsageInRole(TlsCertificateRole.DH);
        }
        ...
        public override void SkipClientCredentials() =>
            new TlsFatalAlert(AlertDescription.unexpected_message);
        ...
        {
            m_dhPeerCertificate = clientCertificate
                .GetCertificateAt(0)
                .CheckUsageInRole(TlsCertificateRole.DH);
        }
