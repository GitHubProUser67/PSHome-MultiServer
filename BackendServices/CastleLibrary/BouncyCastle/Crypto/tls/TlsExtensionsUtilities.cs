...
namespace Org.BouncyCastle.Tls
{
    public static class TlsExtensionsUtilities
    {
        ...
        {
            extensions[ExtensionType.certificate_authorities] =
                CreateCertificateAuthoritiesExtension(authorities);
        }
        ...
        {
            extensions[ExtensionType.client_certificate_type] =
                CreateCertificateTypeExtensionClient(certificateTypes);
        }
        ...
        {
            extensions[ExtensionType.client_certificate_type] =
                CreateCertificateTypeExtensionServer(certificateType);
        }

        public static void AddClientCertificateUrlExtension(IDictionary<int, byte[]> extensions)
        {
            extensions[ExtensionType.client_certificate_url] =
        ...
        {
            extensions[ExtensionType.compress_certificate] = CreateCompressCertificateExtension(
                algorithms
            );
        }
        ...
        {
            extensions[ExtensionType.max_fragment_length] = CreateMaxFragmentLengthExtension(
                maxFragmentLength
            );
        }
        ...
        {
            extensions[ExtensionType.pre_shared_key] = CreatePreSharedKeyServerHello(
                selectedIdentity
            );
        }
        ...
        {
            extensions[ExtensionType.psk_key_exchange_modes] = CreatePskKeyExchangeModesExtension(
                modes
            );
        }
        ...
        {
            extensions[ExtensionType.record_size_limit] = CreateRecordSizeLimitExtension(
                recordSizeLimit
            );
        }
        ...
        {
            extensions[ExtensionType.server_certificate_type] =
                CreateCertificateTypeExtensionClient(certificateTypes);
        }
        ...
        {
            extensions[ExtensionType.signature_algorithms] = CreateSignatureAlgorithmsExtension(
        ...
        {
            extensions[ExtensionType.status_request_v2] = CreateStatusRequestV2Extension(
                statusRequestV2
            );
        }
        ...
        {
            extensions[ExtensionType.supported_groups] = CreateSupportedGroupsExtension(
                namedGroups
            );
        }
        ...
        {
            extensions[ExtensionType.ec_point_formats] = CreateSupportedPointFormatsExtension(
                ecPointFormats
            );
        }
        ...
        {
            extensions[ExtensionType.supported_versions] = CreateSupportedVersionsExtensionClient(
                versions
            );
        }
        ...
        {
            extensions[ExtensionType.supported_versions] = CreateSupportedVersionsExtensionServer(
                selectedVersion
            );
        }
        ...
        {
            extensions[ExtensionType.trusted_ca_keys] = CreateTrustedCAKeysExtensionClient(
                trustedAuthoritiesList
            );
        }
        ...
        /// <exception cref="IOException"/>
        public static IList<ProtocolName> GetAlpnExtensionClient(
            IDictionary<int, byte[]> extensions
        )
        {
            byte[] extensionData = TlsUtilities.GetExtensionData(
                extensions,
        ...
        )
        {
            ...
            return extensionData == null
                ? null
                : ReadCertificateAuthoritiesExtension(extensionData);
        }
        ...
        )
        {
            ...
            return extensionData == null
                ? (short)-1
                : ReadCertificateTypeExtensionServer(extensionData);
        }
        ...
        /// <exception cref="IOException"/>
        public static IList<KeyShareEntry> GetKeyShareClientHello(
            IDictionary<int, byte[]> extensions
        )
        {
            byte[] extensionData = TlsUtilities.GetExtensionData(
        ...
        public static short GetMaxFragmentLengthExtension(IDictionary<int, byte[]> extensions)
        {
            ...
            return extensionData == null
                ? (short)-1
                : ReadMaxFragmentLengthExtension(extensionData);
        }
        ...
        /// <exception cref="IOException"/>
        public static short[] GetServerCertificateTypeExtensionClient(
            IDictionary<int, byte[]> extensions
        )
        {
            byte[] extensionData = TlsUtilities.GetExtensionData(
        ...
        /// <exception cref="IOException"/>
        public static IList<ServerName> GetServerNameExtensionClient(
            IDictionary<int, byte[]> extensions
        )
        {
            byte[] extensionData = TlsUtilities.GetExtensionData(
        ...
        )
        {
            ...
            return extensionData == null
                ? null
                : ReadSignatureAlgorithmsCertExtension(extensionData);
        }
        ...
        )
        {
            ...
            return extensionData == null
                ? null
                : ReadSupportedVersionsExtensionClient(extensionData);
        }
        ...
        )
        {
            ...
            return extensionData == null
                ? null
                : ReadSupportedVersionsExtensionServer(extensionData);
        }
        ...
        {
            var protocol_name_list = new List<ProtocolName> { protocolName };
        ...
        public static byte[] CreateCertificateTypeExtensionServer(short certificateType) =>
            TlsUtilities.EncodeUint8(certificateType);

        public static byte[] CreateClientCertificateUrlExtension() => CreateEmptyExtensionData();
        ...
        public static byte[] CreateEarlyDataIndication() => CreateEmptyExtensionData();

        /// <exception cref="IOException"/>
        public static byte[] CreateEarlyDataMaxSize(long maxSize) =>
            TlsUtilities.EncodeUint32(maxSize);
        ...
        public static byte[] CreateKeyShareHelloRetryRequest(int namedGroup) =>
            TlsUtilities.EncodeUint16(namedGroup);
        ...
        public static byte[] CreateMaxFragmentLengthExtension(short maxFragmentLength) =>
            TlsUtilities.EncodeUint8(maxFragmentLength);

        /// <exception cref="IOException"/>
        public static byte[] CreateOidFiltersExtension(
            IDictionary<DerObjectIdentifier, byte[]> filters
        )
        {
            MemoryStream buf = new MemoryStream();
        ...
        public static byte[] CreatePostHandshakeAuthExtension() => CreateEmptyExtensionData();
        ...
        public static byte[] CreatePreSharedKeyServerHello(int selectedIdentity) =>
            TlsUtilities.EncodeUint16(selectedIdentity);
        ...
        public static byte[] CreateServerNameExtensionServer() => CreateEmptyExtensionData();
        ...
        public static byte[] CreateSupportedPointFormatsExtension(short[] ecPointFormats)
        {
            if (
                ecPointFormats == null
                || !Arrays.Contains(ecPointFormats, ECPointFormat.uncompressed)
            )
            {
                /*
        ...
        /// <exception cref="IOException"/>
        public static byte[] CreateSupportedVersionsExtensionServer(
            ProtocolVersion selectedVersion
        ) => TlsUtilities.EncodeVersion(selectedVersion);
        ...
        public static byte[] CreateTrustedCAKeysExtensionServer() => CreateEmptyExtensionData();
        ...
        public static short ReadCertificateTypeExtensionServer(byte[] extensionData) =>
            TlsUtilities.DecodeUint8(extensionData);
        ...
        public static byte[] ReadConnectionIDExtension(byte[] extensionData) =>
            TlsUtilities.DecodeOpaque8(extensionData);

        /// <exception cref="IOException"/>
        public static byte[] ReadCookieExtension(byte[] extensionData) =>
            TlsUtilities.DecodeOpaque16(extensionData, 1);
        ...
        public static long ReadEarlyDataMaxSize(byte[] extensionData) =>
            TlsUtilities.DecodeUint32(extensionData);
        ...
        public static int ReadKeyShareHelloRetryRequest(byte[] extensionData) =>
            TlsUtilities.DecodeUint16(extensionData);
        ...
        )
        {
            ...
            while (buf.Position < buf.Length)
            {
                ...
                DerObjectIdentifier certificateExtensionOid = TlsUtilities.ReadDerEncoding(
                    derEncoding,
                    DerObjectIdentifier.GetOptional
                );
        ...
        )
        {
            ...
            var supported_signature_algorithms = TlsUtilities.ParseSupportedSignatureAlgorithms(
                buf
            );
        ...
        public static IList<SignatureAndHashAlgorithm> ReadSignatureAlgorithmsCertExtension(
            byte[] extensionData
        ) => ReadSignatureAlgorithmsExtension(extensionData);
        ...
        public static ProtocolVersion[] ReadSupportedVersionsExtensionClient(byte[] extensionData)
        {
            if (extensionData == null)
                throw new ArgumentNullException(nameof(extensionData));
            if (
                extensionData.Length < 3
                || extensionData.Length > 255
                || (extensionData.Length & 1) == 0
            )
                throw new TlsFatalAlert(AlertDescription.decode_error);
