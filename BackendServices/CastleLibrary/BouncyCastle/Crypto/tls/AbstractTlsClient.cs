...
namespace Org.BouncyCastle.Tls
{
    ...
    public abstract class AbstractTlsClient : AbstractTlsPeer, TlsClient
    {
        ...
        protected virtual bool AllowUnexpectedServerExtension(
            int extensionType,
            byte[] extensionData
        )
        {
        ...
        protected virtual IList<int> GetNamedGroupRoles()
        {
            ...
            if (
                (
                    null == sigAlgs
                    || TlsUtilities.ContainsAnySignatureAlgorithm(sigAlgs, SignatureAlgorithm.ecdsa)
                )
                || (
                    null != sigAlgsCert
                    && TlsUtilities.ContainsAnySignatureAlgorithm(
                        sigAlgsCert,
        ...
        )
        {
            ...
            if (
                extensionData != null
                && !AllowUnexpectedServerExtension(extensionType, extensionData)
            )
        ...
        protected virtual IList<int> GetSupportedGroups(IList<int> namedGroupRoles)
        {
            ...
            if (
                namedGroupRoles.Contains(NamedGroupRole.ecdh)
        ...
        public virtual IDictionary<int, byte[]> GetClientExtensions()
        {
            ...
            {
                TlsExtensionsUtilities.AddServerNameExtensionClient(
                    clientExtensions,
                    sniServerNames
                );
            }
            ...
            if (offeringTlsV13Plus)
            {
                ...
                {
                    TlsExtensionsUtilities.AddCertificateAuthoritiesExtension(
                        clientExtensions,
            ...
            if (offeringPreTlsV13)
            {
                ...
                {
                    TlsExtensionsUtilities.AddStatusRequestV2Extension(
                        clientExtensions,
                        statusRequestV2
                    );
                }
                ...
                {
                    TlsExtensionsUtilities.AddTrustedCAKeysExtensionClient(
                        clientExtensions,
                        trustedCAKeys
                    );
                }
            ...
            if (TlsUtilities.IsSignatureAlgorithmsExtensionAllowed(clientVersion))
            {
                ...
                if (null != supportedSigAlgs && supportedSigAlgs.Count > 0)
                {
                    ...
                    TlsExtensionsUtilities.AddSignatureAlgorithmsExtension(
                        clientExtensions,
                        supportedSigAlgs
                    );
                }
                ...
                if (null != supportedSigAlgsCert && supportedSigAlgsCert.Count > 0)
                {
                    ...
                    TlsExtensionsUtilities.AddSignatureAlgorithmsCertExtension(
                        clientExtensions,
                        supportedSigAlgsCert
                    );
                }
            }
...

            {
                ...
                if (
                    clientCertTypes != null
                    && TlsUtilities.ContainsNot(
                        clientCertTypes,
                        0,
                        clientCertTypes.Length,
                        CertificateType.X509
                    )
                )
                {
                    TlsExtensionsUtilities.AddClientCertificateTypeExtensionClient(
                        clientExtensions,
                        clientCertTypes
                    );
                }
...

            {
                ...
                if (
                    serverCertTypes != null
                    && TlsUtilities.ContainsNot(
                        serverCertTypes,
                        0,
                        serverCertTypes.Length,
                        CertificateType.X509
                    )
                )
                {
                    TlsExtensionsUtilities.AddServerCertificateTypeExtensionClient(
                        clientExtensions,
                        serverCertTypes
                    );
                }
