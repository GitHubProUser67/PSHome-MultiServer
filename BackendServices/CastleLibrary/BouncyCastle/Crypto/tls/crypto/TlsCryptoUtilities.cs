...
namespace Org.BouncyCastle.Tls.Crypto
{
    ...
    {
        // "tls13 "
        private static readonly byte[] Tls13Prefix = new byte[]
        {
            0x74,
            0x6c,
            0x73,
            ...
            switch (hashAlgorithm)
            {
                ...
                default:
                    throw new ArgumentException(
                        "specified HashAlgorithm invalid: " + HashAlgorithm.GetText(hashAlgorithm)
                    );
            }
        }
        ...
        public static int GetHashForHmac(int macAlgorithm)
        {
            switch (macAlgorithm)
            {
                ...
                default:
                    throw new ArgumentException(
                        "specified MacAlgorithm not an HMAC: " + MacAlgorithm.GetText(macAlgorithm)
                    );
            }
        }
        ...
        public static int GetHashForPrf(int prfAlgorithm)
        {
            switch (prfAlgorithm)
            {
                ...
                default:
                    throw new ArgumentException(
                        "unknown PrfAlgorithm: " + PrfAlgorithm.GetText(prfAlgorithm)
                    );
            }
        }
        ...
        public static int GetSignature(short signatureAlgorithm)
        {
            switch (signatureAlgorithm)
            {
                ...
                default:
                    throw new ArgumentException(
                        "specified SignatureAlgorithm invalid: "
