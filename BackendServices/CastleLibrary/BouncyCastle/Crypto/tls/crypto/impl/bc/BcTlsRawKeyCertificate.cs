    ...
    public class BcTlsRawKeyCertificate : TlsCertificate
    {
        ...
        public virtual TlsVerifier CreateVerifier(short signatureAlgorithm)
        {
            switch (signatureAlgorithm)
            {
                ...
                {
                    int signatureScheme = SignatureScheme.From(
        ...
        public virtual Tls13Verifier CreateVerifier(int signatureScheme)
        {
            ...
            switch (signatureScheme)
            {
                ...
                case SignatureScheme.rsa_pkcs1_sha512:
                {
                    ...
                    RsaDigestSigner verifier = new RsaDigestSigner(
                        digest,
                ...
                case SignatureScheme.rsa_pss_pss_sha512:
                {
                    ...
                    PssSigner verifier = new PssSigner(
                        new RsaEngine(),
                        digest,
                ...
                case SignatureScheme.mldsa87:
                {
                    ...
                    var verifier = SignerUtilities.InitSigner(
                        mlDsaAlgOid,
                        forSigning: false,
                        publicKey,
                        random: null
        ...
        protected virtual bool SupportsSignatureAlgorithm(short signatureAlgorithm, int keyUsage)
        {
            ...
            {
                case SignatureAlgorithm.rsa:
                    return SupportsRsa_Pkcs1() && publicKey is RsaKeyParameters;
                ...
                case SignatureAlgorithm.rsa_pss_rsae_sha384:
                case SignatureAlgorithm.rsa_pss_rsae_sha512:
                    return SupportsRsa_Pss_Rsae() && publicKey is RsaKeyParameters;

                case SignatureAlgorithm.rsa_pss_pss_sha256:
                case SignatureAlgorithm.rsa_pss_pss_sha384:
                case SignatureAlgorithm.rsa_pss_pss_sha512:
                    return SupportsRsa_Pss_Pss(signatureAlgorithm) && publicKey is RsaKeyParameters;
        ...
        protected virtual void ValidateMLDsa(DerObjectIdentifier mlDsaAlgOid)
        {
            if (!SupportsMLDsa(mlDsaAlgOid))
                throw new TlsFatalAlert(
                    AlertDescription.certificate_unknown,
                    "No support for ML-DSA signature scheme"
                );
        }
        ...
        protected virtual void ValidateSlhDsa(DerObjectIdentifier slhDsaAlgOid)
        {
            if (!SupportsSlhDsa(slhDsaAlgOid))
                throw new TlsFatalAlert(
                    AlertDescription.certificate_unknown,
                    "No support for SLH-DSA signature scheme"
                );
        }
    }
}
