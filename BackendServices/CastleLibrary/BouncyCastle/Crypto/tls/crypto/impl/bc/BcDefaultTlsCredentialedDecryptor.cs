...
namespace Org.BouncyCastle.Tls.Crypto.Impl.BC
{
    ...
    public class BcDefaultTlsCredentialedDecryptor : TlsCredentialedDecryptor
    {
        ...
        )
        {
            ...
            byte[] preMasterSecret =
                Org.BouncyCastle.Crypto.Tls.TlsRsaKeyExchange.DecryptPreMasterSecret(
