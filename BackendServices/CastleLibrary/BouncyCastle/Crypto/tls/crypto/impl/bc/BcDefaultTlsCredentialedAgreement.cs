...
namespace Org.BouncyCastle.Tls.Crypto.Impl.BC
{
    ...
    public class BcDefaultTlsCredentialedAgreement : TlsCredentialedAgreement
    {
        ...
        )
        {
            ...
            {
                this.m_agreementCredentials = new DHCredentialedAgreement(
                    crypto,
                    certificate,
            ...
            {
                this.m_agreementCredentials = new ECCredentialedAgreement(
                    crypto,
                    certificate,
            ...
            else
            {
                throw new ArgumentException(
                    "'privateKey' type not supported: " + privateKey.GetType().FullName
                );
            }
        }
        ...
        private sealed class DHCredentialedAgreement : TlsCredentialedAgreement
        {
            ...
            public TlsSecret GenerateAgreement(TlsCertificate peerCertificate)
            {
                ...
                return BcTlsDHDomain.CalculateDHAgreement(
                    m_crypto,
                    m_privateKey,
                    peerPublicKey,
                    false
        ...
        private sealed class ECCredentialedAgreement : TlsCredentialedAgreement
        {
            private readonly BcTlsCrypto m_crypto;
            private readonly Certificate m_certificate;
