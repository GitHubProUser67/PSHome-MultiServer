...
namespace Org.BouncyCastle.Tls.Crypto.Impl
{
    ...
    public abstract class AbstractTlsCrypto : TlsCrypto
    {
        ...
        public abstract bool HasSignatureAndHashAlgorithm(
        ...
        public virtual TlsSecret AdoptSecret(TlsSecret secret)
        {
            ...
            throw new ArgumentException(
                "unrecognized TlsSecret - cannot copy data: " + secret.GetType().FullName
            );
        }
        ...
        public abstract TlsNonceGenerator CreateNonceGenerator(
            ReadOnlySpan<byte> additionalSeedMaterial
        );

        public abstract TlsSrp6Client CreateSrp6Client(TlsSrpConfig srpConfig);

        public abstract TlsSrp6Server CreateSrp6Server(
            TlsSrpConfig srpConfig,
            BigInteger srpVerifier
        );

        public abstract TlsSrp6VerifierGenerator CreateSrp6VerifierGenerator(
            TlsSrpConfig srpConfig
        );
