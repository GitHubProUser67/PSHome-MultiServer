...
namespace Org.BouncyCastle.Tls.Crypto.Impl
{
    ...
    public sealed class Tls13NullCipher : TlsCipher, TlsCipherExt
    {
        ...
        private readonly TlsHmac m_readHmac,
            m_writeHmac;
        private readonly byte[] m_readNonce,
            m_writeNonce;

        /// <exception cref="IOException"/>
        public Tls13NullCipher(
        ...
        public int GetCiphertextDecodeLimit(int plaintextLimit) =>
            plaintextLimit + 1 + m_readHmac.MacLength;
        ...
        public int GetPlaintextDecodeLimit(int ciphertextLimit) =>
            ciphertextLimit - m_readHmac.MacLength - 1;

        public int GetPlaintextEncodeLimit(int ciphertextLimit) =>
            ciphertextLimit - m_writeHmac.MacLength - 1;
            ...
            try
            {
                ...
                if (
                    !Arrays.FixedTimeEquals(
                        ...
                        0,
                        ciphertext,
                        ciphertextOffset + innerPlaintextLength
                    )
                )
        ...
        private static byte[] GetAdditionalData(
            long seqNo,
            short recordType,
            ProtocolVersion recordVersion,
            int ciphertextLength
