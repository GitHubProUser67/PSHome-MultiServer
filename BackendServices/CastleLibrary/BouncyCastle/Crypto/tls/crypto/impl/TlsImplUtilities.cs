...
namespace Org.BouncyCastle.Tls.Crypto.Impl
{
    ...
    public abstract class TlsImplUtilities
    {
        ...
        public static byte[] CalculateKeyBlock(TlsCryptoParameters cryptoParams, int length)
        {
            ...
            byte[] seed = Arrays.Concatenate(
                securityParameters.ServerRandom,
                securityParameters.ClientRandom
            );
            return master_secret
                .DeriveUsingPrf(prfAlgorithm, ExporterLabel.key_expansion, seed, length)
                .Extract();
        }
