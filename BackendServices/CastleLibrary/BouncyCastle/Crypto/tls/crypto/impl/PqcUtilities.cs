...
namespace Org.BouncyCastle.Tls.Crypto.Impl
{
    public static class PqcUtilities
    {
        ...
        public static bool SupportsMLDsa(
            AlgorithmIdentifier pubKeyAlgID,
            DerObjectIdentifier mlDsaAlgOid
        ) => HasOidWithNullParameters(pubKeyAlgID, mlDsaAlgOid);

        public static bool SupportsSlhDsa(
            AlgorithmIdentifier pubKeyAlgID,
            DerObjectIdentifier slhDsaAlgOid
        ) => HasOidWithNullParameters(pubKeyAlgID, slhDsaAlgOid);

        private static bool HasOidWithNullParameters(
