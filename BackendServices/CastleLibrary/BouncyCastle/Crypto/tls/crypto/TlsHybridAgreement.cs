...
namespace Org.BouncyCastle.Tls.Crypto
{
    public sealed class TlsHybridAgreement : TlsAgreement
    {
        ...
        )
        {
            ...
            m_firstAgreement =
                firstAgreement ?? throw new ArgumentNullException(nameof(firstAgreement));
            m_secondAgreement =
                secondAgreement ?? throw new ArgumentNullException(nameof(secondAgreement));
        ...
        public void ReceivePeerValue(byte[] peerValue)
        {
            ...
            m_secondAgreement.ReceivePeerValue(
                Arrays.CopyOfRange(peerValue, m_peerValueSplit, peerValue.Length)
            );
        }
