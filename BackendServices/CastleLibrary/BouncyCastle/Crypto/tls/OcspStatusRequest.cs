...
namespace Org.BouncyCastle.Tls
{
    ...
    public sealed class OcspStatusRequest
    {
        ...
        public OcspStatusRequest(
            IList<ResponderID> responderIDList,
        ...
        public static OcspStatusRequest Parse(Stream input)
        {
            var responderIDList = new List<ResponderID>();
            {
                ...
                if (data.Length > 0)
                {
                    ...
                    do
                    {
                        ...
                        ResponderID responderID = TlsUtilities.ReadDerEncoding(
                            derEncoding,
                            ResponderID.GetOptional
                        );
            ...
            X509Extensions requestExtensions = null;
            {
                ...
                {
                    requestExtensions = TlsUtilities.ReadDerEncoding(
                        derEncoding,
