...
namespace Org.BouncyCastle.Tls
{
    internal class DtlsReliableHandshake
    {
        ...
        /// <exception cref="IOException"/>
        internal static void SendHelloVerifyRequest(
        ...
        private Dictionary<int, DtlsReassembler> m_currentInboundFlight =
            new Dictionary<int, DtlsReassembler>();
        ...
        private int m_next_send_seq = 0,
            m_next_receive_seq = 0;
        ...
        {
            RecordLayerBuffer fragment = new RecordLayerBuffer(
                MessageHeaderLength + fragment_length
            );
