...
namespace Org.BouncyCastle.Tls
{
    ...
    public abstract class AbstractTlsKeyExchangeFactory : TlsKeyExchangeFactory
    {
        ...
        public virtual TlsKeyExchange CreateDHanonKeyExchangeServer(
            int keyExchange,
        ...
        public virtual TlsKeyExchange CreateDheKeyExchangeServer(
            int keyExchange,
            TlsDHConfig dhConfig
        )
        {
        ...
        public virtual TlsKeyExchange CreateECDheKeyExchangeServer(
            int keyExchange,
            TlsECConfig ecConfig
        )
        {
