    ...
    public sealed class CertificateRequest
    {
        ...
        public CertificateRequest(
            ...
            : this(
                ...
                null,
                CheckSupportedSignatureAlgorithms(
                    supportedSignatureAlgorithms,
        ...
        {
            if (
                null != certificateRequestContext
                && !TlsUtilities.IsValidUint8(certificateRequestContext.Length)
            )
            ...
            if (
                null != certificateTypes
                && (
                    certificateTypes.Length < 1
                    || !TlsUtilities.IsValidUint8(certificateTypes.Length)
                )
            )
            {
        ...
        public byte[] GetCertificateRequestContext() =>
            TlsUtilities.Clone(m_certificateRequestContext);
        ...
        public void Encode(TlsContext context, Stream output)
        {
            ...
            if (
                isTlsV13 != (null != m_certificateRequestContext)
            ...
            if (isTlsV12)
            {
                ...
                TlsUtilities.EncodeSupportedSignatureAlgorithms(
                    m_supportedSignatureAlgorithms,
                    output
                );
            }
        ...
        public static CertificateRequest Parse(TlsContext context, Stream input)
        {
            ...
            if (isTlsV13)
            {
                ...
                var supportedSignatureAlgorithmsCert13 =
                    TlsExtensionsUtilities.GetSignatureAlgorithmsCertExtension(extensions);
                var certificateAuthorities13 =
                    TlsExtensionsUtilities.GetCertificateAuthoritiesExtension(extensions);

                return new CertificateRequest(
                    certificateRequestContext,
                    supportedSignatureAlgorithms13,
                    supportedSignatureAlgorithmsCert13,
                    certificateAuthorities13
                );
            }
            ...
            if (isTLSv12)
            {
                supportedSignatureAlgorithms = TlsUtilities.ParseSupportedSignatureAlgorithms(
                    input
                );
            }
            ...
            IList<X509Name> certificateAuthorities = null;
            {
                ...
                if (certAuthData.Length > 0)
                {
                    ...
                    do
                    {
                        ...
                        X509Name ca = TlsUtilities.ReadDerEncoding(
                            derEncoding,
                            X509Name.GetOptional
                        );
