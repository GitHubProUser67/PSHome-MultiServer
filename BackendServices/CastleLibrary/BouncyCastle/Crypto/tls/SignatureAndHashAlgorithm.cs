...
namespace Org.BouncyCastle.Tls
{
    ...
    {
        public static readonly SignatureAndHashAlgorithm ecdsa_brainpoolP256r1tls13_sha256 = Create(
            SignatureScheme.ecdsa_brainpoolP256r1tls13_sha256
        );
        public static readonly SignatureAndHashAlgorithm ecdsa_brainpoolP384r1tls13_sha384 = Create(
            SignatureScheme.ecdsa_brainpoolP384r1tls13_sha384
        );
        public static readonly SignatureAndHashAlgorithm ecdsa_brainpoolP512r1tls13_sha512 = Create(
        ...
        public static readonly SignatureAndHashAlgorithm gostr34102012_256 = Create(
            HashAlgorithm.Intrinsic,
            SignatureAlgorithm.gostr34102012_256
        );
        public static readonly SignatureAndHashAlgorithm gostr34102012_512 = Create(
            HashAlgorithm.Intrinsic,
        ...
        public static readonly SignatureAndHashAlgorithm rsa_pss_rsae_sha256 = Create(
            SignatureScheme.rsa_pss_rsae_sha256
        );
        public static readonly SignatureAndHashAlgorithm rsa_pss_rsae_sha384 = Create(
            SignatureScheme.rsa_pss_rsae_sha384
        );
        public static readonly SignatureAndHashAlgorithm rsa_pss_rsae_sha512 = Create(
            SignatureScheme.rsa_pss_rsae_sha512
        );
        public static readonly SignatureAndHashAlgorithm rsa_pss_pss_sha256 = Create(
            SignatureScheme.rsa_pss_pss_sha256
        );
        public static readonly SignatureAndHashAlgorithm rsa_pss_pss_sha384 = Create(
            SignatureScheme.rsa_pss_pss_sha384
        );
        public static readonly SignatureAndHashAlgorithm rsa_pss_pss_sha512 = Create(
            SignatureScheme.rsa_pss_pss_sha512
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_128s = Create(
            SignatureScheme.slhdsa_sha2_128s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_128f = Create(
            SignatureScheme.slhdsa_sha2_128f
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_192s = Create(
            SignatureScheme.slhdsa_sha2_192s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_192f = Create(
            SignatureScheme.slhdsa_sha2_192f
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_256s = Create(
            SignatureScheme.slhdsa_sha2_256s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_sha2_256f = Create(
            SignatureScheme.slhdsa_sha2_256f
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_128s = Create(
            SignatureScheme.slhdsa_shake_128s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_128f = Create(
            SignatureScheme.slhdsa_shake_128f
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_192s = Create(
            SignatureScheme.slhdsa_shake_192s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_192f = Create(
            SignatureScheme.slhdsa_shake_192f
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_256s = Create(
            SignatureScheme.slhdsa_shake_256s
        );
        public static readonly SignatureAndHashAlgorithm slhdsa_shake_256f = Create(
            SignatureScheme.slhdsa_shake_256f
        );

        public static SignatureAndHashAlgorithm GetInstance(
            short hashAlgorithm,
        ...
        private static SignatureAndHashAlgorithm Create(
            short hashAlgorithm,
            short signatureAlgorithm
        )
        {
        ...
        {
            return "{"
                + HashAlgorithm.GetText(Hash)
                + ","
                + SignatureAlgorithm.GetText(Signature)
                + "}";
        }
    }
}
