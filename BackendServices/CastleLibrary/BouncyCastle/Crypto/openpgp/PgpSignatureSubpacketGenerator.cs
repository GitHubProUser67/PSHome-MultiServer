...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpSignatureSubpacketGenerator
    {
        ...
        {
            list.Add(
                new PreferredAlgorithms(
                    SignatureSubpacketTag.PreferredHashAlgorithms,
                    isCritical,
                    algorithms
                )
            );
        ...
        public void SetPreferredSymmetricAlgorithms(bool isCritical, int[] algorithms)
        {
            list.Add(
                new PreferredAlgorithms(
                    SignatureSubpacketTag.PreferredSymmetricAlgorithms,
                    isCritical,
                    algorithms
                )
            );
        ...
        public void SetPreferredAeadAlgorithms(bool isCritical, int[] algorithms)
        {
            list.Add(
                new PreferredAlgorithms(
                    SignatureSubpacketTag.PreferredAeadAlgorithms,
                    isCritical,
                    algorithms
                )
            );
        ...
        {
            list.Add(
                new IssuerFingerprint(isCritical, publicKey.Version, publicKey.GetFingerprint())
            );
        }
        ...
        {
            list.Add(
                new IntendedRecipientFingerprint(
                    isCritical,
                    publicKey.Version,
