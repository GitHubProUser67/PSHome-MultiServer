...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpSignatureGenerator
    {
        ...
        {
            hashed =
                hashedPackets == null ? EmptySignatureSubpackets : hashedPackets.ToSubpacketArray();
        }
        ...
        public PgpSignature Generate()
        {
            ...
            if (
                !IsPacketPresent(hashed, SignatureSubpacketTag.IssuerKeyId)
            ...
            if (keyAlgorithm == PublicKeyAlgorithmTag.EdDsa_Legacy)
            {
                ...
                keyAlgorithm == PublicKeyAlgorithmTag.RsaSign
        ...
        private static bool IsPacketPresent(
        ...
        private void UpdateWithPublicKey(PgpPublicKey key)
        {
            ...
            Update(0x99, (byte)(keyBytes.Length >> 8), (byte)(keyBytes.Length));
            Update(keyBytes);
        }
    }
}
