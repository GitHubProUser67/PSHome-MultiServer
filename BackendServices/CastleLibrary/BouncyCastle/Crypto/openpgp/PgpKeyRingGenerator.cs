...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpKeyRingGenerator
    {
        ...
        public void AddSubKey(PgpKeyPair keyPair, HashAlgorithmTag hashAlgorithm)
        {
            this.AddSubKey(
                keyPair,
                this.hashedPacketVector,
                this.unhashedPacketVector,
                hashAlgorithm
            );
        }
        ...
        )
        {
            this.AddSubKey(
                ...
                this.unhashedPacketVector,
                hashAlgorithm,
                primaryKeyBindingHashAlgorithm
            );
        }
        ...
        )
        {
            try
            {
                ...
                keys.Add(
                    new PgpSecretKey(
                        keyPair.PrivateKey,
                        new PgpPublicKey(keyPair.PublicKey, null, subSigs),
                        encAlgorithm,
                        rawPassPhrase,
                        false,
                        useSha1,
        ...
        )
        {
            try
            {
                ...
                PgpSignatureGenerator pGen = new PgpSignatureGenerator(
