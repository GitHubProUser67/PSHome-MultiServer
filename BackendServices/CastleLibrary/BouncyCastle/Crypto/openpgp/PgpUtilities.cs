...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public sealed class PgpUtilities
    {
        ...
        private static readonly Dictionary<string, HashAlgorithmTag> NameToHashID =
            CreateNameToHashID();
            ...
            switch (hashAlgorithm)
            {
                ...
                default:
                    throw new PgpException(
                        "unknown hash algorithm tag in GetDigestName: " + hashAlgorithm
                    );
            }
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal static byte[] EncodePassPhrase(char[] passPhrase, bool utf8)
        {
            return passPhrase == null ? null
                : utf8 ? Encoding.UTF8.GetBytes(passPhrase)
        ...
        {
            return DoMakeKeyFromPassPhrase(
                algorithm,
                s2k,
                EncodePassPhrase(passPhrase, false),
                true
            );
        }
        ...
        )
        {
            return DoMakeKeyFromPassPhrase(
                algorithm,
                s2k,
                EncodePassPhrase(passPhrase, true),
                true
            );
        }
        ...
        )
        {
            ...
            {
                throw new PgpException(
                    $"can't create {GetDigestName(s2k.HashAlgorithm)} digest",
                    e
                );
            }
            ...
            switch (publicKeyAlgorithm)
            {
                ...
                default:
                {
                    return SignerUtilities.GetSigner(
                        GetSignatureName(publicKeyAlgorithm, hashAlgorithm)
                    );
                }
            }
        }
