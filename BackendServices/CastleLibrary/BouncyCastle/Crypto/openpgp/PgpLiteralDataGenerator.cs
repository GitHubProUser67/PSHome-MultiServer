...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpLiteralDataGenerator : IStreamGenerator
    {
        ...
        private readonly bool m_oldFormat;
        ...
        )
        {
            ...
            StreamUtilities.WriteUInt32BE(outStr, (uint)modDate);
        }
        ...
        )
        {
            ...
            pkOut = new BcpgOutputStream(
                outStr,
                PacketTag.LiteralData,
                length + 2 + encName.Length + 4,
                m_oldFormat
            );
        ...
        public Stream Open(Stream outStr, char format, FileInfo file) =>
            Open(outStr, format, file.Name, file.Length, file.LastWriteTime);
