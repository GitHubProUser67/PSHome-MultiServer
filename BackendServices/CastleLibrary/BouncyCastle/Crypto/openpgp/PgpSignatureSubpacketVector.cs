    ...
    public class PgpSignatureSubpacketVector
    {
        ...
        public DateTime GetSignatureCreationTime()
        {
            SignatureSubpacket p =
                GetSubpacket(SignatureSubpacketTag.CreationTime)
        ...
        {
            SignatureSubpacket p = GetSubpacket(
                SignatureSubpacketTag.PreferredCompressionAlgorithms
            );
        ...
        {
            PrimaryUserId primaryId = (PrimaryUserId)GetSubpacket(
                SignatureSubpacketTag.PrimaryUserId
            );
        ...
        public IssuerFingerprint GetIssuerFingerprint()
        {
            ...
            return p == null
                ? null
                : new IssuerFingerprint(p.IsCritical(), p.IsLongLength(), p.Data);
        }
        ...
        public IntendedRecipientFingerprint GetIntendedRecipientFingerprint()
        {
            ...
            return p == null
                ? null
                : new IntendedRecipientFingerprint(p.IsCritical(), p.IsLongLength(), p.Data);
        }

        public IntendedRecipientFingerprint[] GetIntendedRecipientFingerprints()
        {
            SignatureSubpacket[] subpackets = GetSubpackets(
                SignatureSubpacketTag.IntendedRecipientFingerprint
            );
            IntendedRecipientFingerprint[] recipients = new IntendedRecipientFingerprint[
                subpackets.Length
            ];
            for (int i = 0; i < recipients.Length; i++)
            {
                SignatureSubpacket p = subpackets[i];
                recipients[i] = new IntendedRecipientFingerprint(
                    p.IsCritical(),
                    p.IsLongLength(),
                    p.Data
                );
        ...
        public RegularExpression GetRegularExpression()
        {
            ...
            return p == null
                ? null
                : new RegularExpression(p.IsCritical(), p.IsLongLength(), p.Data);
        }
        ...
        public RevocationReason GetRevocationReason()
        {
            ...
            return p == null
                ? null
                : new RevocationReason(p.IsCritical(), p.IsLongLength(), p.Data);
        }
