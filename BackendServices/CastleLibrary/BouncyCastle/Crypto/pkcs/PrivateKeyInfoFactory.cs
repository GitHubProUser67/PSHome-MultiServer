...
namespace Org.BouncyCastle.Pkcs
{
    ...
    {
        private static readonly HashSet<DerObjectIdentifier> cryptoProOids =
        ...
        )
        {
            ...
            if (!privateKey.IsPrivate)
                throw new ArgumentException(
                    "Public key passed - private key expected",
                    nameof(privateKey)
                );
            ...
            if (privateKey is ECPrivateKeyParameters ecKey)
            {
                ...
                if (dp is ECGost3410Parameters domainParameters)
                {
                    ...
                    return new PrivateKeyInfo(
                        new AlgorithmIdentifier(identifier, gostParams),
            ...
            if (privateKey is X448PrivateKeyParameters x448Key)
            {
                ...
                return new PrivateKeyInfo(
                    algID,
                    new DerOctetString(x448Key.GetEncoded()),
                    attributes,
            ...
            if (privateKey is X25519PrivateKeyParameters x25519Key)
            {
                ...
                return new PrivateKeyInfo(
                    algID,
                    new DerOctetString(x25519Key.GetEncoded()),
                    attributes,
            ...
            if (privateKey is Ed448PrivateKeyParameters ed448Key)
            {
                ...
                return new PrivateKeyInfo(
                    algID,
                    new DerOctetString(ed448Key.GetEncoded()),
                    attributes,
            ...
            if (privateKey is Ed25519PrivateKeyParameters ed25519Key)
            {
                ...
                return new PrivateKeyInfo(
                    algID,
                    new DerOctetString(ed25519Key.GetEncoded()),
                    attributes,
            ...
            if (privateKey is SlhDsaPrivateKeyParameters slhDsaKey)
            {
                ...
                return PrivateKeyInfo.Create(
                    algID,
                    new DerOctetString(slhDsaKey.GetEncoded()),
                    attributes,
                    publicKey
                );
            }
            ...
            switch (key.PreferredFormat)
            {
                ...
                default:
                    return new DerSequence(
                        new DerOctetString(key.GetSeed()),
