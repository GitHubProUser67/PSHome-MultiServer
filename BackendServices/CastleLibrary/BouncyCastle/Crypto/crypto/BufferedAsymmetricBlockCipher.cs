    ...
    */
    public class BufferedAsymmetricBlockCipher : BufferedCipherBase
    {
        ...
        */
        ...
        {
            Check.DataLength(
                input.Length > buffer.Length - bufOff,
                "attempt to process message too long for cipher"
            );
        ...
        */
        ...
        {
            byte[] outBytes = bufOff > 0 ? cipher.ProcessBlock(buffer, 0, bufOff) : EmptyBuffer;
