...
namespace Org.BouncyCastle.Crypto.Operators
{
    ...
    {
        private static readonly Dictionary<string, DerObjectIdentifier> Algorithms = new Dictionary<
            string,
            DerObjectIdentifier
        >(StringComparer.OrdinalIgnoreCase);
        private static readonly Dictionary<string, Asn1Encodable> ExParams = new Dictionary<
            string,
            Asn1Encodable
        >(StringComparer.OrdinalIgnoreCase);
        ...
        static X509Utilities()
        {
            ...
            Algorithms.Add(
                ...
                NistObjectIdentifiers.IdRsassaPkcs1V15WithSha3_224
            );
            Algorithms.Add(
                "SHA3-256WITHRSAENCRYPTION",
                NistObjectIdentifiers.IdRsassaPkcs1V15WithSha3_256
            );
            Algorithms.Add(
                "SHA3-384WITHRSAENCRYPTION",
                NistObjectIdentifiers.IdRsassaPkcs1V15WithSha3_384
            );
            Algorithms.Add(
                "SHA3-512WITHRSAENCRYPTION",
                NistObjectIdentifiers.IdRsassaPkcs1V15WithSha3_512
            );
            ...
            Algorithms.Add("SHA1withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA1);
            Algorithms.Add("SHA224withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA224);
            Algorithms.Add("SHA256withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA256);
            Algorithms.Add("SHA384withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA384);
            Algorithms.Add("SHA512withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA512);
            Algorithms.Add("RIPEMD160withPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_RIPEMD160);
            Algorithms.Add(
            ...
            Algorithms.Add(
                ...
                CryptoProObjectIdentifiers.GostR3411x94WithGostR3410x2001
            );
            Algorithms.Add(
            ...
            Algorithms.Add(
                "GOST3411-2012-256WITHECGOST3410",
            ...
            AddNoParams(BsiObjectIdentifiers.ecdsa_plain_SHA512);
            ...
            // explicit params
            //
            AlgorithmIdentifier sha1AlgId = new AlgorithmIdentifier(
                OiwObjectIdentifiers.IdSha1,
                DerNull.Instance
            );
            ExParams.Add("SHA1WITHRSAANDMGF1", CreatePssParams(sha1AlgId, 20));

            AlgorithmIdentifier sha224AlgId = new AlgorithmIdentifier(
            ...
            AlgorithmIdentifier sha384AlgId = new AlgorithmIdentifier(
                NistObjectIdentifiers.IdSha384,
                DerNull.Instance
            );
            ExParams.Add("SHA384WITHRSAANDMGF1", CreatePssParams(sha384AlgId, 48));

            AlgorithmIdentifier sha512AlgId = new AlgorithmIdentifier(
            ...
            AddAlgorithm(
                "SHA3-224WITHDSA",
                NistObjectIdentifiers.IdDsaWithSha3_224,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-256WITHDSA",
                NistObjectIdentifiers.IdDsaWithSha3_256,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-384WITHDSA",
                NistObjectIdentifiers.IdDsaWithSha3_384,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-512WITHDSA",
                NistObjectIdentifiers.IdDsaWithSha3_512,
                isNoParams: true
            );
            ...
            AddAlgorithm(
                "SHA3-224WITHECDSA",
                NistObjectIdentifiers.IdEcdsaWithSha3_224,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-256WITHECDSA",
                NistObjectIdentifiers.IdEcdsaWithSha3_256,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-384WITHECDSA",
                NistObjectIdentifiers.IdEcdsaWithSha3_384,
                isNoParams: true
            );
            AddAlgorithm(
                "SHA3-512WITHECDSA",
                NistObjectIdentifiers.IdEcdsaWithSha3_512,
                isNoParams: true
            );
        ...
        {
            DerObjectIdentifier sigOid = GetSigOid(algorithmName);
