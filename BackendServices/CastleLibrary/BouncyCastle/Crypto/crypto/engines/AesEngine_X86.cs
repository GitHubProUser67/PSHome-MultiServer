    ...
    public struct AesEngine_X86 : IBlockCipher
    {
        ...
        private static Vector128<byte>[] CreateRoundKeys(ReadOnlySpan<byte> key, bool forEncryption)
        {
            ...
            switch (key.Length)
            {
                case 16:
                {
                    ReadOnlySpan<byte> rcon = new byte[]
                    {
                        0x01,
                        0x02,
                        0x04,
                ...
                case 24:
                {
                    ...
                    for (int round = 0; ; )
                    {
                        var t1 = Aes.KeygenAssist(s2, rcon);
                        rcon <<= 1;
                        ...
                        var t2 = Aes.KeygenAssist(s3, rcon);
                        rcon <<= 1;
        ...
        public void Init(bool forEncryption, ICipherParameters parameters)
        {
            if (!(parameters is KeyParameter keyParameter))
            {
                ...
                throw new ArgumentException(
                    "invalid type: " + Platform.GetTypeName(parameters),
                    nameof(parameters)
                );
            }
        ...
        private void ImplRounds(ref Vector128<byte> state)
        {
            switch (m_mode)
            {
                ...
                case Mode.ENC_256:
                    ...
                    break;
                default:
                    throw new InvalidOperationException(nameof(AesEngine_X86) + " not initialised");
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void ImplRounds(
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
            ref Vector128<byte> s4
        )
        {
            switch (m_mode)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void DecryptFour128(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void DecryptFour192(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void DecryptFour256(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void EncryptFour128(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void EncryptFour192(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void EncryptFour256(
            Vector128<byte>[] rk,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
        ...
        private static Vector64<byte> Load64(ReadOnlySpan<byte> t)
        {
            ...
            return Vector64.Create(BinaryPrimitives.ReadUInt64LittleEndian(t[..8])).AsByte();
        }
