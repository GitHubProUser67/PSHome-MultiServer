...
namespace Org.BouncyCastle.Crypto.Engines
{
    ...
    */
    public class HC128Engine : IStreamCipher
    {
        ...
        {
            return (Integers.RotateRight(x, 10) ^ Integers.RotateRight(z, 23))
                + Integers.RotateRight(y, 8);
        }

        private uint G2(uint x, uint y, uint z)
        {
            return (Integers.RotateLeft(x, 10) ^ Integers.RotateLeft(z, 23))
                + Integers.RotateLeft(y, 8);
        }
