...
namespace Org.BouncyCastle.Crypto.Generators
{
    ...
    public class RsaKeyPairGenerator : IAsymmetricCipherKeyPairGenerator
    {
        ...
        private static readonly int SPECIAL_E_HIGHEST = SPECIAL_E_VALUES[
            SPECIAL_E_VALUES.Length - 1
        ];
        private static readonly int SPECIAL_E_BITS = BigInteger
            .ValueOf(SPECIAL_E_HIGHEST)
            .BitLength;
        ...
        {
            bool eIsKnownOddPrime =
                (e.BitLength <= SPECIAL_E_BITS) && Arrays.Contains(SPECIAL_E_VALUES, e.IntValue);
