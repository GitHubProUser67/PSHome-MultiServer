        ...
        */
        ...
        protected override byte[] EngineGenerateKey()
        {
            ...
            do
            {
                ...
                DesEdeParameters.IsWeakKey(newKey) || !DesEdeParameters.IsRealEdeKey(newKey, 0)
            );
            ...
            return KeyParameter.Create(
                ...
                (bytes, random) =>
                {
                    do
                    {
                        ...
                        DesEdeParameters.IsWeakKey(bytes) || !DesEdeParameters.IsRealEdeKey(bytes)
                    );
                }
            );
        }
