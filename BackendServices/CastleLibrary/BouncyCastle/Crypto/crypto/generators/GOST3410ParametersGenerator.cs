            ...
            for (int i = 0; i < s; i++)
            {
                ...
                for (; ; )
                {
                    ...
                    BigInteger N = BigInteger
                        .One.ShiftLeft(t[m] - 1)
                        .Divide(p[m + 1])
                        .Add(Ym.ShiftLeft(t[m] - 1).Divide(p[m + 1].ShiftLeft(16 * rm)));
                    ...
                    for (; ; )
                    {
                        ...
                        //step13
                        if (
                            BigInteger.Two.ModPow(NByLastP, p[m]).CompareTo(BigInteger.One) == 0
            ...
            for (int i = 0; i < s; i++)
            {
                ...
                for (; ; )
                {
                    ...
                    BigInteger N = BigInteger
                        .One.ShiftLeft(t[m] - 1)
                        .Divide(p[m + 1])
                        .Add(Ym.ShiftLeft(t[m] - 1).Divide(p[m + 1].ShiftLeft(32 * rm)));
        ...
        private void procedure_B(int x0, int c, BigInteger[] pq)
        {
            ...
            for (; ; )
            {
                ...
                BigInteger N = BigInteger
                    .One.ShiftLeft(tp - 1)
                    .Divide(qQ)
                    .Add(Y.ShiftLeft(tp - 1).Divide(qQ.ShiftLeft(1024)));
                ...
                for (; ; )
                {
                    ...
                    //step10
                    if (
                        BigInteger.Two.ModPow(qQN, p).CompareTo(BigInteger.One) == 0
