    ...
    internal static class GcmUtilities
    {
        ...
        internal static void Multiply(ref FieldElement x, ref FieldElement y)
        {
            ...
            else
            {
                ...
                ulong y0 = y.n0,
                    y1 = y.n1;
                ulong x0r = Longs.Reverse(x0),
                    x1r = Longs.Reverse(x1);
                ulong y0r = Longs.Reverse(y0),
                    y1r = Longs.Reverse(y1);
                ulong z3;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void MultiplyExt(
            Vector128<ulong> X,
            Vector128<ulong> Y,
            out Vector128<ulong> Z0,
            out Vector128<ulong> Z1,
            out Vector128<ulong> Z2
        )
        {
            if (!Org.BouncyCastle.Runtime.Intrinsics.X86.Pclmulqdq.IsEnabled)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Vector128<ulong> Reduce3(
            Vector128<ulong> Z0,
            Vector128<ulong> Z1,
            Vector128<ulong> Z2
        )
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void SquareExt(
            Vector128<ulong> X,
            out Vector128<ulong> Z0,
            out Vector128<ulong> Z2
        )
