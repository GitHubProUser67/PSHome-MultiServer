...
namespace Org.BouncyCastle.Crypto.Utilities
{
    ...
    public class CipherFactory
    {
        ...
        )
        {
            ...
            {
                if (
                    encAlg.Equals(PkcsObjectIdentifiers.DesEde3Cbc)
                ...
                else if (encAlg.Equals(PkcsObjectIdentifiers.RC2Cbc))
                {
                    ...
                    cipher.Init(
                        forEncryption,
                        new ParametersWithIV(rc2Parameters, rc2CbcParameter.IV.GetOctets())
                    );
                }
                else
                {
        ...
        private static BufferedBlockCipher CreateCipher(DerObjectIdentifier algorithm)
        {
            ...
            if (
                NistObjectIdentifiers.IdAes128Cbc.Equals(algorithm)
