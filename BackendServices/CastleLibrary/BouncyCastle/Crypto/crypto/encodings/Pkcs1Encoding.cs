    ...
    */
    public class Pkcs1Encoding : IAsymmetricBlockCipher
    {
        ...
        static Pkcs1Encoding()
        {
            ...
            bool strictLengthEnabled =
                strictProperty == null || Platform.EqualsIgnoreCase("true", strictProperty);
        ...
        */
        private byte[] DecodeBlock(byte[] input, int inOff, int inLen)
        {
            ...
            int plaintextLength = forPrivateKey
                ? CheckPkcs1Encoding2(data)
                : CheckPkcs1Encoding1(data);
            ...
            finally
            {
                ...
                Arrays.Fill(
                    blockBuffer,
                    0,
                    System.Math.Max(0, blockBuffer.Length - block.Length),
                    0
                );
            }
        }
