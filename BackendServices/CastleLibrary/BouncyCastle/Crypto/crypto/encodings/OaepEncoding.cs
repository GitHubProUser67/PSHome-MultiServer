    ...
    public class OaepEncoding : IAsymmetricBlockCipher
    {
        ...
        public void Init(bool forEncryption, ICipherParameters parameters)
        {
            ...
            this.random = forEncryption
                ? CryptoServicesRegistrar.GetSecureRandom(initRandom)
                : null;
        ...
        private byte[] EncodeBlock(byte[] inBytes, int inOff, int inLen)
        {
            ...
            //
            MaskGeneratorFunction(
                block,
                0,
                defHash.Length,
                block,
                defHash.Length,
                block.Length - defHash.Length
            );
        ...
        */
        ...
        private void MaskGeneratorFunction(
            byte[] z,
            int zOff,
            int zLen,
            byte[] mask,
        ...
        )
        {
            ...
            {
                Span<byte> buf = maskLen <= 512 ? stackalloc byte[maskLen] : new byte[maskLen];
        ...
        */
        private void MaskGeneratorFunction1(
            byte[] z,
            int zOff,
            int zLen,
            byte[] mask,
