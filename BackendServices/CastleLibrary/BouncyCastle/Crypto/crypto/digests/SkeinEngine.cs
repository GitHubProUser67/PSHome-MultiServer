...
namespace Org.BouncyCastle.Crypto.Digests
{
    ...
    public class SkeinEngine : IMemoable
    {
        ...
        public SkeinEngine(int blockSizeBits, int outputSizeBits)
        {
            if (outputSizeBits % 8 != 0)
            {
                throw new ArgumentException(
                    "Output size must be a multiple of 8 bits. :" + outputSizeBits
                );
            }
        ...
        private void CopyIn(SkeinEngine engine)
        {
            ...
            this.preMessageParameters = Clone(
                engine.preMessageParameters,
                this.preMessageParameters
            );
            this.postMessageParameters = Clone(
                engine.postMessageParameters,
        ...
        {
            var precalc = CollectionUtilities.GetValueOrNull(
                InitialStates,
                VariantIdentifier(BlockSize, OutputSize)
            );
