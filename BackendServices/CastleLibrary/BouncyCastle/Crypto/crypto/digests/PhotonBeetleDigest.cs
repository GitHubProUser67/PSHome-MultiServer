...
namespace Org.BouncyCastle.Crypto.Digests
{
    ...
    public sealed class PhotonBeetleDigest : IDigest
    {
        ...
        private static readonly byte[][] MixColMatrix =
        { //[D][D]
        ...
        public int DoFinal(Span<byte> output)
        {
            ...
            PHOTON_Permutation();
            state
                .AsSpan(0, TAG_INBYTES - SQUEEZE_RATE_INBYTES)
                .CopyTo(output[SQUEEZE_RATE_INBYTES..]);
