...
namespace Org.BouncyCastle.Crypto.Digests
{
    ...
    public static class Haraka512_X86
    {
        ...
        private static void ImplRounds(
            ref Vector128<byte> s0,
            ref Vector128<byte> s1,
            ref Vector128<byte> s2,
            ref Vector128<byte> s3,
            ReadOnlySpan<Vector128<byte>> rc
        )
        {
