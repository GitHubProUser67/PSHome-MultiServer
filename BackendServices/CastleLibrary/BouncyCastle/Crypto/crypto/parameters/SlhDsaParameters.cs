...
namespace Org.BouncyCastle.Crypto.Parameters
{
    public sealed class SlhDsaParameters
    {
        ...
        internal static readonly IDictionary<string, SlhDsaParameters> ByName =
        ...
        internal static readonly IDictionary<DerObjectIdentifier, SlhDsaParameters> ByOid =
            CollectionUtilities.ReadOnly(
        ...
        private SlhDsaParameters(
            string name,
            SlhDsaParameterSet parameterSet,
