...
{
    public sealed class MLKemPrivateKeyParameters : MLKemKeyParameters
    {
        public enum Format
        {
            SeedOnly,
        ...
        public static MLKemPrivateKeyParameters FromEncoding(
        ...
        )
        {
            ...
            return new MLKemPrivateKeyParameters(
                parameters,
                s,
                hpk,
                nonce,
        ...
        public static MLKemPrivateKeyParameters FromSeed(
            MLKemParameters parameters,
            byte[] seed,
        ...
        )
        {
            ...
            engine.GenerateKemKeyPairInternal(
                d,
                z,
                out byte[] t,
                out byte[] rho,
        ...
        internal MLKemPrivateKeyParameters(
            MLKemParameters parameters,
            byte[] s,
            byte[] hpk,
            byte[] nonce,
