...
namespace Org.BouncyCastle.Crypto.Parameters
{
    ...
    {
        public static readonly MLKemParameterSet ml_kem_512 = new MLKemParameterSet(
            "ML-KEM-512",
            2
        );
        public static readonly MLKemParameterSet ml_kem_768 = new MLKemParameterSet(
            "ML-KEM-768",
            3
        );
        public static readonly MLKemParameterSet ml_kem_1024 = new MLKemParameterSet(
            "ML-KEM-1024",
            4
        );

        private static readonly Dictionary<string, MLKemParameterSet> ByName = new Dictionary<
            string,
            MLKemParameterSet
        >()
        {
        ...
        internal static MLKemParameterSet FromName(string name) =>
