...
namespace Org.BouncyCastle.Crypto.Parameters
{
    ...
    {
        public static readonly MLDsaParameters ml_dsa_44 = new MLDsaParameters(
            "ML-DSA-44",
            MLDsaParameterSet.ml_dsa_44,
            NistObjectIdentifiers.id_ml_dsa_44,
            null
        );
        public static readonly MLDsaParameters ml_dsa_65 = new MLDsaParameters(
            "ML-DSA-65",
            MLDsaParameterSet.ml_dsa_65,
            NistObjectIdentifiers.id_ml_dsa_65,
            null
        );
        public static readonly MLDsaParameters ml_dsa_87 = new MLDsaParameters(
            "ML-DSA-87",
        ...
        public static readonly MLDsaParameters ml_dsa_44_with_sha512 = new MLDsaParameters(
            "ML-DSA-44-WITH-SHA512",
            MLDsaParameterSet.ml_dsa_44,
            NistObjectIdentifiers.id_hash_ml_dsa_44_with_sha512,
            NistObjectIdentifiers.IdSha512
        );
        public static readonly MLDsaParameters ml_dsa_65_with_sha512 = new MLDsaParameters(
            "ML-DSA-65-WITH-SHA512",
            MLDsaParameterSet.ml_dsa_65,
            NistObjectIdentifiers.id_hash_ml_dsa_65_with_sha512,
            NistObjectIdentifiers.IdSha512
        );
        public static readonly MLDsaParameters ml_dsa_87_with_sha512 = new MLDsaParameters(
        ...
        internal static readonly IDictionary<string, MLDsaParameters> ByName =
            CollectionUtilities.ReadOnly(
        ...
        internal static readonly IDictionary<DerObjectIdentifier, MLDsaParameters> ByOid =
            CollectionUtilities.ReadOnly(
