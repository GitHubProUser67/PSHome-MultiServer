...
namespace Org.BouncyCastle.Crypto.Parameters
{
    public class ECDomainParameters
    {
        ...
        public static ECDomainParameters LookupName(string name)
        {
            ...
            var x9 =
                ECUtilities.FindECCurveByName(name)
                ?? throw new ArgumentException(
                    "Name is not a valid public key parameter set",
                    nameof(name)
                );
        ...
        public BigInteger HInv =>
            Objects.EnsureSingletonInitialized(
                ref m_hInv,
                this,
                self => BigIntegers.ModOddInverseVar(self.N, self.H)
            );
        ...
        {
            return m_curve.Equals(other.m_curve) && m_g.Equals(other.m_g) && m_n.Equals(other.m_n);
        }
