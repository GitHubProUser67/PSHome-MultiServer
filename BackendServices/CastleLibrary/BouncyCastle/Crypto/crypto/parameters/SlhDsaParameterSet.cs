...
namespace Org.BouncyCastle.Crypto.Parameters
{
    ...
    {
        public static readonly SlhDsaParameterSet slh_dsa_sha2_128s = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-128s",
            new Sha2EngineProvider(n: 16, w: 16, d: 7, a: 12, k: 14, h: 63)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_128s = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-128s",
            new Shake256EngineProvider(n: 16, w: 16, d: 7, a: 12, k: 14, h: 63)
        );

        public static readonly SlhDsaParameterSet slh_dsa_sha2_128f = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-128f",
            new Sha2EngineProvider(n: 16, w: 16, d: 22, a: 6, k: 33, h: 66)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_128f = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-128f",
            new Shake256EngineProvider(n: 16, w: 16, d: 22, a: 6, k: 33, h: 66)
        );

        public static readonly SlhDsaParameterSet slh_dsa_sha2_192s = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-192s",
            new Sha2EngineProvider(n: 24, w: 16, d: 7, a: 14, k: 17, h: 63)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_192s = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-192s",
            new Shake256EngineProvider(n: 24, w: 16, d: 7, a: 14, k: 17, h: 63)
        );

        public static readonly SlhDsaParameterSet slh_dsa_sha2_192f = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-192f",
            new Sha2EngineProvider(n: 24, w: 16, d: 22, a: 8, k: 33, h: 66)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_192f = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-192f",
            new Shake256EngineProvider(n: 24, w: 16, d: 22, a: 8, k: 33, h: 66)
        );

        public static readonly SlhDsaParameterSet slh_dsa_sha2_256s = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-256s",
            new Sha2EngineProvider(n: 32, w: 16, d: 8, a: 14, k: 22, h: 64)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_256s = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-256s",
            new Shake256EngineProvider(n: 32, w: 16, d: 8, a: 14, k: 22, h: 64)
        );

        public static readonly SlhDsaParameterSet slh_dsa_sha2_256f = new SlhDsaParameterSet(
            "SLH-DSA-SHA2-256f",
            new Sha2EngineProvider(n: 32, w: 16, d: 17, a: 9, k: 35, h: 68)
        );
        public static readonly SlhDsaParameterSet slh_dsa_shake_256f = new SlhDsaParameterSet(
            "SLH-DSA-SHAKE-256f",
            new Shake256EngineProvider(n: 32, w: 16, d: 17, a: 9, k: 35, h: 68)
        );

        private static readonly Dictionary<string, SlhDsaParameterSet> ByName = new Dictionary<
            string,
            SlhDsaParameterSet
        >()
        {
        ...
        internal static SlhDsaParameterSet FromName(string name) =>
            CollectionUtilities.GetValueOrNull(ByName, name);
    ...
    internal sealed class Sha2EngineProvider : ISlhDsaEngineProvider
    {
    ...
    internal sealed class Shake256EngineProvider : ISlhDsaEngineProvider
    {
        private readonly int n,
            w,
            d,
