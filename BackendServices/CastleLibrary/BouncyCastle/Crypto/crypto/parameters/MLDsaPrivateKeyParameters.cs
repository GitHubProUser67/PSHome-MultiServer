...
namespace Org.BouncyCastle.Crypto.Parameters
{
    public sealed class MLDsaPrivateKeyParameters : MLDsaKeyParameters
    {
        ...
        public static MLDsaPrivateKeyParameters FromEncoding(
        ...
        public static MLDsaPrivateKeyParameters FromSeed(
            MLDsaParameters parameters,
            byte[] seed,
        ...
        )
        {
            ...
            engine.GenerateKeyPairInternal(
                seed,
                out var rho,
                out var k,
                out var tr,
        ...
        internal MLDsaPrivateKeyParameters(
            MLDsaParameters parameters,
            byte[] rho,
            byte[] k,
            byte[] tr,
        ...
        public MLDsaPublicKeyParameters GetPublicKey() =>
            new MLDsaPublicKeyParameters(Parameters, m_rho, m_t1);
