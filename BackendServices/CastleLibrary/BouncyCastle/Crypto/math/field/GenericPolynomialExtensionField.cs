...
{
    internal class GenericPolynomialExtensionField : IPolynomialExtensionField
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return subfield.Equals(other.subfield)
                && minimalPolynomial.Equals(other.minimalPolynomial);
        }

        public override int GetHashCode()
        {
            return subfield.GetHashCode()
                ^ Integers.RotateLeft(minimalPolynomial.GetHashCode(), 16);
        }
    }
}
