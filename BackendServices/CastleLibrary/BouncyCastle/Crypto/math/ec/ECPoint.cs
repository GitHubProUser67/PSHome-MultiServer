...
namespace Org.BouncyCastle.Math.EC
{
    ...
    public abstract class ECPoint
    {
        ...
        internal bool ImplIsValid(bool decompressed, bool checkOrder)
        {
            ...
            ValidityPreCompInfo validity = (ValidityPreCompInfo)
                Curve.Precompute(this, ValidityPreCompInfo.PRECOMP_NAME, callback);
        ...
        private class ValidityCallback : IPreCompCallback
        {
            ...
            public PreCompInfo Precompute(PreCompInfo existing)
            {
                ValidityPreCompInfo info =
                    existing as ValidityPreCompInfo ?? new ValidityPreCompInfo();
    ...
    public abstract class ECPointBase : ECPoint
    {
        ...
        public override void EncodeTo(bool compressed, Span<byte> buf)
        {
            ...
            ECPoint normed = Normalize();
            ECFieldElement X = normed.XCoord,
                Y = normed.YCoord;
    ...
    public class FpPoint : AbstractFpPoint
    {
        ...
        public override ECPoint TimesPow2(int e)
        {
            ...
            ECFieldElement X1 = this.RawXCoord;
            ECFieldElement Z1 =
                this.RawZCoords.Length < 1
                    ? curve.FromBigInteger(BigInteger.One)
                    : this.RawZCoords[0];
        ...
        public virtual AbstractF2mPoint TauPow(int pow)
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_LAMBDA_AFFINE:
                {
                    ECFieldElement Y1 = this.RawYCoord;
                    return (AbstractF2mPoint)
                        curve.CreateRawPoint(X1.SquarePow(pow), Y1.SquarePow(pow));
                }
                case ECCurve.COORD_HOMOGENEOUS:
                case ECCurve.COORD_LAMBDA_PROJECTIVE:
                {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            switch (coord)
            {
                ...
                case ECCurve.COORD_HOMOGENEOUS:
                {
                    ...
                    ECFieldElement Y3 = U.MultiplyPlusProduct(X1, V, Y1)
                ...
                case ECCurve.COORD_LAMBDA_PROJECTIVE:
                {
                    ...
                    ECFieldElement L1 = this.RawYCoord,
                        Z1 = this.RawZCoords[0];
