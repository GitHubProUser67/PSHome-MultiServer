...
namespace Org.BouncyCastle.Math.EC.Abc
{
    ...
    */
    internal static class Tnaf
    {
        ...
        */
        public static ZTauElement Round(
            SimpleBigDecimal lambda0,
        ...
        */
        public static sbyte[] TauAdicNaf(sbyte mu, ZTauElement lambda)
        {
            ...
            while (!((r0.Equals(BigInteger.Zero)) && (r1.Equals(BigInteger.Zero))))
            {
                ...
                {
                    u[i] = (sbyte)
                        BigInteger.Two.Subtract((r0.Subtract(r1.ShiftLeft(1))).Mod(Four)).IntValue;
        ...
        */
        ...
        )
        {
            ...
            PartModPreCompInfo preCompInfo = (PartModPreCompInfo)
                curve.Precompute(PRECOMP_NAME, callback);
            ...
            // r0 = n - d0*q0 - 2*s1*q1
            BigInteger r0 = k.Subtract(d0.Multiply(q.u)).Subtract(s1.Multiply(q.v).ShiftLeft(1));
        ...
        private sealed class PartModPreCompCallback : IPreCompCallback
        {
            ...
            public PreCompInfo Precompute(PreCompInfo existing)
            {
                ...
                if (m_curve.IsKoblitz)
                {
                     ...
                     */
                    lucas = BigInteger
                        .One.ShiftLeft(m_curve.FieldSize)
                        .Add(BigInteger.One)
                        .Subtract(m_curve.Order.Multiply(m_curve.Cofactor));
                }
                else
                {
