...
namespace Org.BouncyCastle.Math.EC.Rfc7748
{
    ...
    public static class X448Field
    {
        ...
        private static readonly uint[] P32 =
        {
            0xFFFFFFFFU,
            0xFFFFFFFFU,
            0xFFFFFFFFU,
        ...
        public static void Mul(uint[] x, uint[] y, uint[] z)
        {
            ...
            ulong f1 = (ulong)x1 * y0 + (ulong)x0 * y1;
            ulong f9 =
                (ulong)x7 * y2
                + (ulong)x6 * y3
                + (ulong)x5 * y4
                ...
                + (ulong)x3 * y6
                + (ulong)x2 * y7;
            ulong g1 = (ulong)u1 * v0 + (ulong)u0 * v1;
            ulong g9 =
                (ulong)u7 * v2
                + (ulong)u6 * v3
                + (ulong)u5 * v4
                ...
                + (ulong)u3 * v6
                + (ulong)u2 * v7;
            ulong h1 = (ulong)s1 * t0 + (ulong)s0 * t1;
            ulong h9 =
                (ulong)s7 * t2
                + (ulong)s6 * t3
                + (ulong)s5 * t4
            ...
            ulong f2 = (ulong)x2 * y0 + (ulong)x1 * y1 + (ulong)x0 * y2;
            ulong f10 =
                (ulong)x7 * y3 + (ulong)x6 * y4 + (ulong)x5 * y5 + (ulong)x4 * y6 + (ulong)x3 * y7;
            ulong g2 = (ulong)u2 * v0 + (ulong)u1 * v1 + (ulong)u0 * v2;
            ulong g10 =
                (ulong)u7 * v3 + (ulong)u6 * v4 + (ulong)u5 * v5 + (ulong)u4 * v6 + (ulong)u3 * v7;
            ulong h2 = (ulong)s2 * t0 + (ulong)s1 * t1 + (ulong)s0 * t2;
            ulong h10 =
                (ulong)s7 * t3 + (ulong)s6 * t4 + (ulong)s5 * t5 + (ulong)s4 * t6 + (ulong)s3 * t7;
            ...
            ulong f3 = (ulong)x3 * y0 + (ulong)x2 * y1 + (ulong)x1 * y2 + (ulong)x0 * y3;
            ulong f11 = (ulong)x7 * y4 + (ulong)x6 * y5 + (ulong)x5 * y6 + (ulong)x4 * y7;
            ulong g3 = (ulong)u3 * v0 + (ulong)u2 * v1 + (ulong)u1 * v2 + (ulong)u0 * v3;
            ulong g11 = (ulong)u7 * v4 + (ulong)u6 * v5 + (ulong)u5 * v6 + (ulong)u4 * v7;
            ulong h3 = (ulong)s3 * t0 + (ulong)s2 * t1 + (ulong)s1 * t2 + (ulong)s0 * t3;
            ulong h11 = (ulong)s7 * t4 + (ulong)s6 * t5 + (ulong)s5 * t6 + (ulong)s4 * t7;
            ...
            ulong f4 =
                (ulong)x4 * y0 + (ulong)x3 * y1 + (ulong)x2 * y2 + (ulong)x1 * y3 + (ulong)x0 * y4;
            ulong f12 = (ulong)x7 * y5 + (ulong)x6 * y6 + (ulong)x5 * y7;
            ulong g4 =
                (ulong)u4 * v0 + (ulong)u3 * v1 + (ulong)u2 * v2 + (ulong)u1 * v3 + (ulong)u0 * v4;
            ulong g12 = (ulong)u7 * v5 + (ulong)u6 * v6 + (ulong)u5 * v7;
            ulong h4 =
                (ulong)s4 * t0 + (ulong)s3 * t1 + (ulong)s2 * t2 + (ulong)s1 * t3 + (ulong)s0 * t4;
            ulong h12 = (ulong)s7 * t5 + (ulong)s6 * t6 + (ulong)s5 * t7;
            ...
            ulong f5 =
                ...
                + (ulong)x1 * y4
                + (ulong)x0 * y5;
            ulong f13 = (ulong)x7 * y6 + (ulong)x6 * y7;
            ulong g5 =
                (ulong)u5 * v0
                + (ulong)u4 * v1
                + (ulong)u3 * v2
                ...
                + (ulong)u1 * v4
                + (ulong)u0 * v5;
            ulong g13 = (ulong)u7 * v6 + (ulong)u6 * v7;
            ulong h5 =
                (ulong)s5 * t0
                + (ulong)s4 * t1
                + (ulong)s3 * t2
                ...
                + (ulong)s1 * t4
                + (ulong)s0 * t5;
            ulong h13 = (ulong)s7 * t6 + (ulong)s6 * t7;
        ...
        public static void Sqr(uint[] x, uint[] z)
        {
            ...
            ulong f8 = (ulong)x7 * x1_2 + (ulong)x6 * x2_2 + (ulong)x5 * x3_2 + (ulong)x4 * x4;
            ulong g0 = (ulong)u0 * u0;
            ulong g8 = (ulong)u7 * u1_2 + (ulong)u6 * u2_2 + (ulong)u5 * u3_2 + (ulong)u4 * u4;
            ulong h0 = (ulong)s0 * s0;
            ulong h8 = (ulong)s7 * s1_2 + (ulong)s6 * s2_2 + (ulong)s5 * s3_2 + (ulong)s4 * s4;
            ...
            ulong f9 = (ulong)x7 * x2_2 + (ulong)x6 * x3_2 + (ulong)x5 * x4_2;
            ulong g1 = (ulong)u1 * u0_2;
            ulong g9 = (ulong)u7 * u2_2 + (ulong)u6 * u3_2 + (ulong)u5 * u4_2;
            ulong h1 = (ulong)s1 * s0_2;
            ulong h9 = (ulong)s7 * s2_2 + (ulong)s6 * s3_2 + (ulong)s5 * s4_2;
            ...
            ulong f2 = (ulong)x2 * x0_2 + (ulong)x1 * x1;
            ulong f10 = (ulong)x7 * x3_2 + (ulong)x6 * x4_2 + (ulong)x5 * x5;
            ulong g2 = (ulong)u2 * u0_2 + (ulong)u1 * u1;
            ulong g10 = (ulong)u7 * u3_2 + (ulong)u6 * u4_2 + (ulong)u5 * u5;
            ulong h2 = (ulong)s2 * s0_2 + (ulong)s1 * s1;
            ulong h10 = (ulong)s7 * s3_2 + (ulong)s6 * s4_2 + (ulong)s5 * s5;
            ...
            ulong f3 = (ulong)x3 * x0_2 + (ulong)x2 * x1_2;
            ulong f11 = (ulong)x7 * x4_2 + (ulong)x6 * x5_2;
            ulong g3 = (ulong)u3 * u0_2 + (ulong)u2 * u1_2;
            ulong g11 = (ulong)u7 * u4_2 + (ulong)u6 * u5_2;
            ulong h3 = (ulong)s3 * s0_2 + (ulong)s2 * s1_2;
            ulong h11 = (ulong)s7 * s4_2 + (ulong)s6 * s5_2;
            ...
            ulong f4 = (ulong)x4 * x0_2 + (ulong)x3 * x1_2 + (ulong)x2 * x2;
            ulong f12 = (ulong)x7 * x5_2 + (ulong)x6 * x6;
            ulong g4 = (ulong)u4 * u0_2 + (ulong)u3 * u1_2 + (ulong)u2 * u2;
            ulong g12 = (ulong)u7 * u5_2 + (ulong)u6 * u6;
            ulong h4 = (ulong)s4 * s0_2 + (ulong)s3 * s1_2 + (ulong)s2 * s2;
            ulong h12 = (ulong)s7 * s5_2 + (ulong)s6 * s6;
            ...
            ulong f5 = (ulong)x5 * x0_2 + (ulong)x4 * x1_2 + (ulong)x3 * x2_2;
            ulong f13 = (ulong)x7 * x6_2;
            ulong g5 = (ulong)u5 * u0_2 + (ulong)u4 * u1_2 + (ulong)u3 * u2_2;
            ulong g13 = (ulong)u7 * u6_2;
            ulong h5 = (ulong)s5 * s0_2 + (ulong)s4 * s1_2 + (ulong)s3 * s2_2;
            ...
            ulong f6 = (ulong)x6 * x0_2 + (ulong)x5 * x1_2 + (ulong)x4 * x2_2 + (ulong)x3 * x3;
            ulong f14 = (ulong)x7 * x7;
            ulong g6 = (ulong)u6 * u0_2 + (ulong)u5 * u1_2 + (ulong)u4 * u2_2 + (ulong)u3 * u3;
            ulong g14 = (ulong)u7 * u7;
            ulong h6 = (ulong)s6 * s0_2 + (ulong)s5 * s1_2 + (ulong)s4 * s2_2 + (ulong)s3 * s3;
            ...
            ulong f7 = (ulong)x7 * x0_2 + (ulong)x6 * x1_2 + (ulong)x5 * x2_2 + (ulong)x4 * x3_2;
            ulong g7 = (ulong)u7 * u0_2 + (ulong)u6 * u1_2 + (ulong)u5 * u2_2 + (ulong)u4 * u3_2;
            ulong h7 = (ulong)s7 * s0_2 + (ulong)s6 * s1_2 + (ulong)s5 * s2_2 + (ulong)s4 * s3_2;
