...
namespace Org.BouncyCastle.Math.EC.Rfc8032
{
    ...
    public static class Ed25519
    {
        ...
        private static readonly uint[] Order8_y1 =
        {
            0x706A17C7U,
            0x4FD84D3DU,
            0x760B3CBAU,
        ...
        private static readonly uint[] Order8_y2 =
        {
            0x8F95E826U,
            0xB027B2C2U,
            0x89F4C345U,
        ...
        // 2^128 * B
        private static readonly int[] B128_x =
        {
            0x00B7E824,
            0x0011EB98,
            0x003E5FC8,
        ...
        private static readonly int[] B128_y =
        {
            0x03F5A66B,
            0x02AF4452,
            0x0049E5BB,
        ...
        )
        {
            ...
            Span<uint> u = stackalloc uint[ScalarUints];
            Scalar25519.Decode(k, u);
            Span<uint> v = stackalloc uint[ScalarUints];
        ...
        )
        {
            ...
            {
                int cond = ((i ^ abs) - 1) >> 31;
                F.CMov(cond, table, r.ymx_h);
                table = table[F.Size..];
                F.CMov(cond, table, r.ypx_h);
                table = table[F.Size..];
                F.CMov(cond, table, r.xyd);
                table = table[F.Size..];
                F.CMov(cond, table, r.z);
                table = table[F.Size..];
            }
                ...
                for (int block = 0; block < PrecompBlocks; ++block)
                {
                    ...
                    for (int tooth = 0; tooth < (PrecompTeeth - 1); ++tooth)
                    {
                        ...
                        for (int j = 0; j < size; ++j, ++pointsIndex)
                        {
                            ...
                            PointAdd(
                                ref points[pointsIndex - size],
                                ref toothPowers[tooth],
        ...
        private static void ScalarMultStraus128Var(
            ReadOnlySpan<uint> nb,
            ReadOnlySpan<uint> np,
            ref PointAffine p,
            ReadOnlySpan<uint> nq,
            ref PointAffine q,
            ref PointAccum r
        )
        {
