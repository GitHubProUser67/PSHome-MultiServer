...
namespace Org.BouncyCastle.Math.EC.Rfc8032
{
    ...
    public static class Ed448
    {
        ...
        // 2^225 * B
        private static readonly uint[] B225_x =
        {
            0x06909EE2U,
            0x01D7605CU,
            0x0995EC8AU,
        ...
        private static readonly uint[] B225_y =
        {
            0x0D3A9FE4U,
            0x030696B9U,
            0x07E7E326U,
        ...
        )
        {
            ...
            Span<uint> t = stackalloc uint[ScalarUints * 2 + 1];
        ...
        private static void PointLookup(
            ReadOnlySpan<uint> x,
            int n,
        ...
        )
        {
            ...
            {
                int cond = ((i ^ abs) - 1) >> 31;
                F.CMov(cond, table, r.x);
                table = table[F.Size..];
                F.CMov(cond, table, r.y);
                table = table[F.Size..];
