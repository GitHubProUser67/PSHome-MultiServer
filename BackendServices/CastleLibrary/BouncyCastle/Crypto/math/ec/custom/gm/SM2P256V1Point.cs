...
namespace Org.BouncyCastle.Math.EC.Custom.GM
{
    internal class SM2P256V1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SM2P256V1FieldElement X1 = (SM2P256V1FieldElement)this.RawXCoord,
                Y1 = (SM2P256V1FieldElement)this.RawYCoord;
            SM2P256V1FieldElement X2 = (SM2P256V1FieldElement)b.RawXCoord,
                Y2 = (SM2P256V1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SM2P256V1FieldElement X1 = (SM2P256V1FieldElement)this.RawXCoord,
                Z1 = (SM2P256V1FieldElement)this.RawZCoords[0];
