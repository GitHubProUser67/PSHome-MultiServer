...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP128R1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP128R1FieldElement X1 = (SecP128R1FieldElement)this.RawXCoord,
                Y1 = (SecP128R1FieldElement)this.RawYCoord;
            SecP128R1FieldElement X2 = (SecP128R1FieldElement)b.RawXCoord,
                Y2 = (SecP128R1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP128R1FieldElement X1 = (SecP128R1FieldElement)this.RawXCoord,
                Z1 = (SecP128R1FieldElement)this.RawZCoords[0];
