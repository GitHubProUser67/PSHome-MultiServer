...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP224K1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP224K1FieldElement X1 = (SecP224K1FieldElement)this.RawXCoord,
                Y1 = (SecP224K1FieldElement)this.RawYCoord;
            SecP224K1FieldElement X2 = (SecP224K1FieldElement)b.RawXCoord,
                Y2 = (SecP224K1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP224K1FieldElement X1 = (SecP224K1FieldElement)this.RawXCoord,
                Z1 = (SecP224K1FieldElement)this.RawZCoords[0];
