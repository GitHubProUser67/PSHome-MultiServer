...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP384R1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP384R1FieldElement X1 = (SecP384R1FieldElement)this.RawXCoord,
                Y1 = (SecP384R1FieldElement)this.RawYCoord;
            SecP384R1FieldElement X2 = (SecP384R1FieldElement)b.RawXCoord,
                Y2 = (SecP384R1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP384R1FieldElement X1 = (SecP384R1FieldElement)this.RawXCoord,
                Z1 = (SecP384R1FieldElement)this.RawZCoords[0];
