    ...
    internal class SecP160R2Curve : AbstractFpCurve
    {
            ...
            : base(q, isInternal: true)
        {
            ...
            this.m_a = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70"))
            );
            this.m_b = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA"))
            );
            this.m_order = new BigInteger(
                1,
                Hex.DecodeStrict("0100000000000000000000351EE786A818F3A1A16B")
            );
