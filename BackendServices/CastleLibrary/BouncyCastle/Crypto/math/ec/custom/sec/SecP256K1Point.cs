...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP256K1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP256K1FieldElement X1 = (SecP256K1FieldElement)this.RawXCoord,
                Y1 = (SecP256K1FieldElement)this.RawYCoord;
            SecP256K1FieldElement X2 = (SecP256K1FieldElement)b.RawXCoord,
                Y2 = (SecP256K1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP256K1FieldElement X1 = (SecP256K1FieldElement)this.RawXCoord,
                Z1 = (SecP256K1FieldElement)this.RawZCoords[0];
