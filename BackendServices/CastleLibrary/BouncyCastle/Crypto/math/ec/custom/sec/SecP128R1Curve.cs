    ...
    internal class SecP128R1Curve : AbstractFpCurve
    {
            ...
            : base(q, isInternal: true)
        {
            ...
            this.m_a = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC"))
            );
            this.m_b = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("E87579C11079F43DD824993C2CEE5ED3"))
            );
