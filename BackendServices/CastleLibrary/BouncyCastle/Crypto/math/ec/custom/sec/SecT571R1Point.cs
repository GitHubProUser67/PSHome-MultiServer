...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecT571R1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecT571FieldElement L1 = (SecT571FieldElement)this.RawYCoord,
                Z1 = (SecT571FieldElement)this.RawZCoords[0];
            SecT571FieldElement L2 = (SecT571FieldElement)b.RawYCoord,
                Z2 = (SecT571FieldElement)b.RawZCoords[0];
        ...
        public override ECPoint Twice()
        {
            ...
            {
                return new SecT571R1Point(
                    curve,
                    new SecT571FieldElement(T),
