    ...
    internal class SecT113R2Curve : AbstractF2mCurve
    {
            ...
            : base(113, 9, 0, 0)
        {
            ...
            this.m_a = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("00689918DBEC7E5A0DD6DFC0AA55C7"))
            );
            this.m_b = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("0095E9A9EC9B297BD4BF36E059184F"))
            );
