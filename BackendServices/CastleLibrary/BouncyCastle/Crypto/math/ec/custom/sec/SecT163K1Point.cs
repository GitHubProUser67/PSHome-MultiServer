...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecT163K1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecT163FieldElement L1 = (SecT163FieldElement)this.RawYCoord,
                Z1 = (SecT163FieldElement)this.RawZCoords[0];
            SecT163FieldElement L2 = (SecT163FieldElement)b.RawYCoord,
                Z2 = (SecT163FieldElement)b.RawZCoords[0];
            ...
            return new SecT163K1Point(
                curve,
                new SecT163FieldElement(_X3),
                new SecT163FieldElement(_L3),
