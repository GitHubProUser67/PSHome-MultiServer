    ...
    internal class SecT131R2Curve : AbstractF2mCurve
    {
            ...
            : base(131, 2, 3, 8)
        {
            ...
            this.m_a = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("03E5A88919D7CAFCBF415F07C2176573B2"))
            );
            this.m_b = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("04B8266A46C55657AC734CE38F018F2192"))
            );
            this.m_order = new BigInteger(
                1,
                Hex.DecodeStrict("0400000000000000016954A233049BA98F")
            );
