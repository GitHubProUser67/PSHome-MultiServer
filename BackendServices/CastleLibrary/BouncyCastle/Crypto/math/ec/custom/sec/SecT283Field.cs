...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal static class SecT283Field
    {
        ...
        {
            0x0C30C30C30C30808UL,
            0x30C30C30C30C30C3UL,
            0x820820820820830CUL,
            0x0820820820820820UL,
            0x2082082UL,
        };
        ...
        )
        {
            ...
            )
            {
                ...
                var Z23 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X01, Y23, 0x00),
                    Sse2.Xor(
                        Pclmulqdq.CarrylessMultiply(X01, Y01, 0x11),
                        Pclmulqdq.CarrylessMultiply(X23, Y01, 0x00)
                    )
                );
                var Z34 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X01, Y23, 0x01),
                    Sse2.Xor(
                        Pclmulqdq.CarrylessMultiply(X01, Y23, 0x10),
                        Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(X23, Y01, 0x01),
                            Pclmulqdq.CarrylessMultiply(X23, Y01, 0x10)
                        )
                    )
                );
                var Z45 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X01, Y4_, 0x00),
                    Sse2.Xor(
                        Pclmulqdq.CarrylessMultiply(X01, Y23, 0x11),
                        Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(X23, Y23, 0x00),
                            Sse2.Xor(
                                Pclmulqdq.CarrylessMultiply(X23, Y01, 0x11),
                ...
                var Z56 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X01, Y4_, 0x01),
                    Sse2.Xor(
                        Pclmulqdq.CarrylessMultiply(X23, Y23, 0x01),
                        Sse2.Xor(
                ...
                var Z67 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X23, Y4_, 0x00),
                    Sse2.Xor(
                        Pclmulqdq.CarrylessMultiply(X23, Y23, 0x11),
                        Pclmulqdq.CarrylessMultiply(X4_, Y23, 0x00)
                    )
                );
                var Z78 = Sse2.Xor(
                    Pclmulqdq.CarrylessMultiply(X23, Y4_, 0x01),
