...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP256R1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP256R1FieldElement X1 = (SecP256R1FieldElement)this.RawXCoord,
                Y1 = (SecP256R1FieldElement)this.RawYCoord;
            SecP256R1FieldElement X2 = (SecP256R1FieldElement)b.RawXCoord,
                Y2 = (SecP256R1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP256R1FieldElement X1 = (SecP256R1FieldElement)this.RawXCoord,
                Z1 = (SecP256R1FieldElement)this.RawZCoords[0];
