...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP160R2Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP160R2FieldElement X1 = (SecP160R2FieldElement)this.RawXCoord,
                Y1 = (SecP160R2FieldElement)this.RawYCoord;
            SecP160R2FieldElement X2 = (SecP160R2FieldElement)b.RawXCoord,
                Y2 = (SecP160R2FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP160R2FieldElement X1 = (SecP160R2FieldElement)this.RawXCoord,
                Z1 = (SecP160R2FieldElement)this.RawZCoords[0];
        ...
        public override ECPoint Negate()
        {
            ...
            return new SecP160R2Point(
                Curve,
                this.RawXCoord,
                this.RawYCoord.Negate(),
                this.RawZCoords
            );
        }
    }
