...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP521R1Point : AbstractFpPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecP521R1FieldElement X1 = (SecP521R1FieldElement)this.RawXCoord,
                Y1 = (SecP521R1FieldElement)this.RawYCoord;
            SecP521R1FieldElement X2 = (SecP521R1FieldElement)b.RawXCoord,
                Y2 = (SecP521R1FieldElement)b.RawYCoord;
        ...
        public override ECPoint Twice()
        {
            ...
            SecP521R1FieldElement X1 = (SecP521R1FieldElement)this.RawXCoord,
                Z1 = (SecP521R1FieldElement)this.RawZCoords[0];
