...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecT233K1Point : AbstractF2mPoint
    {
        ...
        public override ECPoint Add(ECPoint b)
        {
            ...
            SecT233FieldElement L1 = (SecT233FieldElement)this.RawYCoord,
                Z1 = (SecT233FieldElement)this.RawZCoords[0];
            SecT233FieldElement L2 = (SecT233FieldElement)b.RawYCoord,
                Z2 = (SecT233FieldElement)b.RawZCoords[0];
            ...
            return new SecT233K1Point(
                curve,
                new SecT233FieldElement(_X3),
                new SecT233FieldElement(_L3),
