...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
    internal class SecP160R1Curve : AbstractFpCurve
    {
            ...
            : base(q, isInternal: true)
        {
            ...
            this.m_a = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC"))
            );
            this.m_b = FromBigInteger(
                new BigInteger(1, Hex.DecodeStrict("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45"))
            );
            this.m_order = new BigInteger(
                1,
                Hex.DecodeStrict("0100000000000000000001F4C8F927AED3CA752257")
            );
        ...
        private class SecP160R1LookupTable : AbstractECLookupTable
        {
            ...
            {
                return m_outer.CreateRawPoint(
                    new SecP160R1FieldElement(x),
                    new SecP160R1FieldElement(y),
                    SECP160R1_AFFINE_ZS
                );
            }
        }
