...
namespace Org.BouncyCastle.Cms
{
    internal static class CmsSignedHelper
    {
        ...
        static CmsSignedHelper()
        {
            ...
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha224,
            ...
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha384,
            ...
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha3_224,
                NistObjectIdentifiers.IdEcdsaWithSha3_224
            );
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha3_256,
                NistObjectIdentifiers.IdEcdsaWithSha3_256
            );
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha3_384,
                NistObjectIdentifiers.IdEcdsaWithSha3_384
            );
            m_ecAlgorithms.Add(
                CmsSignedGenerator.DigestSha3_512,
        ...
        */
        ...
        {
            return m_digestAliases.TryGetValue(algName, out var aliases)
                ? (string[])aliases.Clone()
                : new string[0];
        }
        ...
        */
        ...
        internal static IDigest GetDigestInstance(string algorithm) =>
            DigestUtilities.GetDigest(algorithm);

        internal static ISigner GetSignatureInstance(string algorithm) =>
            SignerUtilities.GetSigner(algorithm);
        ...
        internal static DerObjectIdentifier GetEncOid(AsymmetricKeyParameter key, string digestOID)
        {
            ...
            else if (key is ECPrivateKeyParameters ecPrivKey)
            {
                ...
                else if (ecPrivKey.Parameters is ECGost3410Parameters ecGost3410Parameters)
                {
                    ...
                    if (
                        digestParamSet.Equals(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256)
                    )
                    {
                        encOid = RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256;
                    }
                    else if (
                        digestParamSet.Equals(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512)
                    )
                    {
                ...
                else
                {
                    ...
                    if (!m_ecAlgorithms.TryGetValue(digestOID, out encOid))
                        throw new ArgumentException(
                            "can't mix ECDSA with anything but SHA family digests"
                        );
                }
            }
        ...
        internal static IStore<X509V2AttributeCertificate> GetAttributeCertificates(
            Asn1Set attrCertSet
        )
        {
            ...
            if (attrCertSet != null)
            {
                ...
                {
                    if (
                        Asn1Utilities.TryGetOptionalContextTagged(
                            element,
                            2,
                            false,
                            out var attributeCertificate,
        ...
        internal static IStore<Asn1Encodable> GetOtherRevInfos(
            Asn1Set crlSet,
            DerObjectIdentifier infoFormat
        )
        {
                ...
                foreach (Asn1Encodable element in crlSet)
                {
                    if (
                        Asn1Utilities.TryGetOptionalContextTagged(
                            ...
                            1,
                            false,
                            out var otherRevocationInfoFormat,
