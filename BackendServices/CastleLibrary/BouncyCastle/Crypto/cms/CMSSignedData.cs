    ...
    public class CmsSignedData
    {
        ...
        public CmsSignedData(ContentInfo sigData)
        {
            ...
            if (encapContent != null)
            {
                ...
                {
                    m_signedContent = new Pkcs7ProcessableObject(
        ...
        public IStore<X509Certificate> GetCertificates() =>
            CmsSignedHelper.GetCertificates(SignedData.Certificates);
        ...
        public SignerInformationStore GetSignerInfos()
        {
            if (m_signerInfoStore == null)
            {
                ...
                foreach (object element in SignedData.SignerInfos)
                {
                    ...
                    {
                        signerInfos.Add(
                            new SignerInformation(signerInfo, contentType, SignedContent, null)
                        );
                    }
                    else if (
                        m_hashes.TryGetValue(
                            signerInfo.DigestAlgorithm.Algorithm.GetID(),
                            out var hash
                        )
                    )
                    {
        ...
        )
        {
            ...
            var newContent = new SignedData(
                newDigestAlgorithms,
                oldContent.EncapContentInfo,
                oldContent.Certificates,
                oldContent.CRLs,
                oldContent.SignerInfos
            );

            return new CmsSignedData(
                signedData.ContentInfo.ContentType,
                newContent,
                signedData.m_signedContent,
        ...
        )
        {
            ...
            digestAlgorithmFinder = new PreserveAbsentParameters(
            ...
            Asn1Set newSignerInfos = signerInfos.ToAsn1Set(
                useDer: false,
        ...
        {
            return ReplaceCertificatesAndRevocations(
                signedData,
                x509Certs,
                x509Crls,
                x509AttrCerts,
        ...
        )
        {
            ...
            var content = new SignedData(
                oldContent.DigestAlgorithms,
                oldContent.EncapContentInfo,
                certSet,
                revocationSet,
                oldContent.SignerInfos
        ...
        private class PreserveAbsentParameters : IDigestAlgorithmFinder
        {
            ...
            internal PreserveAbsentParameters(
                IDigestAlgorithmFinder inner,
            ...
            public AlgorithmIdentifier Find(string digestName) =>
                Preserve(m_inner.Find(digestName));
