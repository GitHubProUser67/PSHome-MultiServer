    ...
    public class CmsAuthenticatedData
    {
        ...
        public CmsAuthenticatedData(ContentInfo contentInfo)
        {
            ...
            CmsSecureReadable secureReadable =
                new CmsEnvelopedHelper.CmsAuthenticatedSecureReadable(
                    m_authenticatedData.MacAlgorithm,
                    readable
                );
        ...
        public Asn1.Cms.AttributeTable GetAuthAttrs() =>
            m_authenticatedData.AuthAttrs?.ToAttributeTable();
        ...
        public Asn1.Cms.AttributeTable GetUnauthAttrs() =>
            m_authenticatedData.UnauthAttrs?.ToAttributeTable();
