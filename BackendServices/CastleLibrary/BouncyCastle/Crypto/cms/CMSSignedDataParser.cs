    ...
    public class CmsSignedDataParser : CmsContentInfoParser
    {
            ...
            : base(sigData)
        {
            try
            {
                ...
                this._signedData = SignedDataParser.GetInstance(
                    this.contentInfo.GetContent(Asn1Tags.Sequence)
                );
            ...
            if (_signerInfoStore == null)
            {
                ...
                try
                {
                    ...
                    while ((o = s.ReadObject()) != null)
                    {
                        ...
                        signerInfos.Add(
                            new SignerInformation(info, _signedContentType, null, hash)
                        );
                    }
                }
                catch (IOException e)
