    ...
    public class CmsEnvelopedDataStreamGenerator : CmsEnvelopedGenerator
    {
        ...
        )
        {
            try
            {
                ...
                using (
                    var recipGen = m_berEncodeRecipientSet
                ...
                BerOctetStringGenerator ecGen = new BerOctetStringGenerator(
                    eciGen.GetRawOutputStream(),
                    0,
                    false
                );
                ...
                if (disposing)
                {
                    ...
                    if (m_outer.unprotectedAttributeGenerator != null)
                    {
                        Asn1.Cms.AttributeTable attrTable =
                            m_outer.unprotectedAttributeGenerator.GetAttributes(
