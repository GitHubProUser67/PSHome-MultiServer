...
namespace Org.BouncyCastle.Cms
{
    ...
    public class DefaultDigestAlgorithmIdentifierFinder : Operators.Utilities.IDigestAlgorithmFinder
    {
        // TODO[api] Make virtual
    ...
    public abstract class CmsSignedGenerator
    {
        ...
        public static readonly string EncryptionGost3410 = CryptoProObjectIdentifiers
            .GostR3410x94
            .Id;
        public static readonly string EncryptionECGost3410 = CryptoProObjectIdentifiers
            .GostR3410x2001
            .Id;
        public static readonly string EncryptionECGost3410_2012_256 = RosstandartObjectIdentifiers
            .id_tc26_gost_3410_12_256
            .Id;
        public static readonly string EncryptionECGost3410_2012_512 = RosstandartObjectIdentifiers
        ...
        internal Dictionary<DerObjectIdentifier, byte[]> m_digests =
            new Dictionary<DerObjectIdentifier, byte[]>();
        internal IDigestAlgorithmFinder m_digestAlgorithmFinder =
            DefaultDigestAlgorithmFinder.Instance;
        ...
        protected internal virtual IDictionary<
        ...
        public void AddCertificate(X509Certificate cert) =>
            CmsUtilities.CollectCertificate(_certs, cert);
        ...
        public IDigestAlgorithmFinder DigestAlgorithmFinder
        {
            ...
            set
            {
                m_digestAlgorithmFinder = value ?? throw new ArgumentNullException(nameof(value));
            }
        }
        ...
        [Obsolete(
            "Will be removed. Replaced in CmsSignedDataGenerator by the similar 'UseDefiniteLength' property"
        )]
        ...
        internal static SignerIdentifier GetSignerIdentifier(X509Certificate c) =>
            CmsUtilities.GetSignerIdentifier(c);
