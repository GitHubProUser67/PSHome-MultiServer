...
namespace Org.BouncyCastle.Cms
{
    internal class CmsEnvelopedHelper
    {
        ...
        )
        {
            ...
            {
                KeyAgreeRecipientInformation.ReadRecipientInfo(
                    infos,
        ...
        internal class CmsAuthenticatedSecureReadable : CmsSecureReadable
        {
            ...
            internal CmsAuthenticatedSecureReadable(
            ...
            public CmsReadable GetReadable(KeyParameter sKey)
            {
                ...
                try
                {
                    return new CmsProcessableInputStream(
                        new TeeInputStream(readable.GetInputStream(), new MacSink(this.mac))
                    );
                }
                catch (IOException e)
                {
            ...
            public CmsReadable GetReadable(KeyParameter sKey)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if (
                            alg.Equals(CmsEnvelopedGenerator.DesEde3Cbc)
                            || alg.Equals(CmsEnvelopedGenerator.IdeaCbc)
                            || alg.Equals(CmsEnvelopedGenerator.Cast5Cbc)
                        )
                        {
                            cipherParameters = ParametersWithIV.Create<byte>(
                                cipherParameters,
                                8,
                                0,
