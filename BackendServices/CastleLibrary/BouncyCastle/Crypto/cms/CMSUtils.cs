...
namespace Org.BouncyCastle.Cms
{
    internal static class CmsUtilities
    {
        ...
        internal static byte[] StreamToByteArray(Stream inStream, int limit) =>
            Streams.ReadAllLimited(inStream, limit);

        internal static void AddDigestAlgorithms(
            DigestAlgorithmsBuilder builder,
        ...
        internal static IssuerAndSerialNumber GetIssuerAndSerialNumber(
        ...
        internal static void CollectAttributeCertificate(
            List<Asn1Encodable> result,
        ...
        internal static void CollectAttributeCertificates(
            List<Asn1Encodable> result,
        ...
        internal static void CollectCertificates(
            List<Asn1Encodable> result,
        ...
        internal static void CollectOtherRevocationInfo(
            List<Asn1Encodable> result,
        ...
        {
            CollectOtherRevocationInfo(
                result,
                new OtherRevocationInfoFormat(otherRevInfoFormat, otherRevInfo)
            );
        }

        internal static void CollectOtherRevocationInfos(
            List<Asn1Encodable> result,
        ...
        internal static Asn1Set ToAsn1Set(
            this IReadOnlyCollection<Asn1Encodable> elements,
            bool useDer,
            bool useDL
        )
        {
            return useDer ? ToDerSet(elements)
                : useDL ? ToDLSet(elements)
                : ToBerSet(elements);
        }

        internal static Asn1Set ToAsn1SetOptional(
            this IReadOnlyCollection<Asn1Encodable> elements,
            bool useDer,
            bool useDL
        )
        ...
        internal static void ValidateOtherRevocationInfo(
            OtherRevocationInfoFormat otherRevocationInfo
        )
        {
            if (CmsObjectIdentifiers.id_ri_ocsp_response.Equals(otherRevocationInfo.InfoFormat))
            {
                ...
                if (!ocspResponse.ResponseStatus.HasValue(OcspResponseStatus.Successful))
                    throw new ArgumentException(
                        "cannot add unsuccessful OCSP response to CMS SignedData"
                    );
            }
        }
    }
