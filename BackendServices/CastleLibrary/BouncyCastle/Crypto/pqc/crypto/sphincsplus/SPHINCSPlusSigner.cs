...
namespace Org.BouncyCastle.Pqc.Crypto.SphincsPlus
{
    ...
    public sealed class SphincsPlusSigner : IMessageSigner
    {
        ...
        public byte[] GenerateSignature(byte[] message)
        {
            ...
            engine.PRF_msg(m_privKey.m_sk.prf, optRand, message, 0, message.Length, signature, 0);
            int pos = engine.N;

            // compute message digest and index
            IndexedDigest idxDigest = engine.H_msg(
                signature,
                0,
                m_privKey.m_pk.seed,
                m_privKey.m_pk.root,
            ...
            HT ht = new HT(engine, m_privKey.SK.seed, m_privKey.PK.seed);
