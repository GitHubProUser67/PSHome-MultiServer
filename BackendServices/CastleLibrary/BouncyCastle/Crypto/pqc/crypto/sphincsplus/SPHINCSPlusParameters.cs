...
namespace Org.BouncyCastle.Pqc.Crypto.SphincsPlus
{
    ...
    public sealed class SphincsPlusParameters
    {
        ...
        public static readonly SphincsPlusParameters haraka_128f = new SphincsPlusParameters(
            0x030101,
            "haraka-128f-robust",
            new HarakaSEngineProvider(true, 16, 16, 22, 6, 33, 66)
        );
        ...
        public static readonly SphincsPlusParameters haraka_128s = new SphincsPlusParameters(
            0x030102,
            "haraka-128s-robust",
            new HarakaSEngineProvider(true, 16, 16, 7, 12, 14, 63)
        );
        ...
        public static readonly SphincsPlusParameters haraka_192f = new SphincsPlusParameters(
            0x030103,
            "haraka-192f-robust",
            new HarakaSEngineProvider(true, 24, 16, 22, 8, 33, 66)
        );
        ...
        public static readonly SphincsPlusParameters haraka_192s = new SphincsPlusParameters(
            0x030104,
            "haraka-192s-robust",
            new HarakaSEngineProvider(true, 24, 16, 7, 14, 17, 63)
        );
        ...
        public static readonly SphincsPlusParameters haraka_256f = new SphincsPlusParameters(
            0x030105,
            "haraka-256f-robust",
            new HarakaSEngineProvider(true, 32, 16, 17, 9, 35, 68)
        );
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private SphincsPlusParameters(
            int id,
            string name,
            ISphincsPlusEngineProvider engineProvider
        )
        {
            m_id = id;
            m_name = name;
        ...
        public static SphincsPlusParameters GetParams(int id) =>
            CollectionUtilities.GetValueOrNull(IdToParams, id);
