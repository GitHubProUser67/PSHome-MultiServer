...
namespace Org.BouncyCastle.Pqc.Crypto.SphincsPlus
{
    ...
    internal abstract class HarakaSBase
    {
        ...
        {
            uint q0 = q[0],
                r0 = Integers.RotateRight(q0, 8),
                s0 = q0 ^ r0;
            uint q1 = q[1],
                r1 = Integers.RotateRight(q1, 8),
                s1 = q1 ^ r1;
            uint q2 = q[2],
                r2 = Integers.RotateRight(q2, 8),
                s2 = q2 ^ r2;
            uint q3 = q[3],
                r3 = Integers.RotateRight(q3, 8),
                s3 = q3 ^ r3;
            uint q4 = q[4],
                r4 = Integers.RotateRight(q4, 8),
                s4 = q4 ^ r4;
            uint q5 = q[5],
                r5 = Integers.RotateRight(q5, 8),
                s5 = q5 ^ r5;
            uint q6 = q[6],
                r6 = Integers.RotateRight(q6, 8),
                s6 = q6 ^ r6;
            uint q7 = q[7],
                r7 = Integers.RotateRight(q7, 8),
                s7 = q7 ^ r7;
        ...
        {
            ulong q0 = q[0],
                r0 = Longs.RotateRight(q0, 16),
                s0 = q0 ^ r0;
            ulong q1 = q[1],
                r1 = Longs.RotateRight(q1, 16),
                s1 = q1 ^ r1;
            ulong q2 = q[2],
                r2 = Longs.RotateRight(q2, 16),
                s2 = q2 ^ r2;
            ulong q3 = q[3],
                r3 = Longs.RotateRight(q3, 16),
                s3 = q3 ^ r3;
            ulong q4 = q[4],
                r4 = Longs.RotateRight(q4, 16),
                s4 = q4 ^ r4;
            ulong q5 = q[5],
                r5 = Longs.RotateRight(q5, 16),
                s5 = q5 ^ r5;
            ulong q6 = q[6],
                r6 = Longs.RotateRight(q6, 16),
                s6 = q6 ^ r6;
            ulong q7 = q[7],
                r7 = Longs.RotateRight(q7, 16),
                s7 = q7 ^ r7;
