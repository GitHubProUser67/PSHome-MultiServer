...
namespace Org.BouncyCastle.Pqc.Crypto.Hqc
{
    public class HqcKeyPairGenerator : IAsymmetricCipherKeyPairGenerator
    {
        ...
        public AsymmetricCipherKeyPair GenerateKeyPair() =>
            GenKeyPair(SecureRandom.GetNextBytes(random, 48));
        ...
        private AsymmetricCipherKeyPair GenKeyPair(byte[] seed)
        {
            ...
            // form keys
            HqcPublicKeyParameters publicKey = new HqcPublicKeyParameters(
                hqcKeyGenerationParameters.Parameters,
                pk
            );
            HqcPrivateKeyParameters privateKey = new HqcPrivateKeyParameters(
                hqcKeyGenerationParameters.Parameters,
                sk
            );
