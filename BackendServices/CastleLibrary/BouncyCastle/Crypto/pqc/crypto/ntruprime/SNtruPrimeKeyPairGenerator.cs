...
namespace Org.BouncyCastle.Pqc.Crypto.NtruPrime
{
    public class SNtruPrimeKeyPairGenerator
    {
        ...
        private AsymmetricCipherKeyPair GenKeyPair()
        {
            ...
            SNtruPrimePublicKeyParameters pubKey = new SNtruPrimePublicKeyParameters(
                _ntruPrimeParams.Parameters,
                pk
            );
            SNtruPrimePrivateKeyParameters privKey = new SNtruPrimePrivateKeyParameters(
                _ntruPrimeParams.Parameters,
                sk
            );
