    ...
    public static class PqcPrivateKeyFactory
    {
        ...
        public static AsymmetricKeyParameter CreateKey(PrivateKeyInfo keyInfo)
        {
            ...
            if (algOid.On(BCObjectIdentifiers.pqc_kem_mceliece))
            {
                ...
                return new CmcePrivateKeyParameters(
                    spParams,
                    cmceKey.Delta,
                    cmceKey.C,
                    cmceKey.G,
...
#pragma warning disable CS0618 // Type or member is obsolete
            if (
                algOid.On(BCObjectIdentifiers.sphincsPlus)
            ...
            )
            {
                ...
                if (obj is Asn1Sequence keySeq)
                {
                    ...
                    return new SphincsPlusPrivateKeyParameters(
                        spParams,
                        spKey.GetSkseed(),
                        spKey.GetSkprf(),
                        publicKey.GetPkseed(),
...
#pragma warning disable CS0618 // Type or member is obsolete
            if (
                algOid.Equals(BCObjectIdentifiers.dilithium2)
            ...
            )
            {
                ...
                return new DilithiumPrivateKeyParameters(
                    spParams,
                    encoding: keyEnc.GetOctets(),
                    pubKey
                );
            }
#pragma warning restore CS0618 // Type or member is obsolete
            if (
                algOid.Equals(BCObjectIdentifiers.falcon_512)
            ...
            )
            {
                ...
                return new FalconPrivateKeyParameters(
                    spParams,
                ...
                if (ntruParameters != null)
                {
                    ...
                    if (length > expectedLength)
                    {
                        try
                        {
                            ...
                            if (
                                obj is Asn1OctetString oct
                                && oct.GetOctetsLength() == expectedLength
                            )
                                return NtruPrivateKeyParameters.FromEncoding(
                                    ntruParameters,
