...
namespace Org.BouncyCastle.Pqc.Crypto.Utilities
{
    public static class PqcPrivateKeyInfoFactory
    {
        ...
        )
        {
            ...
            {
                byte[] encoding = Composer
                    .Compose()
                    .U32Str(1)
                    .Bytes(lmsPrivateKeyParameters)
                    .Build();
                byte[] pubEncoding = Composer
                    .Compose()
                    .U32Str(1)
                    .Bytes(lmsPrivateKeyParameters.GetPublicKey())
                    .Build();
            ...
            if (privateKey is HssPrivateKeyParameters hssPrivateKeyParameters)
            {
                ...
                byte[] encoding = Composer
                    .Compose()
                    .U32Str(L)
                    .Bytes(hssPrivateKeyParameters)
                    .Build();
                byte[] pubEncoding = Composer
                    .Compose()
                    .U32Str(L)
                    .Bytes(hssPrivateKeyParameters.GetPublicKey().LmsPublicKey)
                    .Build();
...
#pragma warning disable CS0618 // Type or member is obsolete
            if (privateKey is SphincsPlusPrivateKeyParameters sphincsPlusPrivateKeyParameters)
            {
                ...
                return new PrivateKeyInfo(
                    algorithmIdentifier,
                    new DerOctetString(sphincsPlusPrivateKeyParameters.GetEncoded()),
                    attributes
                );
            }
#pragma warning restore CS0618 // Type or member is obsolete
            if (privateKey is CmcePrivateKeyParameters cmcePrivateKeyParameters)
            {
                ...
                CmcePublicKey CmcePub = new CmcePublicKey(
                    cmcePrivateKeyParameters.ReconstructPublicKey()
                );
                CmcePrivateKey CmcePriv = new CmcePrivateKey(
                    0,
                    cmcePrivateKeyParameters.Delta,
                    cmcePrivateKeyParameters.C,
                    cmcePrivateKeyParameters.G,
                    cmcePrivateKeyParameters.Alpha,
                    cmcePrivateKeyParameters.S,
                    CmcePub
                );
...
#pragma warning disable CS0618 // Type or member is obsolete
            if (privateKey is DilithiumPrivateKeyParameters dilithiumPrivateKeyParameters)
            {
                ...
                DilithiumPublicKeyParameters pubParams =
                    dilithiumPrivateKeyParameters.GetPublicKeyParameters();

                return new PrivateKeyInfo(
                    algorithmIdentifier,
                    new DerOctetString(dilithiumPrivateKeyParameters.GetEncoded()),
                    attributes,
                    pubParams.GetEncoded()
                );
            }
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            throw new ArgumentException(
                "Class provided is not convertible: " + Platform.GetTypeName(privateKey)
            );
        }
    }
}
