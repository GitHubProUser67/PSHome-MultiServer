...
namespace Org.BouncyCastle.Pqc.Crypto.Falcon
{
    internal class FalconNist
    {
        ...
        )
        {
            ...
            */
            ...
            v = this.codec.trim_i8_encode(
                ...
                0,
                this.logn,
                this.codec.max_fg_bits[this.logn]
            );
            if (v == 0)
            {
        ...
        )
        {
            ...
            if (
                this.vrfy.complete_private(G, 0, f, 0, g, 0, F, 0, this.logn, new ushort[2 * n], 0)
                == 0
            )
            {
        ...
        )
        {
            ...
            */
            ...
            // }
            if (
                this.codec.modq_decode(h, 0, this.logn, pksrc, pk, CRYPTO_PUBLICKEYBYTES - 1)
            ...
            */
            ...
            if (attached)
            {
                ...
                if (
                    this.codec.comp_decode(sig, 0, this.logn, sig_encoded, 1, sig_len - 1)
                    != sig_len - 1
                )
                {
                    return -1;
            ...
            else
            {
                if (
                    sig_len < 1
                    || this.codec.comp_decode(sig, 0, this.logn, sig_encoded, 0, sig_len) != sig_len
                )
                {
                    return -1;
                }
