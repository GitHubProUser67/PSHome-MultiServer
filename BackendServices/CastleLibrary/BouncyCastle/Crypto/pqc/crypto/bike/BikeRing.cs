            ...
            if (Org.BouncyCastle.Runtime.Intrinsics.X86.Pclmulqdq.IsEnabled)
            {
                ...
                if (i <= limit2)
                {
                    ...
                    for (int j = 0; j < i; j += 2)
                    {
                        ...
                        var U12 = Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(Xi, Yj, 0x01),
                        ...
                        var V12 = Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(Xj, Yi, 0x01),
...

                    {
                        ...
                        var Z12 = Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(Xi, Yi, 0x01),
                ...
                if (i < Size)
                {
                    ...
                    for (int j = 0; j < i; ++j)
                    {
                        ...
                        var Z = Sse2.Xor(
                            Pclmulqdq.CarrylessMultiply(Xi, Yj, 0x00),
