...
namespace Org.BouncyCastle.Pqc.Crypto.Frodo
{
    ...
    {
        private static readonly short[] cdf_table640 =
        {
            4643,
            13363,
            20579,
        ...
        private static readonly short[] cdf_table976 =
        {
            5638,
            15915,
            23689,
        ...
        private static readonly short[] cdf_table1344 =
        {
            9142,
            23462,
            30338,
        ...
        public static readonly FrodoParameters frodokem640aes = new FrodoParameters(
            "frodokem19888",
            640,
            15,
            2,
            cdf_table640,
            new ShakeDigest(128),
            new FrodoMatrixGenerator.Aes128MatrixGenerator(640, (1 << 15))
        );
        public static readonly FrodoParameters frodokem640shake = new FrodoParameters(
            "frodokem19888shake",
            640,
            15,
            2,
            cdf_table640,
            new ShakeDigest(128),
            new FrodoMatrixGenerator.Shake128MatrixGenerator(640, (1 << 15))
        );

        public static readonly FrodoParameters frodokem976aes = new FrodoParameters(
            "frodokem31296",
            976,
            16,
            3,
            cdf_table976,
            new ShakeDigest(256),
            new FrodoMatrixGenerator.Aes128MatrixGenerator(976, (1 << 16))
        );
        public static readonly FrodoParameters frodokem976shake = new FrodoParameters(
            "frodokem31296shake",
            976,
            16,
            3,
            cdf_table976,
            new ShakeDigest(256),
            new FrodoMatrixGenerator.Shake128MatrixGenerator(976, (1 << 16))
        );

        public static readonly FrodoParameters frodokem1344aes = new FrodoParameters(
            "frodokem43088",
            1344,
            16,
            4,
            cdf_table1344,
            new ShakeDigest(256),
            new FrodoMatrixGenerator.Aes128MatrixGenerator(1344, (1 << 16))
        );
        public static readonly FrodoParameters frodokem1344shake = new FrodoParameters(
            "frodokem43088shake",
            1344,
            16,
            4,
            cdf_table1344,
            new ShakeDigest(256),
            new FrodoMatrixGenerator.Shake128MatrixGenerator(1344, (1 << 16))
        );
