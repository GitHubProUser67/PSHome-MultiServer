...
namespace Org.BouncyCastle.Pqc.Crypto.Cmce
{
    public sealed class CmcePrivateKeyParameters : CmceKeyParameters
    {
        ...
        public byte[] ReconstructPublicKey() =>
            Parameters.Engine.GeneratePublicKeyFromPrivateKey(privateKey);
        ...
        internal byte[] Alpha =>
            Arrays.CopyOfRange(privateKey, 40 + Parameters.T * 2, privateKey.Length - 32);

        internal byte[] S =>
            Arrays.CopyOfRange(privateKey, privateKey.Length - 32, privateKey.Length);
    }
}
