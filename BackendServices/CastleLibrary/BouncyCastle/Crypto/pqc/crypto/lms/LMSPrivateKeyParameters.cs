...
namespace Org.BouncyCastle.Pqc.Crypto.Lms
{
    public sealed class LmsPrivateKeyParameters : LmsKeyParameters, ILmsContextBasedSigner
    {
        ...
        {
            return new LmsPublicKeyParameters(
                privateKey.sigParameters,
                privateKey.otsParameters,
                privateKey.FindT(1),
                privateKey.I
            );
        }
        ...
        internal static LmsPrivateKeyParameters Parse(BinaryReader binaryReader)
        {
            ...
            return new LmsPrivateKeyParameters(
                sigParameter,
                otsParameter,
                q,
                I,
        ...
        internal static LmsPrivateKeyParameters Parse(
            byte[] buf,
            int off,
            int len,
        ...
        internal LMOtsPrivateKey GetNextOtsPrivateKey()
        {
            ...
            lock (this)
            {
                ...
                LMOtsPrivateKey otsPrivateKey = new LMOtsPrivateKey(
                    otsParameters,
                    I,
                    q,
                    masterSecret
        ...
        private byte[] CalcT(int r)
        {
            ...
            if (r >= twoToh)
            {
                ...
                //
                byte[] K = LMOts.LmsOtsGeneratePublicKey(
                    otsParameters,
                    I,
                    r - twoToh,
                    masterSecret
