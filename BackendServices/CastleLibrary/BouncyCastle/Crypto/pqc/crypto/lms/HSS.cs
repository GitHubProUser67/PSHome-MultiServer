...
namespace Org.BouncyCastle.Pqc.Crypto.Lms
{
    ...
    {
        public static HssPrivateKeyParameters GenerateHssKeyPair(
            HssKeyGenerationParameters parameters
        )
        {
            //
            ...
            byte[] rootSeed = SecureRandom.GetNextBytes(
                parameters.Random,
        ...
        public static HssSignature GenerateSignature(
            HssPrivateKeyParameters keyPair,
            byte[] message
        )
        {
