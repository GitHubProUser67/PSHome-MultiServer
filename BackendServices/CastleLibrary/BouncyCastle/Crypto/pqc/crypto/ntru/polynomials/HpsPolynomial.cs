...
namespace Org.BouncyCastle.Pqc.Crypto.Ntru.Polynomials
{
    internal class HpsPolynomial : Polynomial
    {
        ...
        public override void SqFromBytes(byte[] a)
        {
            ...
            {
                coeffs[8 * i + 0] = (ushort)(
                    ((a[11 * i + 0] & 0xff) >> 0) | (((ushort)(a[11 * i + 1] & 0xff) & 0x07) << 8)
                );
                coeffs[8 * i + 1] = (ushort)(
                    ((a[11 * i + 1] & 0xff) >> 3) | (((ushort)(a[11 * i + 2] & 0xff) & 0x3f) << 5)
                );
                coeffs[8 * i + 2] = (ushort)(
                    ((a[11 * i + 2] & 0xff) >> 6)
                ...
                coeffs[8 * i + 3] = (ushort)(
                    ((a[11 * i + 4] & 0xff) >> 1) | (((ushort)(a[11 * i + 5] & 0xff) & 0x0f) << 7)
                );
                coeffs[8 * i + 4] = (ushort)(
                    ((a[11 * i + 5] & 0xff) >> 4) | (((ushort)(a[11 * i + 6] & 0xff) & 0x7f) << 4)
                );
                coeffs[8 * i + 5] = (ushort)(
                    ((a[11 * i + 6] & 0xff) >> 7)
                ...
                coeffs[8 * i + 6] = (ushort)(
                    ((a[11 * i + 8] & 0xff) >> 2) | (((ushort)(a[11 * i + 9] & 0xff) & 0x1f) << 6)
                );
                coeffs[8 * i + 7] = (ushort)(
                    ((a[11 * i + 9] & 0xff) >> 5) | (((ushort)(a[11 * i + 10] & 0xff) & 0xff) << 3)
                );
            }
            ...
            switch (ParameterSet.PackDegree() & 0x07)
            {
                case 4:
                {
                    coeffs[8 * i + 0] = (ushort)(
                        ((a[11 * i + 0] & 0xff) >> 0)
                        | (((ushort)(a[11 * i + 1] & 0xff) & 0x07) << 8)
                    );
                    coeffs[8 * i + 1] = (ushort)(
                        ((a[11 * i + 1] & 0xff) >> 3)
                        | (((ushort)(a[11 * i + 2] & 0xff) & 0x3f) << 5)
                    );
                    coeffs[8 * i + 2] = (ushort)(
                        ((a[11 * i + 2] & 0xff) >> 6)
                        | (((ushort)(a[11 * i + 3] & 0xff) & 0xff) << 2)
