...
namespace Org.BouncyCastle.Pqc.Crypto.Ntru.Polynomials
{
    internal class HrssPolynomial : Polynomial
    {
        ...
        public override void SqFromBytes(byte[] a)
        {
            ...
            {
                coeffs[8 * i + 0] = (ushort)(
                    (a[13 * i + 0] & 0xff) | (((ushort)(a[13 * i + 1] & 0xff) & 0x1f) << 8)
                );
                coeffs[8 * i + 1] = (ushort)(
                    ((a[13 * i + 1] & 0xff) >> 5)
                    | (((ushort)(a[13 * i + 2] & 0xff)) << 3)
                    | (((short)(a[13 * i + 3] & 0xff) & 0x03) << 11)
                );
                coeffs[8 * i + 2] = (ushort)(
                    ((a[13 * i + 3] & 0xff) >> 2) | (((ushort)(a[13 * i + 4] & 0xff) & 0x7f) << 6)
                );
                coeffs[8 * i + 3] = (ushort)(
                    ((a[13 * i + 4] & 0xff) >> 7)
                    | (((ushort)(a[13 * i + 5] & 0xff)) << 1)
                    | (((short)(a[13 * i + 6] & 0xff) & 0x0f) << 9)
                );
                coeffs[8 * i + 4] = (ushort)(
                    ((a[13 * i + 6] & 0xff) >> 4)
                    | (((ushort)(a[13 * i + 7] & 0xff)) << 4)
                    | (((short)(a[13 * i + 8] & 0xff) & 0x01) << 12)
                );
                coeffs[8 * i + 5] = (ushort)(
                    ((a[13 * i + 8] & 0xff) >> 1) | (((ushort)(a[13 * i + 9] & 0xff) & 0x3f) << 7)
                );
                coeffs[8 * i + 6] = (ushort)(
                    ((a[13 * i + 9] & 0xff) >> 6)
                    | (((ushort)(a[13 * i + 10] & 0xff)) << 2)
                    | (((short)(a[13 * i + 11] & 0xff) & 0x07) << 10)
                );
                coeffs[8 * i + 7] = (ushort)(
                    ((a[13 * i + 11] & 0xff) >> 3) | (((ushort)(a[13 * i + 12] & 0xff)) << 5)
                );
            }
            ...
            switch (ParameterSet.PackDegree() & 0x07)
            {
                ...
                {
                    coeffs[8 * i + 0] = (ushort)(
                        (a[13 * i + 0] & 0xff) | (((short)(a[13 * i + 1] & 0xff) & 0x1f) << 8)
                    );
                    coeffs[8 * i + 1] = (ushort)(
                        ((a[13 * i + 1] & 0xff) >> 5)
