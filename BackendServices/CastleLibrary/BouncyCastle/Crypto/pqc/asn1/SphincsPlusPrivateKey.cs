...
namespace Org.BouncyCastle.Pqc.Asn1
{
    ...
    public sealed class SphincsPlusPrivateKey : Asn1Encodable
    {
        ...
        public static SphincsPlusPrivateKey GetInstance(
        ...
        public static SphincsPlusPrivateKey GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private SphincsPlusPrivateKey(Asn1Sequence seq)
        {
            ...
            m_publicKey = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                SphincsPlusPublicKey.GetOptional
            );
