    ...
    public class CBZip2OutputStream : BaseOutputStream
    {
        ...
        */
        ...
        private void SendMtfValues()
        {
            ...
            int[][] rfreq = CBZip2InputStream.CreateIntArray(
            ...
            int[][] code = CBZip2InputStream.CreateIntArray(
                BZip2Constants.N_GROUPS,
                BZip2Constants.MAX_ALPHA_SIZE
            );
            ...
            BsPutBits(15, nSelectors);
            {
                ...
                for (i = 0; i < nSelectors; i++)
                {
                    ...
                    {
                        int mtfIncMask =
                            (0x00888888 - mtfSelectors + 0x00111111 * mtfSelector) & 0x00888888;
