    ...
    */
    public class CBZip2InputStream : BaseInputStream
    {
        ...
        */
        ...
        private int[][] limit = CreateIntArray(
            BZip2Constants.N_GROUPS,
            BZip2Constants.MAX_CODE_LEN + 1
        );
        private int[][] basev = CreateIntArray(
            BZip2Constants.N_GROUPS,
            BZip2Constants.MAX_CODE_LEN + 1
        );
        private int[][] perm = CreateIntArray(
            BZip2Constants.N_GROUPS,
        ...
        private int RecvDecodingTables()
        {
            ...
            for (i = 0; i < nSelectors; i++)
            {
                ...
                switch (mtfSelector)
                {
                    ...
                    case 1:
                        mtfGroups =
                            (mtfGroups >> 4) & 0x00000FU
                            | (mtfGroups << 4) & 0x0000F0U
                            | mtfGroups & 0xFFFF00U;
                        break;
                    case 2:
                        mtfGroups =
                            (mtfGroups >> 8) & 0x00000FU
                            | (mtfGroups << 4) & 0x000FF0U
                            | mtfGroups & 0xFFF000U;
                        break;
                    case 3:
                        mtfGroups =
                            (mtfGroups >> 12) & 0x00000FU
                            | (mtfGroups << 4) & 0x00FFF0U
                            | mtfGroups & 0xFF0000U;
                        break;
                    case 4:
                        mtfGroups =
                            (mtfGroups >> 16) & 0x00000FU
                            | (mtfGroups << 4) & 0x0FFFF0U
                            | mtfGroups & 0xF00000U;
                        break;
                    case 5:
