...
namespace Org.BouncyCastle.X509
{
    ...
    public class AttributeCertificateHolder
        : IEquatable<AttributeCertificateHolder>,
            ISelector<X509Certificate>
    {
        ...
        {
            var digestAlgorithmID = new AlgorithmIdentifier(
                new DerObjectIdentifier(digestAlgorithm)
            );
            var objectDigestInfo = new ObjectDigestInfo(
                digestedObjectType,
                otherObjectTypeID,
                digestAlgorithmID,
        ...
        public int DigestedObjectType
        {
            get
            {
                ...
                return odi == null ? -1 : odi.DigestedObjectType.IntValueExact;
            }
        }
        ...
        public object Clone() =>
            new AttributeCertificateHolder((Asn1Sequence)m_holder.ToAsn1Object());
