...
namespace Org.BouncyCastle.X509
{
    ...
    public class X509V3CertificateGenerator
    {
        ...
        public X509V3CertificateGenerator(X509CertificateStructure template)
        {
            ...
            {
                if (
                    X509Extensions.SubjectAltPublicKeyInfo.Equals(oid)
        ...
        public void AddExtension(
            DerObjectIdentifier oid,
            bool critical,
            IAsn1Convertible extensionValue
        ) => extGenerator.AddExtension(oid, critical, extensionValue);
        ...
        public void AddExtension(Asn1.X509.Extension extension) =>
        ...
        public X509Certificate Generate(ISignatureFactory signatureFactory)
        {
            ...
            {
                var deltaExtension = extGenerator.GetExtension(
                ...
                if (deltaExtension != null)
                {
                    ...
                    extGenerator.ReplaceExtension(
                        X509Extensions.DRAFT_DeltaCertificateDescriptor,
                        deltaExtension.IsCritical,
                        descriptor
                    );
                }
            ...
            return new X509Certificate(
                new X509CertificateStructure(tbsCertificate, sigAlgID, signature)
            );
        }
        ...
        )
        {
            ...
            extGenerator.AddExtension(
                X509Extensions.AltSignatureAlgorithm,
                isCritical,
                altSigAlgID
            );
            ...
            if (deltaExtension != null)
            {
                ...
                tmpExtGenerator.AddExtension(
                    X509Extensions.AltSignatureValue,
                    false,
                    DerNull.Instance
                );
            ...
            var altSignature = X509Utilities.GenerateSignature(
                altSignatureFactory,
                tbsGen.GeneratePreTbsCertificate()
            );
        ...
        internal static DerBitString BooleanToBitString(bool[] id)
        {
            ...
            Span<byte> bytes =
                byteLength <= 512 ? stackalloc byte[byteLength] : new byte[byteLength];
