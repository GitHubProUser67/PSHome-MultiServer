    ...
    public class X509V2CrlGenerator
    {
        ...
        */
        public void AddExtension(string oid, bool critical, byte[] extensionValue)
        {
            extGenerator.AddExtension(
                ...
                critical,
                DerOctetString.FromContents(extensionValue)
            );
        }
        ...
        */
        ...
        public X509Crl Generate(ISignatureFactory signatureFactory)
        {
            ...
            return new X509Crl(
                CertificateList.GetInstance(new DerSequence(tbsCertList, sigAlgID, signature))
            );
        }
