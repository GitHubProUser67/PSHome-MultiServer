...
namespace Org.BouncyCastle.X509
{
    ...
    public static class SubjectPublicKeyInfoFactory
    {
        ...
        )
        {
            ...
            if (publicKey.IsPrivate)
                throw new ArgumentException(
                    "Private key passed - public key expected.",
                    nameof(publicKey)
                );
            ...
            if (publicKey is RsaKeyParameters rsaKey)
            {
                ...
                return new SubjectPublicKeyInfo(
                    algID,
                    new RsaPublicKeyStructure(rsaKey.Modulus, rsaKey.Exponent)
                );
            }
            ...
            throw new ArgumentException(
                "Class provided no convertible: " + Platform.GetTypeName(publicKey)
            );
        }
        ...
        private static void EncodeECGost3410FieldElement(
            BigInteger bi,
            byte[] buf,
            int off,
            int len
