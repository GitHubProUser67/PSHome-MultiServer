...
{
    public class X509CrlStoreSelector : ISelector<X509Crl>, ICheckingCertificate
    {
        ...
        public virtual bool Match(X509Crl c)
        {
            ...
            {
                BigInteger cn = c.GetExtension(
                    X509Extensions.CrlNumber,
                    CrlNumber.GetInstance
                )?.PositiveValue;
                if (cn == null)
                    return false;
            ...
            // TODO[pkix] Do we always need to parse the Delta CRL Indicator extension?
            {
                ...
                else
                {
                    ...
                    if (
                        ...
                        && baseCrlNumber.PositiveValue.CompareTo(maxBaseCrlNumber) > 0
                    )
                        return false;
                }
            }
