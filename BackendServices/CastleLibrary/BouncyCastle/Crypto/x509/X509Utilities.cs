...
namespace Org.BouncyCastle.X509
{
    internal static class X509Utilities
    {
        ...
        internal static bool AreEquivalentAlgorithms(
            AlgorithmIdentifier id1,
        ...
        internal static byte[] CalculateDigest(
        ...
        internal static DerBitString GenerateDigest(
            IDigestFactory digestFactory,
            Asn1Encodable asn1Encodable
        )
        {
        ...
        internal static DerBitString GenerateMac(
            IMacFactory macFactory,
            Asn1Encodable asn1Encodable
        )
        {
        ...
        internal static IEnumerable<string> GetAlgNames() =>
            CollectionUtilities.Proxy(m_algorithms.Keys);

        internal static bool HasAbsentParameters(AlgorithmIdentifier algID) =>
            IsAbsentParameters(algID.Parameters);

        internal static bool IsAbsentParameters(Asn1Encodable parameters) =>
            parameters == null || DerNull.Instance.Equals(parameters);

        internal static bool VerifyMac(
            IMacFactory macFactory,
            Asn1Encodable asn1Encodable,
            DerBitString expected
        )
        {
