...
namespace Org.BouncyCastle.Cmp
{
    public sealed class CertificateConfirmationContentBuilder
    {
        ...
        private readonly List<AlgorithmIdentifier> m_acceptedSignatureAlgorithms =
            new List<AlgorithmIdentifier>();
        ...
        )
        {
            return AddAcceptedCertificate(
                new CmpCertificate(cert.CertificateStructure),
        ...
        public CertificateConfirmationContent Build()
        {
            ...
            {
                var certHash = CmpUtilities.CalculateCertHash(
                    m_acceptedCerts[i],
                    m_acceptedSignatureAlgorithms[i],
