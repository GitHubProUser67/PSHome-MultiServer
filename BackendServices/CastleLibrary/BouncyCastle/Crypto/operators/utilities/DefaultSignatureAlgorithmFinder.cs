...
namespace Org.BouncyCastle.Operators.Utilities
{
    public class DefaultSignatureAlgorithmFinder : ISignatureAlgorithmFinder
    {
        public static readonly DefaultSignatureAlgorithmFinder Instance =
            new DefaultSignatureAlgorithmFinder();
        ...
        private static readonly Dictionary<string, Asn1Encodable> Parameters = new Dictionary<
            string,
            Asn1Encodable
        >(StringComparer.OrdinalIgnoreCase);
        ...
        private static void AddDigestOid(
            DerObjectIdentifier signatureOid,
            DerObjectIdentifier digestOid
        ...
        private static void AddParameters(string algorithmName, Asn1Encodable parameters)
        {
            if (parameters == null)
                throw new ArgumentException(
                    "use 'NoParams' instead for absent parameters",
                    nameof(parameters)
                );
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            AlgorithmIdentifier sha3_224AlgID = new AlgorithmIdentifier(
                NistObjectIdentifiers.IdSha3_224,
                DerNull.Instance
            );
            AddParameters("SHA3-224WITHRSAANDMGF1", CreatePssParams(sha3_224AlgID, 28));

            AlgorithmIdentifier sha3_256AlgID = new AlgorithmIdentifier(
                NistObjectIdentifiers.IdSha3_256,
                DerNull.Instance
            );
            AddParameters("SHA3-256WITHRSAANDMGF1", CreatePssParams(sha3_256AlgID, 32));

            AlgorithmIdentifier sha3_384AlgID = new AlgorithmIdentifier(
                NistObjectIdentifiers.IdSha3_384,
                DerNull.Instance
            );
            AddParameters("SHA3-384WITHRSAANDMGF1", CreatePssParams(sha3_384AlgID, 48));

            AlgorithmIdentifier sha3_512AlgID = new AlgorithmIdentifier(
                NistObjectIdentifiers.IdSha3_512,
                DerNull.Instance
            );
            ...
            AddDigestOid(
                PkcsObjectIdentifiers.Sha512_224WithRSAEncryption,
                NistObjectIdentifiers.IdSha512_224
            );
            AddDigestOid(
                PkcsObjectIdentifiers.Sha512_256WithRSAEncryption,
                NistObjectIdentifiers.IdSha512_256
            );
            AddDigestOid(
                NistObjectIdentifiers.IdRsassaPkcs1V15WithSha3_224,
                NistObjectIdentifiers.IdSha3_224
...
#pragma warning disable CS0618 // Type or member is obsolete
            ...
            AddDigestOid(
                ...
                NistObjectIdentifiers.IdShake256
            );
            AddDigestOid(
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            AddDigestOid(
                ...
                NistObjectIdentifiers.IdShake128
            );
            AddDigestOid(
        ...
        public virtual AlgorithmIdentifier Find(string signatureName)
        {
            if (!Algorithms.TryGetValue(signatureName, out var sigAlgOid))
                throw new ArgumentException(
                    $"Unknown signature name: {signatureName}",
