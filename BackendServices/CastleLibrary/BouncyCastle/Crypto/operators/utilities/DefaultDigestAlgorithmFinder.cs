...
namespace Org.BouncyCastle.Operators.Utilities
{
    public class DefaultDigestAlgorithmFinder : IDigestAlgorithmFinder
    {
        public static readonly DefaultDigestAlgorithmFinder Instance =
            new DefaultDigestAlgorithmFinder();
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            DigestOids.Add(
                BCObjectIdentifiers.picnic_with_sha3_512,
                NistObjectIdentifiers.IdSha3_512
            );
            DigestOids.Add(
                BCObjectIdentifiers.picnic_with_shake256,
                NistObjectIdentifiers.IdShake256
            );
            ...
            DigestOids.Add(
                PkcsObjectIdentifiers.IdAlgHssLmsHashsig,
                NistObjectIdentifiers.IdSha256
            );
        ...
        private static void AddDigestAlgID(DerObjectIdentifier oid, bool withNullParams) =>
            DigestOidToAlgIDs.Add(
                oid,
                new AlgorithmIdentifier(oid, withNullParams ? DerNull.Instance : null)
            );
        ...
        public virtual AlgorithmIdentifier Find(AlgorithmIdentifier signatureAlgorithm)
        {
            ...
            if (EdECObjectIdentifiers.id_Ed448.Equals(signatureOid))
                return new AlgorithmIdentifier(
                    ...
                    DerInteger.ValueOf(512)
                );

            DerObjectIdentifier digestOid;
            if (PkcsObjectIdentifiers.IdRsassaPss.Equals(signatureOid))
            {
                digestOid = RsassaPssParameters
                    .GetInstance(signatureAlgorithm.Parameters)
        ...
        {
            if (
                DigestNameToOids.TryGetValue(digestName, out var digestOid)
