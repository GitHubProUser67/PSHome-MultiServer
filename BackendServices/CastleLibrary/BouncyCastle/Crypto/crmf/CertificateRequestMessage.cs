...
namespace Org.BouncyCastle.Crmf
{
    public class CertificateRequestMessage
    {
        ...
        public static readonly int popKeyEncipherment = Asn1.Crmf
            .ProofOfPossession
        ...
        public bool HasControl(DerObjectIdentifier objectIdentifier) =>
            FindControl(objectIdentifier) != null;
        ...
        /// <exception cref="InvalidOperationException">if there is a problem in verification or content verifier creation.</exception>
        /// <exception cref="InvalidOperationException">if POP not appropriate.</exception>
        public bool IsValidSigningKeyPop(
        ...
        {
            var verifierFactory = verifierFactoryProvider.CreateVerifierFactory(
                signKey.AlgorithmIdentifier
            );
            ...
            return X509.X509Utilities.VerifySignature(
                verifierFactory,
                asn1Encodable,
                signKey.Signature
            );
