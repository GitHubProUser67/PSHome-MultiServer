    ...
    public class CertificateRequestMessageBuilder
    {
        ...
        )
        {
            if (m_popoPrivKey != null || m_popRaVerified != null || m_agreeMac != null)
                throw new InvalidOperationException("only one proof of possession is allowed.");
            if (
                type != ProofOfPossession.TYPE_KEY_ENCIPHERMENT
                && type != ProofOfPossession.TYPE_KEY_AGREEMENT
            )
                throw new ArgumentException(
                    "type must be ProofOfPossession.TYPE_KEY_ENCIPHERMENT or ProofOfPossession.TYPE_KEY_AGREEMENT"
                );
        ...
        public CertificateRequestMessage Build()
        {
            ...
            else if (m_agreeMac != null)
            {
                proofOfPossession = new ProofOfPossession(
                    ProofOfPossession.TYPE_KEY_AGREEMENT,
                    new PopoPrivKey(m_agreeMac)
                );
            }
