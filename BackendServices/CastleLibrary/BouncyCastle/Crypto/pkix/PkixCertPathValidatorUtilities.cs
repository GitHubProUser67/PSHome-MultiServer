...
namespace Org.BouncyCastle.Pkix
{
    ...
    internal static class PkixCertPathValidatorUtilities
    {
        ...
        internal static readonly DerObjectIdentifier ANY_POLICY_OID = new DerObjectIdentifier(
            ANY_POLICY
        );
        ...
        internal static AlgorithmIdentifier GetAlgorithmIdentifier(AsymmetricKeyParameter key)
        {
            ...
            catch (Exception e)
            {
                throw new PkixCertPathValidatorException(
                    "Subject public key cannot be decoded.",
                    e
                );
            }
        }
        ...
        internal static PkixPolicyNode RemoveChildlessPolicyNodes(
        ...
        )
        {
            ...
            if (
                !issuer.Equivalent(crl_entry.GetCertificateIssuer(), true)
            ...
            {
                CheckCrlEntryCriticalExtensions(
                    crl_entry,
                ...
                try
                {
                    var reasonCode = crl_entry.GetExtension(
        ...
        */
        ...
        )
        {
            ...
            if (index - 1 == 0)
            {
                ...
                try
                {
                    dateOfCertgen = issuedCert.GetExtension(
        ...
        */
         ...
         */
        internal static HashSet<X509Crl> GetCompleteCrls(
            DistributionPoint dp,
            object certObj,
        ...
        )
        {
            ...
            try
            {
                completeCrlNumber = completeCrl
                    .GetExtension(X509Extensions.CrlNumber, CrlNumber.GetInstance)
                    ?.PositiveValue;
            }
            catch (Exception e)
            {
        ...
        private static bool IsDeltaCrl(X509Crl crl) =>
            HasCriticalExtension(crl, X509Extensions.DeltaCrlIndicator);

        private static void RetainDeltaCrls(HashSet<X509Crl> crls) =>
            crls.RemoveWhere(crl => !IsDeltaCrl(crl));
                ...
                if (dpn != null)
                {
                    if (dpn.Type == DistributionPointName.FullName)
                    {
                        ...
                        for (int j = 0; j < genNames.Length; j++)
                        {
                            ...
                            {
                                string location = DerIA5String
                                    .GetInstance(genNames[j].Name)
                                    .GetString();
                                AddAdditionalStoreFromLocation(location, pkixParams);
                            }
                        }
        ...
        */
        ...
        internal static void CheckCrlCriticalExtensions(X509Crl crl, string exceptionMessage)
        {
            ...
            if (c.Version >= 2)
            {
                ...
                if (extensions != null)
                {
                    ...
                    {
                        if (
                            X509Extensions.IssuingDistributionPoint.Equals(oid)
        ...
        internal static void CheckCrlEntryCriticalExtensions(
        ...
        internal static PkixPolicyNode FindValidPolicy(
        ...
        internal static bool HasCriticalExtension(
            X509Certificate certificate,
            DerObjectIdentifier extensionOid
        )
        {
        ...
        private static bool HasCriticalExtension(
