    ...
    public class PkixAttrCertPathBuilder
    {
        ...
        */
        public virtual PkixCertPathBuilderResult Build(PkixBuilderParameters pkixParams)
        {
            ...
            try
            {
                targets = FindAttributeCertificates(
                    attrCertSelector,
                    pkixParams.GetStoresAttrCert()
                );
            }
            catch (Exception e)
            {
                throw new PkixCertPathBuilderException(
                    "Error finding target attribute certificate.",
                    e
                );
            }
        ...
        )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        issuers = PkixCertPathValidatorUtilities.FindIssuerCerts(
                            tbvCert,
                            pkixParams
                        );
                    }
