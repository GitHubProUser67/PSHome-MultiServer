    ...
    internal static class Rfc3281CertPathUtilities
    {
            ...
            if (critExtOids.Contains(X509Extensions.TargetInformation.Id))
            {
                ...
                catch (Exception e)
                {
                    throw new PkixCertPathValidatorException(
                        "Target information extension could not be read.",
                        e
                    );
                }
            }
        ...
        */
        ...
        )
        {
            ...
            {
                if (
                    attrCert.GetExtensionValue(X509Extensions.CrlDistributionPoints) != null
            ...
            */
            ...
            if (certStatus.Status == CertStatus.Unrevoked && !reasonsMask.IsAllReasons)
            {
                try
                {
                    ...
                    */
                    ...
                    try
                    {
                        issuer = X509Name.GetInstance(
                            attrCert.Issuer.GetPrincipals()[0].GetEncoded()
                        );
                    }
                    catch (Exception e)
                    {
            ...
            if (certStatus.Status != CertStatus.Unrevoked)
            {
                ...
                string message =
                    "Attribute certificate revocation after "
                    + formattedDate
                    + ", reason: "
        ...
        )
        {
            foreach (var anchor in pkixParams.GetTrustedACIssuers())
            {
                ...
                if (
                    acIssuerCert.SubjectDN.ToString(false, symbols).Equals(anchor.CAName)
            ...
            )
            {
                try
                {
                    ...
                    */
                    ...
                    // (f)
                    var keys = Rfc3280CertPathUtilities.ProcessCrlF(
                        crl,
                        attrCert,
                        null,
                        null,
                    ...
                    */
                    ...
                    // (i)
                    Rfc3280CertPathUtilities.ProcessCrlI(
                        validDate,
                        deltaCRL,
                        attrCert,
                        certStatus,
