...
namespace Org.BouncyCastle.Pkix
{
    internal static class Rfc3280CertPathUtilities
    {
        ...
        internal static readonly DerObjectIdentifier ANY_POLICY_OID =
            PkixCertPathValidatorUtilities.ANY_POLICY_OID;
        ...
        */
        internal static void ProcessCrlB2(DistributionPoint dp, object cert, X509Crl crl)
        {
            ...
            {
                throw new Exception(
                    "0 Issuing distribution point extension could not be decoded.",
                    e
                );
            }
            ...
            if (idp != null)
            {
                    ...
                    if (dp.DistributionPointName != null)
                    {
                        ...
                        if (dpName.Type == DistributionPointName.NameRelativeToCrlIssuer)
                        {
                            ...
                            for (int j = 0; j < genNames.Length; j++)
                            {
                                ...
                                genNames[j] = new GeneralName(
                                    X509Name.GetInstance(new DerSequence(vec))
                                );
                            }
                        }
                        if (genNames != null)
                ...
                try
                {
                    bc = ((IX509Extension)cert).GetExtension(
        ...
        )
        {
            ...
            if (!(PkixCertPathValidatorUtilities.IsSelfIssued(cert) && (i < n)))
            {
                ...
                foreach (string email in emails)
                {
                    ...
                    {
                        throw new PkixCertPathValidatorException(
                            "Subtree check for certificate subject alternative email failed.",
                            ex,
                            index
                        );
                    }
        ...
        internal static void PrepareNextCertA(PkixCertPath certPath, int index)
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Policy mappings extension could not be decoded.",
                    ex,
                    index
                );
            }
        ...
        internal static PkixPolicyNode ProcessCertD(
            ...
            List<PkixPolicyNode>[] policyNodes,
        ...
        )
        {
            ...
            try
            {
                certPolicies = cert.GetExtension(
            ...
            foreach (Asn1Encodable element in certPolicies)
            {
                ...
                if (!ANY_POLICY_OID.Equals(pOid))
                {
                    ...
                    bool match = PkixCertPathValidatorUtilities.ProcessCertD1i(
                        i,
                        policyNodes,
                        pOid,
                        pq
            ...
            if (
                (inhibitAnyPolicy > 0)
                || ((i < n) && PkixCertPathValidatorUtilities.IsSelfIssued(cert))
            )
            {
                foreach (Asn1Encodable element in certPolicies)
                {
                    ...
                    {
                        var _apq = PkixCertPathValidatorUtilities.GetQualifierSet(
                            pInfo.PolicyQualifiers
                        );
                        ...
                        foreach (var _node in policyNodes[i - 1])
                        {
                            foreach (var _policy in _node.ExpectedPolicies)
                            {
                                ...
                                if (validPolicyChild == null)
                                {
                                    ...
                                    var _newChild = new PkixPolicyNode(
                                        null,
                                        i,
            ...
            // (d) (3)
            //
            validPolicyTree = PkixCertPathValidatorUtilities.RemoveChildlessPolicyNodes(
                validPolicyTree,
                policyNodes,
                depthLimit: i
            );
        ...
        */
        ...
        {
            IssuingDistributionPoint idp = crl.GetExtension(
                X509Extensions.IssuingDistributionPoint,
                IssuingDistributionPoint.GetInstance
            );
        ...
        //throws AnnotatedException
        {
            ...
            {
                throw new Exception(
                    "issuing distribution point extension could not be decoded.",
                    e
                );
            }
            ...
            {
                return new ReasonsMask(dp.Reasons.IntValue).Intersect(
                    new ReasonsMask(idp.OnlySomeReasons.IntValue)
                );
            }
            // (d) (4)
            if ((idp == null || idp.OnlySomeReasons == null) && dp.Reasons == null)
        ...
        */
        ...
        )
        {
            ...
            try
            {
                CollectionUtilities.CollectMatches(
                    signingCerts,
                    certSelector,
                    paramsPKIX.GetStoresCert()
                );
            }
            catch (Exception e)
            {
            ...
            foreach (X509Certificate signingCert in signingCerts)
            {
                ...
                try
                {
                    ...
                    PkixBuilderParameters parameters = PkixBuilderParameters.GetInstance(
                        paramsPKIX
                    );
                ...
                {
                    throw new Exception(
                        "Public key of issuer certificate of CRL could not be retrieved.",
                        e
                    );
                }
            }
        ...
        */
        ...
        )
        {
            ...
            var crls = PkixCertPathValidatorUtilities.GetCompleteCrls(
                dp,
                cert,
                currentDate,
                paramsPKIX
            ...
            )
            {
                try
                {
                    ...
                    {
                        // get delta CRLs
                        HashSet<X509Crl> deltaCRLs = PkixCertPathValidatorUtilities.GetDeltaCrls(
                            currentDate,
                            paramsPKIX,
                            crl
                        );
                    ...
                    PkixCertPathValidatorUtilities.CheckCrlCriticalExtensions(
                        crl,
                ...
                try
                {
                    ...
                    DistributionPoint dp = new DistributionPoint(
                        new DistributionPointName(
                            0,
                            new GeneralNames(
                                new GeneralName(GeneralName.DirectoryName, cert.IssuerDN)
                            )
                        ),
                        null,
                        null
        ...
        )
        {
            ...
            if (mappings != null)
            {
                ...
                foreach (var e_idp in m_idp)
                {
                    ...
                    var validPolicyNode = PkixCertPathValidatorUtilities.FindValidPolicy(
                        policyNodes[i],
                        id_p
                    );
                    ...
                    var anyPolicyNode = PkixCertPathValidatorUtilities.FindValidPolicy(
                        policyNodes[i],
                        ANY_POLICY
                    );
                    ...
                    foreach (Asn1Encodable element in policies)
                    {
                        ...
                        if (ANY_POLICY_OID.Equals(policyInformation.PolicyIdentifier))
                        {
                            try
                            {
                                pq = PkixCertPathValidatorUtilities.GetQualifierSet(
                    ...
                    bool critical = PkixCertPathValidatorUtilities.HasCriticalExtension(
                        cert,
                        X509Extensions.CertificatePolicies
                    );
        ...
        )
        {
            ...
            HashSet<X509Crl> completeSet = PkixCrlUtilities.ImplFindCrls(
                crlselect,
                paramsPKIX,
                currentDate
            );
            ...
            if (paramsPKIX.IsUseDeltasEnabled)
            {
                ...
                try
                {
                    deltaSet = PkixCertPathValidatorUtilities.GetDeltaCrls(
                        currentDate,
                        paramsPKIX,
                        crl
                    );
        ...
        internal static HashSet<X509Crl> ProcessCrlA1i(
            DateTime currentDate,
            PkixParameters paramsPKIX,
            X509Certificate cert,
            X509Crl crl
        )
        {
            if (paramsPKIX.IsUseDeltasEnabled)
            {
                ...
                if (freshestCRL != null)
                {
                    ...
                    try
                    {
                        return PkixCertPathValidatorUtilities.GetDeltaCrls(
                            currentDate,
                            paramsPKIX,
                            crl
                        );
        ...
        )
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Could not validate certificate: " + e.Message,
                    e,
                    index
                );
            }
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Could not validate time of certificate.",
                    e,
                    index
                );
            }
        ...
        internal static int PrepareNextCertI1(PkixCertPath certPath, int index, int explicitPolicy)
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Policy constraints extension cannot be decoded.",
                    e,
                    index
                );
            }
            ...
            if (pc != null)
            {
                foreach (var policyConstraint in pc)
                {
                    try
                    {
                        Asn1TaggedObject constraint = Asn1TaggedObject.GetInstance(
                            policyConstraint
                        );
        ...
        )
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Name constraints extension could not be decoded.",
                    e,
                    index
                );
            }
        ...
        internal static void PrepareNextCertK(PkixCertPath certPath, int index)
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Basic constraints extension cannot be decoded.",
                    e,
                    index
                );
            }
        ...
        internal static int PrepareNextCertM(PkixCertPath certPath, int index, int maxPathLength)
        {
            ...
            if (bc != null && bc.IsCA())
            {
                ...
                {
                    maxPathLength = System.Math.Min(
                        maxPathLength,
                        pathLenConstraint.IntPositiveValueExact
                    );
                }
            }
            return maxPathLength;
        ...
        internal static int WrapupCertB(PkixCertPath certPath, int index, int explicitPolicy)
        {
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Policy constraints could not be decoded.",
                    e,
                    index
                );
            }
            ...
            if (pc != null)
            {
                foreach (var policyConstraint in pc)
                {
                    ...
                    if (constraint.HasContextTag(0))
                    {
                        ...
                        {
                            throw new PkixCertPathValidatorException(
                                "Policy constraints requireExplicitPolicy field could not be decoded.",
                                e,
                                index
                            );
                        }
        ...
        )
        {
            ...
            if (validPolicyTree == null)
            {
                ...
                {
                    throw new PkixCertPathValidatorException(
                        "Explicit policy requested but none available.",
                        null,
                        index
                    );
                }
        ...
        */
        ...
        )
        {
            ...
            try
            {
                completeIdp = completeCrl.GetExtension(
                    X509Extensions.IssuingDistributionPoint,
                    IssuingDistributionPoint.GetInstance
                );
            }
            ...
            {
                throw new Exception(
                    "000 Issuing distribution point extension could not be decoded.",
                    e
                );
            }
            ...
            if (pkixParams.IsUseDeltasEnabled)
            {
                ...
                try
                {
                    deltaIdp = deltaCrl.GetExtension(
                        X509Extensions.IssuingDistributionPoint,
                        IssuingDistributionPoint.GetInstance
                    );
                }
                ...
                try
                {
                    completeKeyIdentifier = X509ExtensionUtilities.GetAuthorityKeyIdentifier(
                        completeCrl
                    );
                }
                catch (Exception e)
        ...
        )
        {
            if (certStatus.Status == CertStatus.Unrevoked)
            {
                PkixCertPathValidatorUtilities.GetCertStatus(
                    validDate,
                    completecrl,
                    cert,
                    certStatus
