        ...
        )
        {
            if (
                !(
                    ...
                    is X509AttrCertStoreSelector attrCertSelector
                )
            )
            {
            ...
            PkixCertPath holderCertPath = Rfc3281CertPathUtilities.ProcessAttrCert1(
                attrCert,
                pkixParams
            );
            PkixCertPathValidatorResult result = Rfc3281CertPathUtilities.ProcessAttrCert2(
                certPath,
                pkixParams
            );
            ...
            Rfc3281CertPathUtilities.ProcessAttrCert7(
                attrCert,
                certPath,
                holderCertPath,
                pkixParams
            ...
            try
            {
                date = PkixCertPathValidatorUtilities.GetValidCertDateFromValidityModel(
                    pkixParams,
                    null,
                    -1
                );
            ...
            catch (Exception e)
            {
                throw new PkixCertPathValidatorException(
                    "Could not get validity date from attribute certificate.",
                    e
                );
            }
