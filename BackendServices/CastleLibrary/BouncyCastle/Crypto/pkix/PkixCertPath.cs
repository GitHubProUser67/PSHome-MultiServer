    ...
    //		: CertPath
    {
        ...
        public PkixCertPath(Stream inStream, string encoding)
        {
            ...
            try
            {
                ...
                {
                    using (
                        var asn1In = new Asn1InputStream(inStream, int.MaxValue, leaveOpen: true)
                    )
                    {
                        ...
                        var certArray = asn1Sequence.MapElements(element => new X509Certificate(
                            X509CertificateStructure.GetInstance(element.ToAsn1Object())
                        ));
                    ...
                    Platform.EqualsIgnoreCase("PEM", encoding)
