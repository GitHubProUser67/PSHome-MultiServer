...
namespace Org.BouncyCastle.Pkix
{
    ...
    public class PkixCertPathValidator
    {
        ...
        )
        {
            ...
            var validPolicyTree = new PkixPolicyNode(
                null,
                0,
                policySet,
                null,
            ...
            {
                throw new PkixCertPathValidatorException(
                    "Subject of trust anchor could not be (re)encoded.",
                    ex,
                    -1
                );
            }
            ...
            try
            {
                workingAlgID = PkixCertPathValidatorUtilities.GetAlgorithmIdentifier(
                    workingPublicKey
                );
            }
            ...
            for (index = certs.Count - 1; index >= 0; index--)
            {
                ...
                validPolicyTree = Rfc3280CertPathUtilities.ProcessCertD(
                    certPath,
                    index,
                    acceptablePolicies,
                    validPolicyTree,
                ...
                validPolicyTree = Rfc3280CertPathUtilities.ProcessCertE(
                    certPath,
                    index,
                    validPolicyTree
                );

                Rfc3280CertPathUtilities.ProcessCertF(
                    certPath,
                    index,
                    validPolicyTree,
                    explicitPolicy
                ...
                if (i != n)
                {
                    ...
                    Rfc3280CertPathUtilities.PrepareNextCertG(
                        certPath,
                        index,
                    ...
                    // (o)
                    Rfc3280CertPathUtilities.PrepareNextCertO(
                        certPath,
                        index,
                        criticalExtensions1,
                        certPathCheckers
                    ...
                    try
                    {
                        workingPublicKey = PkixCertPathValidatorUtilities.GetNextWorkingKey(
                    ...
                    {
                        throw new PkixCertPathValidatorException(
                            "Next working key could not be retrieved.",
                            e,
                            index
                        );
                    }
            ...
            explicitPolicy = Rfc3280CertPathUtilities.WrapupCertB(
                certPath,
                index + 1,
                explicitPolicy
            );
            ...
            Rfc3280CertPathUtilities.WrapupCertF(
                certPath,
                index + 1,
                certPathCheckers,
                criticalExtensions
            ...
            PkixPolicyNode intersection = Rfc3280CertPathUtilities.WrapupCertG(
                certPath,
                paramsPkix,
