...
namespace Org.BouncyCastle.Security
{
    public static class ParameterUtilities
    {
        ...
        )
        {
            ...
            if (
                NistObjectIdentifiers.IdAes128Gcm.Id.Equals(algorithm)
            ...
            )
            {
                ...
                return new AeadParameters(
                    keyParameter,
                    gcmParameters.IcvLen * 8,
                    gcmParameters.GetNonce()
                );
            }

            if (
                NistObjectIdentifiers.IdAes128Ccm.Id.Equals(algorithm)
            ...
            )
            {
                ...
                return new AeadParameters(
                    keyParameter,
                    ccmParameters.IcvLen * 8,
                    ccmParameters.GetNonce()
                );
            }
        ...
        public static ICipherParameters GetContext(
        ...
        public static ICipherParameters GetRandom(
            ICipherParameters cipherParameters,
            out SecureRandom random
        )
        {
