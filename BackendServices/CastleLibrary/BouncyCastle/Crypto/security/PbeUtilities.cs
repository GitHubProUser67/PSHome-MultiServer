...
namespace Org.BouncyCastle.Security
{
    ...
    public static class PbeUtilities
    {
        ...
        private static readonly IDictionary<string, string> Algorithms = new Dictionary<
            string,
            string
        >(StringComparer.OrdinalIgnoreCase);
        private static readonly IDictionary<string, string> AlgorithmType = new Dictionary<
            string,
            string
        >(StringComparer.OrdinalIgnoreCase);
        private static readonly IDictionary<string, DerObjectIdentifier> Oids = new Dictionary<
            string,
            DerObjectIdentifier
        >(StringComparer.OrdinalIgnoreCase);
        ...
        static PbeUtilities()
        {
            ...
            Algorithms[BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.Id] =
                "PBEwithSHA-1and128bitAES-CBC-BC";
            Algorithms[BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.Id] =
                "PBEwithSHA-1and192bitAES-CBC-BC";
            Algorithms[BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.Id] =
                "PBEwithSHA-1and256bitAES-CBC-BC";
            Algorithms[BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.Id] =
                "PBEwithSHA-256and128bitAES-CBC-BC";
            Algorithms[BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.Id] =
                "PBEwithSHA-256and192bitAES-CBC-BC";
            Algorithms[BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.Id] =
            ...
            Algorithms[PkcsObjectIdentifiers.PbeWithShaAnd128BitRC4.Id] =
            ...
            Algorithms[PkcsObjectIdentifiers.PbeWithShaAnd3KeyTripleDesCbc.Id] =
            ...
            Algorithms[PkcsObjectIdentifiers.PbeWithShaAnd2KeyTripleDesCbc.Id] =
            ...
            Algorithms[PkcsObjectIdentifiers.PbeWithShaAnd128BitRC2Cbc.Id] =
            ...
            Algorithms[PkcsObjectIdentifiers.PbewithShaAnd40BitRC2Cbc.Id] =
            ...
            Oids["PBEwithSHA-1and3-keyDESEDE-CBC"] =
                PkcsObjectIdentifiers.PbeWithShaAnd3KeyTripleDesCbc;
            Oids["PBEwithSHA-1and2-keyDESEDE-CBC"] =
                PkcsObjectIdentifiers.PbeWithShaAnd2KeyTripleDesCbc;
        ...
        )
        {
            ...
            if (
                NistObjectIdentifiers.IdAes128Cbc.Equals(cipherAlgorithm)
            ...
            KeyDerivationFunc func = new KeyDerivationFunc(
                PkcsObjectIdentifiers.IdPbkdf2,
                new Pbkdf2Params(
                    salt,
                    iterationCount,
                    new AlgorithmIdentifier(hashAlgorithm, DerNull.Instance)
                )
            );
        ...
        {
            return GenerateCipherParameters(
                algorithmOid.Id,
                password,
                wrongPkcs12Zero,
                pbeParameters
        ...
        public static object CreateEngine(string algorithm)
        {
            ...
            if (
                Platform.StartsWith(mechanism, "PBEwithMD2")
            ...
            {
                if (
                    Platform.EndsWith(mechanism, "AES-CBC-BC")
                    || Platform.EndsWith(mechanism, "AES-CBC-OPENSSL")
                )
                {
        ...
        private static ICipherParameters FixDesParity(
            string mechanism,
            ICipherParameters parameters
        )
        {
            if (
                !Platform.EndsWith(mechanism, "DES-CBC")
                && !Platform.EndsWith(mechanism, "DESEDE-CBC")
            )
            {
                return parameters;
            }
            ...
            if (parameters is ParametersWithIV)
            {
                ...
                return new ParametersWithIV(
                    FixDesParity(mechanism, ivParams.Parameters),
                    ivParams.GetIV()
                );
            }
