...
namespace Org.BouncyCastle.Security
{
    ...
    public static class SignerUtilities
    {
        ...
        private static readonly HashSet<string> NoRandom = new HashSet<string>(
            StringComparer.OrdinalIgnoreCase
        );
        private static readonly Dictionary<string, DerObjectIdentifier> Oids = new Dictionary<
            string,
            DerObjectIdentifier
        >(StringComparer.OrdinalIgnoreCase);
        ...
        static SignerUtilities()
        {
            ...
            AlgorithmOidMap[PkcsObjectIdentifiers.Sha512_224WithRSAEncryption] =
                "SHA-512(224)withRSA";
            ...
            AlgorithmOidMap[PkcsObjectIdentifiers.Sha512_256WithRSAEncryption] =
                "SHA-512(256)withRSA";
            ...
            AlgorithmOidMap[TeleTrusTObjectIdentifiers.RsaSignatureWithRipeMD160] =
                "RIPEMD160withRSA";

            AlgorithmMap["RIPEMD256WITHRSA"] = "RIPEMD256withRSA";
            AlgorithmMap["RIPEMD256WITHRSAENCRYPTION"] = "RIPEMD256withRSA";
            AlgorithmOidMap[TeleTrusTObjectIdentifiers.RsaSignatureWithRipeMD256] =
                "RIPEMD256withRSA";
            ...
            AlgorithmOidMap[BsiObjectIdentifiers.ecdsa_plain_RIPEMD160] =
            ...
            AlgorithmOidMap[CryptoProObjectIdentifiers.GostR3411x94WithGostR3410x2001] =
                "ECGOST3410";
        ...
        private static Asn1Encodable GetDefaultX509ParametersForMechanism(string mechanism)
        {
            ...
            {
                string digestName = mechanism.Substring(
                    0,
                    mechanism.Length - "withRSAandMGF1".Length
                );
        ...
        private static Asn1Encodable GetPssX509Parameters(string digestName)
        {
            AlgorithmIdentifier hashAlgorithm = new AlgorithmIdentifier(
                DigestUtilities.GetObjectIdentifier(digestName),
                DerNull.Instance
            );
        ...
        private static ISigner GetSignerForMechanism(string mechanism)
        {
            ...
            if (
                Platform.EndsWith(mechanism, "withCVC-ECDSA")
            ...
            if (Platform.StartsWith(mechanism, "ECGOST3410"))
            {
                ...
                {
                    return new Gost3410DigestSigner(
                        new ECGost3410Signer(),
            ...
            if (
                SlhDsaParameters.ByName.TryGetValue(
                    mechanism,
        ...
        private static ISigner InitSignerForMechanism(
            string mechanism,
            bool forSigning,
        ...
        {
            var signer =
                GetSignerForMechanism(mechanism)
                ?? throw new SecurityUtilityException(
                    "Signing mechanism " + mechanism + " not recognised."
                );
