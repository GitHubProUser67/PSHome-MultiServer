    ...
    public static class PublicKeyFactory
    {
        ...
        public static AsymmetricKeyParameter CreateKey(SubjectPublicKeyInfo keyInfo)
        {
            ...
            else if (algOid.Equals(OiwObjectIdentifiers.ElGamalAlgorithm))
            {
                ...
                algOid.Equals(X9ObjectIdentifiers.IdDsa)
            ...
            {
                Gost3410PublicKeyAlgParameters algParams =
                    Gost3410PublicKeyAlgParameters.GetInstance(algID.Parameters);
            ...
            )
            {
                ...
                UAObjectIdentifiers.dstu4145be.Equals(algOid)
        ...
        internal static MLDsaPublicKeyParameters GetMLDsaPublicKey(
        ...
        )
        {
            if (publicKey.IsOctetAligned())
            {
                ...
                if (bytesLength == publicKeyLength)
                    ...
                    return MLDsaPublicKeyParameters.FromEncoding(
                        mlDsaParameters,
        ...
        internal static MLKemPublicKeyParameters GetMLKemPublicKey(
        ...
        )
        {
            if (publicKey.IsOctetAligned())
            {
                ...
                if (bytesLength == publicKeyLength)
                    // TODO[pqc] Avoid redundant copies?
                    return MLKemPublicKeyParameters.FromEncoding(
                        mlKemParameters,
                        encoding: publicKey.GetOctets()
                    );
            }
        ...
        internal static SlhDsaPublicKeyParameters GetSlhDsaPublicKey(
        ...
        )
        {
            if (publicKey.IsOctetAligned())
            {
                ...
                if (bytesLength == publicKeyLength)
                    // TODO[pqc] Avoid redundant copies?
                    return SlhDsaPublicKeyParameters.FromEncoding(
                        slhDsaParameters,
                        encoding: publicKey.GetOctets()
                    );
