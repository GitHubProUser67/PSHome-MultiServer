...
namespace Org.BouncyCastle.Security
{
    ...
    {
        private static readonly Dictionary<string, string> AlgorithmMap = new Dictionary<
            string,
            string
        ...
        static AgreementUtilities()
        {
            ...
            AlgorithmOidMap[X9ObjectIdentifiers.DHSinglePassCofactorDHSha1KdfScheme] =
                "ECCDHWITHSHA1KDF";
            AlgorithmOidMap[X9ObjectIdentifiers.MqvSinglePassSha1KdfScheme] = "ECMQVWITHSHA1KDF";

            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_stdDH_sha224kdf_scheme] =
                "ECDHWITHSHA224KDF";
            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_cofactorDH_sha224kdf_scheme] =
                "ECCDHWITHSHA224KDF";
            AlgorithmOidMap[SecObjectIdentifiers.mqvSinglePass_sha224kdf_scheme] =
                "ECMQVWITHSHA224KDF";

            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_stdDH_sha256kdf_scheme] =
                "ECDHWITHSHA256KDF";
            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_cofactorDH_sha256kdf_scheme] =
                "ECCDHWITHSHA256KDF";
            AlgorithmOidMap[SecObjectIdentifiers.mqvSinglePass_sha256kdf_scheme] =
                "ECMQVWITHSHA256KDF";

            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_stdDH_sha384kdf_scheme] =
                "ECDHWITHSHA384KDF";
            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_cofactorDH_sha384kdf_scheme] =
                "ECCDHWITHSHA384KDF";
            AlgorithmOidMap[SecObjectIdentifiers.mqvSinglePass_sha384kdf_scheme] =
                "ECMQVWITHSHA384KDF";

            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_stdDH_sha512kdf_scheme] =
                "ECDHWITHSHA512KDF";
            AlgorithmOidMap[SecObjectIdentifiers.dhSinglePass_cofactorDH_sha512kdf_scheme] =
                "ECCDHWITHSHA512KDF";
            AlgorithmOidMap[SecObjectIdentifiers.mqvSinglePass_sha512kdf_scheme] =
                "ECMQVWITHSHA512KDF";
            ...
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_256] =
                "ECGOST3410-2012-256";
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256] =
                "ECGOST3410-2012-256";

            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_512] =
                "ECGOST3410-2012-512";
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512] =
                "ECGOST3410-2012-512";
        ...
        public static IBasicAgreement GetBasicAgreementWithKdf(
            DerObjectIdentifier agreeAlgOid,
        ...
        )
        {
            ...
            throw new SecurityUtilityException(
                "Basic Agreement (with KDF) " + agreeAlgorithm + " not recognised."
            );
        }

        private static IBasicAgreement GetBasicAgreementWithKdfForMechanism(
            string mechanism,
            string wrapAlgorithm
        )
        {
            if (mechanism == "ECDHWITHSHA1KDF")
                return new ECDHWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-1")
                );
            if (mechanism == "ECDHWITHSHA224KDF")
                return new ECDHWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-224")
                );
            if (mechanism == "ECDHWITHSHA256KDF")
                return new ECDHWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-256")
                );
            if (mechanism == "ECDHWITHSHA384KDF")
                return new ECDHWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-384")
                );
            if (mechanism == "ECDHWITHSHA512KDF")
                return new ECDHWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-512")
                );

            if (mechanism == "ECCDHWITHSHA1KDF")
                return new ECDHCWithKdfBasicAgreement(
                    wrapAlgorithm,
                    CreateECDHKekGenerator("SHA-1")
                );
