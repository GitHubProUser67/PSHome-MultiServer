...
namespace Org.BouncyCastle.Security
{
    ...
    public static class DigestUtilities
    {
        ...
        static DigestUtilities()
        {
            ...
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256] =
                "GOST3411-2012-256";
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512] =
                "GOST3411-2012-512";
        ...
        private static IDigest GetDigestForMechanism(string mechanism)
        {
            ...
            switch (digestAlgorithm)
            {
                ...
                case DigestAlgorithm.BLAKE3_256:
                ...
                case DigestAlgorithm.SHAKE128_256:
                    return new ShakeDigest(128);
                case DigestAlgorithm.SHAKE256_512:
