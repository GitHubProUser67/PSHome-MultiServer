...
namespace Org.BouncyCastle.Security
{
    ...
    public static class MacUtilities
    {
        ...
        static MacUtilities()
        {
            ...
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_256] =
                "HMAC-GOST3411-2012-256";
            AlgorithmOidMap[RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_512] =
            ...
            AlgorithmMap["DESEDEISO9797ALG1MACWITHISO7816-4PADDING"] =
                "DESEDEMAC64WITHISO7816-4PADDING";
            AlgorithmMap["DESEDEISO9797ALG1WITHISO7816-4PADDING"] =
                "DESEDEMAC64WITHISO7816-4PADDING";
        ...
        private static IMac GetMacForMechanism(string mechanism)
        {
            ...
            if (Platform.StartsWith(mechanism, "HMAC"))
            {
                string digestName;
                if (
                    Platform.StartsWith(mechanism, "HMAC-")
                    || Platform.StartsWith(mechanism, "HMAC/")
                )
                {
            ...
            if (mechanism == "DESWITHISO9797" || mechanism == "ISO9797ALG3MAC")
            {
