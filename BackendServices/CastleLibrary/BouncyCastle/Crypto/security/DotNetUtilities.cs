...
namespace Org.BouncyCastle.Security
{
    ...
    public static class DotNetUtilities
    {
        ...
        {
            return SystemX509.X509CertificateLoader.LoadCertificate(
                x509Struct.GetEncoded(Asn1Encodable.Der)
            );
        }
        ...
        public static DsaPublicKeyParameters GetDsaPublicKey(DSAParameters dp)
        {
            DsaValidationParameters validationParameters =
                (dp.Seed != null) ? new DsaValidationParameters(dp.Seed, dp.Counter) : null;
