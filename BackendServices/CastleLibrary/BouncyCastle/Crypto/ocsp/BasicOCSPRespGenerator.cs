...
namespace Org.BouncyCastle.Ocsp
{
    ...
    public class BasicOcspRespGenerator
    {
        ...
        private class ResponseObject
        {
            ...
            )
            {
                ...
                else
                {
                    ...
                    var revocationTime = Rfc5280Asn1Utilities.CreateGeneralizedTime(
                        rs.RevocationTime
                    );
                ...
                this.nextUpdate = nextUpdate.HasValue
                    ? Rfc5280Asn1Utilities.CreateGeneralizedTime(nextUpdate.Value)
                    : null;
        ...
        {
            list.Add(
                new ResponseObject(certID, certStatus, DateTime.UtcNow, null, singleExtensions)
            );
        }
        ...
        {
            list.Add(
                new ResponseObject(certID, certStatus, thisUpdate, nextUpdate, singleExtensions)
            );
        }
        ...
        {
            AlgorithmIdentifier signingAlgID = (AlgorithmIdentifier)
                signatureFactory.AlgorithmDetails;
            ...
            return new BasicOcspResp(
                new BasicOcspResponse(responseData, sigAlgID, bitSig, chainSeq)
            );
        }
        ...
        )
        {
            ...
            return GenerateResponse(
                new Asn1SignatureFactory(signingAlgorithm, privateKey, random),
                chain,
                producedAt
            );
        }
