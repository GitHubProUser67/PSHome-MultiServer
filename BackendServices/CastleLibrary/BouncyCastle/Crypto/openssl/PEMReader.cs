    ...
    */
    public class PemReader : Utilities.IO.Pem.PemReader
    {
        ...
        */
        ...
        {
            RsaPublicKeyStructure rsaPublicKey = RsaPublicKeyStructure.GetInstance(
                pemObject.Content
            );
        ...
        */
        private object ReadPrivateKey(PemObject pemObject)
        {
            ...
            string type = pemObject
                .Type.Substring(0, pemObject.Type.Length - "PRIVATE KEY".Length)
                .Trim();
            ...
            try
            {
                ...
                switch (type)
                {
                    ...
                    case "ENCRYPTED":
                    {
                        ...
                        return PrivateKeyFactory.DecryptKey(
                            password,
                            EncryptedPrivateKeyInfo.GetInstance(seq)
                        );
                    }
