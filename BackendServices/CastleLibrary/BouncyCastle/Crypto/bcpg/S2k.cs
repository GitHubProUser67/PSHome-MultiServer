...
namespace Org.BouncyCastle.Bcpg
{
    ...
    public class S2k : BcpgObject
    {
        ...
        public static S2k GenerateSaltedAndIterated(
        ...
        )
        {
            if (itCount < 0x00 || itCount > 0xFF)
                throw new ArgumentOutOfRangeException(
                    nameof(itCount),
                    "Coded S2K iteration count must be in range 0-255"
                );
        ...
        internal S2k(Stream inStr)
        {
            ...
            switch (m_type)
            {
                ...
                case Argon2:
                {
                    ...
                    m_argon2Config = new Argon2Params(
                        salt,
                        passes,
                        parallelism,
                        memorySizeExponent
        ...
        public virtual long IterationCount =>
            m_itCount >= 256 ? m_itCount : DeriveIterationCount(m_itCount);
        ...
        public override void Encode(BcpgOutputStream bcpgOut)
        {
            ...
            switch (m_type)
            {
                ...
                case Argon2:
                {
                    ...
                    WriteCheckedByte(
                        bcpgOut,
                        m_argon2Config.MemorySizeExponent,
        ...
        private static long DeriveIterationCount(int itCount) =>
            (16 + (itCount & 15)) << ((itCount >> 4) + ExpBias);

        private static byte[] GenerateIV(SecureRandom secureRandom) =>
            SecureRandom.GetNextBytes(secureRandom, 8);
