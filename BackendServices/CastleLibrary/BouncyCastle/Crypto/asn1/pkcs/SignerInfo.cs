...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public SignerInfo(Asn1Sequence seq)
        {
            ...
            m_authenticatedAttributes = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_unauthenticatedAttributes = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
        ...
        )
        {
            ...
            m_issuerAndSerialNumber =
                issuerAndSerialNumber
                ?? throw new ArgumentNullException(nameof(issuerAndSerialNumber));
            m_digestAlgorithm =
                digAlgorithm ?? throw new ArgumentNullException(nameof(digAlgorithm));
            m_authenticatedAttributes = authenticatedAttributes;
            m_digestEncryptionAlgorithm =
                digEncryptionAlgorithm
                ?? throw new ArgumentNullException(nameof(digEncryptionAlgorithm));
            m_encryptedDigest =
                encryptedDigest ?? throw new ArgumentNullException(nameof(encryptedDigest));
