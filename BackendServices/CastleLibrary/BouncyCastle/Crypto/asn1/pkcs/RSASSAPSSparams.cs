...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    ...
    {
        public static readonly AlgorithmIdentifier DefaultHashAlgorithm = new AlgorithmIdentifier(
            OiwObjectIdentifiers.IdSha1,
            DerNull.Instance
        );
        public static readonly AlgorithmIdentifier DefaultMaskGenAlgorithm =
        ...
        public static readonly DerInteger DefaultSaltLength = DerInteger.ValueOf(20);
        public static readonly DerInteger DefaultTrailerField = DerInteger.One;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static RsassaPssParameters GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public RsassaPssParameters(Asn1Sequence seq)
        {
            ...
            m_hashAlgorithm =
                Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    0,
                    true,
            ...
            m_saltLength =
                Asn1Utilities.ReadOptionalContextTagged(seq, ref pos, 2, true, DerInteger.GetTagged)
                ?? DefaultSaltLength;

            m_trailerField =
                Asn1Utilities.ReadOptionalContextTagged(seq, ref pos, 3, true, DerInteger.GetTagged)
                ?? DefaultTrailerField;
