...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    public class RsaPrivateKeyStructure : Asn1Encodable
    {
        ...
        public static RsaPrivateKeyStructure GetTagged(
        ...
        )
        {
            ...
            m_publicExponent =
                publicExponent ?? throw new ArgumentNullException(nameof(publicExponent));
            m_privateExponent =
                privateExponent ?? throw new ArgumentNullException(nameof(privateExponent));
