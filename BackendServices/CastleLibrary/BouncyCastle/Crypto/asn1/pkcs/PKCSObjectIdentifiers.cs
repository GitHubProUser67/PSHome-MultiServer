...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    ...
    public abstract class PkcsObjectIdentifiers
    {
        ...
        public static readonly DerObjectIdentifier Sha512_224WithRSAEncryption = pkcs_1.Branch(
            "15"
        );

        /** PKCS#1: 1.2.840.113549.1.1.16 */
        public static readonly DerObjectIdentifier Sha512_256WithRSAEncryption = pkcs_1.Branch(
            "16"
        );
        ...
        private static readonly DerObjectIdentifier EncryptionAlgorithmOid =
            new DerObjectIdentifier(EncryptionAlgorithm);
        ...
        private static readonly DerObjectIdentifier DigestAlgorithmOid = new DerObjectIdentifier(
            DigestAlgorithm
        );
        ...
        public static readonly DerObjectIdentifier IdHmacWithSha224 = DigestAlgorithmOid.Branch(
            "8"
        );
        public static readonly DerObjectIdentifier IdHmacWithSha256 = DigestAlgorithmOid.Branch(
            "9"
        );
        public static readonly DerObjectIdentifier IdHmacWithSha384 = DigestAlgorithmOid.Branch(
            "10"
        );
        public static readonly DerObjectIdentifier IdHmacWithSha512 = DigestAlgorithmOid.Branch(
            "11"
        );
        public static readonly DerObjectIdentifier IdHmacWithSha512_224 = DigestAlgorithmOid.Branch(
            "12"
        );
        public static readonly DerObjectIdentifier IdHmacWithSha512_256 = DigestAlgorithmOid.Branch(
            "13"
        );
         ...
         * </pre>
         */
        public static readonly DerObjectIdentifier IdAlgAeadChaCha20Poly1305 = smime_alg.Branch(
            "18"
        );
        ...
        */
        ...
        private static readonly DerObjectIdentifier pkcs_12_bag_types = new DerObjectIdentifier(
            BagTypes
        );

        public static readonly DerObjectIdentifier KeyBag = pkcs_12_bag_types.Branch("1");
        public static readonly DerObjectIdentifier Pkcs8ShroudedKeyBag = pkcs_12_bag_types.Branch(
            "2"
        );
        ...
        private static readonly DerObjectIdentifier pkcs_12_pbe_ids = new DerObjectIdentifier(
            Pkcs12PbeIds
        );

        public static readonly DerObjectIdentifier PbeWithShaAnd128BitRC4 = pkcs_12_pbe_ids.Branch(
            "1"
        );
        public static readonly DerObjectIdentifier PbeWithShaAnd40BitRC4 = pkcs_12_pbe_ids.Branch(
            "2"
        );
        public static readonly DerObjectIdentifier PbeWithShaAnd3KeyTripleDesCbc =
            pkcs_12_pbe_ids.Branch("3");
        public static readonly DerObjectIdentifier PbeWithShaAnd2KeyTripleDesCbc =
            pkcs_12_pbe_ids.Branch("4");
        public static readonly DerObjectIdentifier PbeWithShaAnd128BitRC2Cbc =
            pkcs_12_pbe_ids.Branch("5");
        public static readonly DerObjectIdentifier PbewithShaAnd40BitRC2Cbc =
            pkcs_12_pbe_ids.Branch("6");
    }
}
