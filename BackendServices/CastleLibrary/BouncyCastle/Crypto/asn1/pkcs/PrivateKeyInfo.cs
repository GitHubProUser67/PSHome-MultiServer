...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    ...
    {
        public static PrivateKeyInfo Create(
        ...
        public static PrivateKeyInfo GetTagged(
        ...
        public virtual Asn1Object ParsePrivateKey() =>
            Asn1Object.FromByteArray(m_privateKey.GetOctets());
        ...
        public virtual Asn1Object ParsePublicKey()
        {
            return m_publicKey == null
                ? null
                : Asn1Object.FromMemoryStream(m_publicKey.GetOctetMemoryStream());
        }
