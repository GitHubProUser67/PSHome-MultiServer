...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    public class EncryptedPrivateKeyInfo : Asn1Encodable
    {
        ...
        public static EncryptedPrivateKeyInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        )
        {
            m_encryptionAlgorithm =
                encryptionAlgorithm ?? throw new ArgumentNullException(nameof(encryptionAlgorithm));
            m_encryptedData =
                encryptedData ?? throw new ArgumentNullException(nameof(encryptedData));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_encryptionAlgorithm, m_encryptedData);
    }
}
