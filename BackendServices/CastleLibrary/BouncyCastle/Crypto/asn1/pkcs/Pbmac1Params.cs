...
namespace Org.BouncyCastle.Asn1.Pkcs
{
    ...
    public sealed class Pbmac1Params : Asn1Encodable
    {
        ...
        public static Pbmac1Params GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_keyDerivationFunc =
                keyDerivationFunc ?? throw new ArgumentNullException(nameof(keyDerivationFunc));
            m_messageAuthScheme =
                messageAuthScheme ?? throw new ArgumentNullException(nameof(messageAuthScheme));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_keyDerivationFunc, m_messageAuthScheme);
    }
}
