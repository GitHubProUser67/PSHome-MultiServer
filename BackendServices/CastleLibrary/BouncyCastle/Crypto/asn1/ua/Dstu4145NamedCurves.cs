...
namespace Org.BouncyCastle.Asn1.UA
{
    ...
    public class Dstu4145NamedCurves
    {
        ...
        private static readonly ECDomainParameters[] DomainParameters = new ECDomainParameters[
            CurveCount
        ];
        ...
        private static readonly DerObjectIdentifier OidBase = UAObjectIdentifiers.dstu4145le.Branch(
            "2"
        );
        ...
        static Dstu4145NamedCurves()
        {
            ...
            curves[1] = new F2mCurve(
                167,
                6,
                One,
                new BigInteger("6EE3CEEB230811759F20518A0930F1A4315A827DAC", 16),
                n_s[1],
                h_s[1]
            );
            curves[2] = new F2mCurve(
                173,
                1,
                2,
                10,
                Zero,
                new BigInteger("108576C80499DB2FC16EDDF6853BBB278F6B6FB437D9", 16),
                n_s[2],
                h_s[2]
            );
            curves[3] = new F2mCurve(
                179,
                1,
                2,
                4,
                One,
                new BigInteger("4A6E0856526436F2F88DD07A341E32D04184572BEB710", 16),
                n_s[3],
                h_s[3]
            );
            curves[4] = new F2mCurve(
                191,
                9,
                One,
                new BigInteger("7BC86E2102902EC4D5890E8B6B4981ff27E0482750FEFC03", 16),
                n_s[4],
                h_s[4]
            );
            curves[5] = new F2mCurve(
                233,
                1,
                4,
                9,
                One,
                new BigInteger("06973B15095675534C7CF7E64A21BD54EF5DD3B8A0326AA936ECE454D2C", 16),
                n_s[5],
                h_s[5]
            );
            curves[6] = new F2mCurve(
                257,
                12,
                Zero,
                new BigInteger(
            ...
            points[0] = ConfigureBasepoint(
                curves[0],
                new BigInteger("2E2F85F5DD74CE983A5C4237229DAF8A3F35823BE", 16),
                new BigInteger("3826F008A8C51D7B95284D9D03FF0E00CE2CD723A", 16)
            );
            points[1] = ConfigureBasepoint(
                curves[1],
                new BigInteger("7A1F6653786A68192803910A3D30B2A2018B21CD54", 16),
                new BigInteger("5F49EB26781C0EC6B8909156D98ED435E45FD59918", 16)
            );
            points[2] = ConfigureBasepoint(
                curves[2],
                new BigInteger("4D41A619BCC6EADF0448FA22FAD567A9181D37389CA", 16),
                new BigInteger("10B51CC12849B234C75E6DD2028BF7FF5C1CE0D991A1", 16)
            );
            points[3] = ConfigureBasepoint(
                curves[3],
                new BigInteger("6BA06FE51464B2BD26DC57F48819BA9954667022C7D03", 16),
                new BigInteger("25FBC363582DCEC065080CA8287AAFF09788A66DC3A9E", 16)
            );
            points[4] = ConfigureBasepoint(
                curves[4],
                new BigInteger("714114B762F2FF4A7912A6D2AC58B9B5C2FCFE76DAEB7129", 16),
                new BigInteger("29C41E568B77C617EFE5902F11DB96FA9613CD8D03DB08DA", 16)
            );
            points[5] = ConfigureBasepoint(
                curves[5],
