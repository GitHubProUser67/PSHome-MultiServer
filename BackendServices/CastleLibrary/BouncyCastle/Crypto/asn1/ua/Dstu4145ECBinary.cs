...
{
    public class Dstu4145ECBinary : Asn1Encodable
    {
        ...
        public static Dstu4145ECBinary GetInstance(
        ...
        public static Dstu4145ECBinary GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public Dstu4145ECBinary(ECDomainParameters domainParameters)
        {
            ...
            if (!ECAlgorithms.IsF2mCurve(curve))
                throw new ArgumentException(
                    "only binary domain is possible",
                    nameof(domainParameters)
                );
            ...
            {
                throw new ArgumentException(
                    "curve must have a trinomial or pentanomial basis",
                    nameof(domainParameters)
                );
            }
