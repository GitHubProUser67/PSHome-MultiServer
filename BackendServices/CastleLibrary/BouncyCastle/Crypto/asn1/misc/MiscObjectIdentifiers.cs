namespace Org.BouncyCastle.Asn1.Misc
{
    ...
    public abstract class MiscObjectIdentifiers
    {
        ...
        //
        public static readonly DerObjectIdentifier Netscape = new DerObjectIdentifier(
            "2.16.840.1.113730.1"
        );
        ...
        //
        public static readonly DerObjectIdentifier Verisign = new DerObjectIdentifier(
            "2.16.840.1.113733.1"
        );
        ...
        public static readonly DerObjectIdentifier VerisignOnSiteJurisdictionHash = Verisign.Branch(
            "6.11"
        );
        ...
        //
        public static readonly DerObjectIdentifier Novell = new DerObjectIdentifier(
            "2.16.840.1.113719"
        );
        ...
        //
        public static readonly DerObjectIdentifier Entrust = new DerObjectIdentifier(
            "1.2.840.113533.7"
        );
        ...
        //
        public static readonly DerObjectIdentifier HMAC_SHA1 = new DerObjectIdentifier(
            "1.3.6.1.5.5.8.1.2"
        );
        ...
        // Ascom
        //
        public static readonly DerObjectIdentifier as_sys_sec_alg_ideaCBC = new DerObjectIdentifier(
        ...
        //
        public static readonly DerObjectIdentifier cryptlib = new DerObjectIdentifier(
            "1.3.6.1.4.1.3029"
        );

        public static readonly DerObjectIdentifier cryptlib_algorithm = cryptlib.Branch("1");
        public static readonly DerObjectIdentifier cryptlib_algorithm_blowfish_ECB =
            cryptlib_algorithm.Branch("1.1");
        public static readonly DerObjectIdentifier cryptlib_algorithm_blowfish_CBC =
            cryptlib_algorithm.Branch("1.2");
        public static readonly DerObjectIdentifier cryptlib_algorithm_blowfish_CFB =
            cryptlib_algorithm.Branch("1.3");
        public static readonly DerObjectIdentifier cryptlib_algorithm_blowfish_OFB =
            cryptlib_algorithm.Branch("1.4");

        //
        // Blake2b
        //
        public static readonly DerObjectIdentifier blake2 = new DerObjectIdentifier(
        ...
        //
        // Scrypt
        public static readonly DerObjectIdentifier id_scrypt = new DerObjectIdentifier(
        ...
        public static readonly DerObjectIdentifier id_alg_composite = new DerObjectIdentifier(
        ...
        public static readonly DerObjectIdentifier id_composite_key = new DerObjectIdentifier(
