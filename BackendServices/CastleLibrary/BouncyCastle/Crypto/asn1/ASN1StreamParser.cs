    ...
    public class Asn1StreamParser
    {
        ...
        internal IAsn1Convertible ImplParseObject(int tagHdr)
        {
            ...
            int length = Asn1InputStream.ReadLength(
                _in,
                _limit,
                tagNo == Asn1Tags.BitString
                    || tagNo == Asn1Tags.OctetString
                    || tagNo == Asn1Tags.Sequence
                    || tagNo == Asn1Tags.Set
            ...
            {
                DefiniteLengthInputStream defIn = new DefiniteLengthInputStream(
                    _in,
                    length,
                    _limit
                );
...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                default:
                    throw new Asn1Exception(
                        "unknown DL object encountered: 0x" + univTagNo.ToString("X")
                    );
            }
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
                default:
                    throw new Asn1Exception(
                        "unknown BER object encountered: 0x" + univTagNo.ToString("X")
                    );
            }
        }
        ...
        internal IAsn1Convertible ParseImplicitPrimitive(
            int univTagNo,
        ...
        internal IAsn1Convertible ParseObject(int univTagNo)
        {
            if (univTagNo < 0 || univTagNo > 30)
                throw new ArgumentException(
                    "invalid universal tag number: " + univTagNo,
                    "univTagNo"
                );
