...
namespace Org.BouncyCastle.Asn1.Ocsp
{
    public class BasicOcspResponse : Asn1Encodable
    {
        ...
        public static BasicOcspResponse GetTagged(
        ...
        {
            m_tbsResponseData =
                tbsResponseData ?? throw new ArgumentNullException(nameof(tbsResponseData));
        ...
        private BasicOcspResponse(Asn1Sequence seq)
        {
            ...
            m_certs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
