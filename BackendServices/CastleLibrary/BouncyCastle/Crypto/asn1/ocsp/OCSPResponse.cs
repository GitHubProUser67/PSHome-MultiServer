...
namespace Org.BouncyCastle.Asn1.Ocsp
{
    public class OcspResponse : Asn1Encodable
    {
        ...
        public static OcspResponse GetTagged(
        ...
        {
            m_responseStatus =
                responseStatus ?? throw new ArgumentNullException(nameof(responseStatus));
        ...
        private OcspResponse(Asn1Sequence seq)
        {
            ...
            m_responseBytes = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                ResponseBytes.GetTagged
            );
