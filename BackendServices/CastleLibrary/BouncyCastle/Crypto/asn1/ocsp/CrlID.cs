...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public CrlID(Asn1Sequence seq)
        {
            ...
            m_crlUrl = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                DerIA5String.GetTagged
            );
            m_crlNum = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_crlTime = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
