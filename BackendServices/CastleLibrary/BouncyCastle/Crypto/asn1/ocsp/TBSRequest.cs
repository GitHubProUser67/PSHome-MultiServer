...
namespace Org.BouncyCastle.Asn1.Ocsp
{
    public class TbsRequest : Asn1Encodable
    {
        ...
        private TbsRequest(Asn1Sequence seq)
        {
            ...
            {
                DerInteger version = Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    0,
                    true,
            ...
            m_requestorName = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_requestExtensions = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
