...
namespace Org.BouncyCastle.Asn1.Isara
{
    public static class IsaraObjectIdentifiers
    {
         ...
         */
        public static readonly DerObjectIdentifier id_alg_xmss = new DerObjectIdentifier(
         ...
         */
        public static readonly DerObjectIdentifier id_alg_xmssmt = new DerObjectIdentifier(
