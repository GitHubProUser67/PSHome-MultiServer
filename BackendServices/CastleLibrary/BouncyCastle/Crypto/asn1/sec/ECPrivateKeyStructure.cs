...
namespace Org.BouncyCastle.Asn1.Sec
{
    ...
    public class ECPrivateKeyStructure : Asn1Encodable
    {
        ...
        public static ECPrivateKeyStructure GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private ECPrivateKeyStructure(Asn1Sequence seq)
        {
            ...
            m_parameters = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
        ...
        )
        {
            ...
            byte[] privateKeyContents = BigIntegers.AsUnsignedByteArray(
                (orderBitLength + 7) / 8,
                key
            );
        ...
        public virtual BigInteger GetKey() =>
            BigIntegers.FromUnsignedByteArray(m_privateKey.GetOctets());
