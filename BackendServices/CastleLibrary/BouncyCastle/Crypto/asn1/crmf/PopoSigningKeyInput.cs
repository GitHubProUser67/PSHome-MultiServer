...
namespace Org.BouncyCastle.Asn1.Crmf
{
    public class PopoSigningKeyInput : Asn1Encodable
    {
        ...
        public static PopoSigningKeyInput GetInstance(
        ...
        public static PopoSigningKeyInput GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private PopoSigningKeyInput(Asn1Sequence seq)
        {
            ...
            {
                m_sender = GeneralName.GetInstance(
                    Asn1Utilities.GetExplicitContextBaseObject(tagObj, 0)
                );
            }
            else
            {
