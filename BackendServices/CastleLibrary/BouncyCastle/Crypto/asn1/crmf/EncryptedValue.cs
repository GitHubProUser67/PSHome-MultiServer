...
namespace Org.BouncyCastle.Asn1.Crmf
{
    public class EncryptedValue : Asn1Encodable
    {
        ...
        public static EncryptedValue GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private EncryptedValue(Asn1Sequence seq)
        {
            ...
            m_intendedAlg = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_symmAlg = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_encSymmKey = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
            ...
            m_keyAlg = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                false,
            ...
            m_valueHint = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                4,
                false,
