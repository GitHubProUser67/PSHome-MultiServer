...
namespace Org.BouncyCastle.Asn1.Crmf
{
    public class CertTemplate : Asn1Encodable
    {
        ...
        public static CertTemplate GetInstance(
        ...
        public static CertTemplate GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private CertTemplate(Asn1Sequence seq)
        {
            ...
            m_version = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_serialNumber = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_signingAlg = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
            ...
            m_issuer = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                true,
            ...
            m_validity = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                4,
                false,
                OptionalValidity.GetTagged
            );
            m_subject = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                5,
                true,
            ...
            m_publicKey = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                6,
                false,
                SubjectPublicKeyInfo.GetTagged
            );
            m_issuerUID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                7,
                false,
                DerBitString.GetTagged
            );
            m_subjectUID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                8,
                false,
            ...
            m_extensions = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                9,
                false,
                X509Extensions.GetTagged
            );
