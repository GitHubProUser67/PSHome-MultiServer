...
namespace Org.BouncyCastle.Asn1.Crmf
{
    ...
    public abstract class CrmfObjectIdentifiers
    {
        ...
        public static readonly DerObjectIdentifier id_regCtrl_authenticator = id_regCtrl.Branch(
            "2"
        );
        public static readonly DerObjectIdentifier id_regCtrl_pkiPublicationInfo =
            id_regCtrl.Branch("3");
        public static readonly DerObjectIdentifier id_regCtrl_pkiArchiveOptions = id_regCtrl.Branch(
            "4"
        );
        public static readonly DerObjectIdentifier id_regCtrl_oldCertID = id_regCtrl.Branch("5");
        public static readonly DerObjectIdentifier id_regCtrl_protocolEncrKey = id_regCtrl.Branch(
            "6"
        );
        ...
        public static readonly DerObjectIdentifier id_ct_encKeyWithID =
            PkcsObjectIdentifiers.id_ct.Branch("21");

        public static readonly DerObjectIdentifier id_dh_sig_hmac_sha1 =
            X509ObjectIdentifiers.pkix_algorithms.Branch("3");
        public static readonly DerObjectIdentifier id_alg_dh_pop =
            X509ObjectIdentifiers.pkix_algorithms.Branch("4");
    }
}
