...
namespace Org.BouncyCastle.Asn1.Crmf
{
    public class OptionalValidity : Asn1Encodable
    {
        ...
        public static OptionalValidity GetInstance(
        ...
        public static OptionalValidity GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private OptionalValidity(Asn1Sequence seq)
        {
            ...
            m_notBefore = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_notAfter = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
