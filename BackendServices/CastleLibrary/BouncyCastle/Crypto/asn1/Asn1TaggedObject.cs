...
namespace Org.BouncyCastle.Asn1
{
    ...
    public abstract class Asn1TaggedObject : Asn1Object, Asn1TaggedObjectParser
    {
        ...
        public static Asn1TaggedObject GetInstance(object obj)
        {
            ...
            throw new ArgumentException(
                "illegal object in GetInstance: " + Platform.GetTypeName(obj),
                nameof(obj)
            );
        }
        ...
        {
            return Asn1Utilities.GetExplicitContextBaseTagged(
                CheckInstance(taggedObject, declaredExplicit)
            );
        }
        ...
        {
            return Asn1Utilities.GetExplicitBaseTagged(
                CheckInstance(taggedObject, declaredExplicit),
                tagClass
            );
        }
        ...
        public static Asn1TaggedObject GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        )
        {
            if (!declaredExplicit)
                throw new ArgumentException(
                    "this method not valid for implicitly tagged tagged objects"
                );
        ...
        {
            return (m_tagClass * 7919)
                ^ m_tagNo
                ^ (IsExplicit() ? 0x0F : 0xF0)
                ^ m_object.ToAsn1Object().CallAsn1GetHashCode();
        }
        ...
        {
            if (
                Asn1Tags.Universal == baseTagClass
                || (baseTagClass & Asn1Tags.Private) != baseTagClass
            )
                throw new ArgumentException(
                    "invalid base tag class: " + baseTagClass,
                    nameof(baseTagClass)
                );
        ...
        {
            Asn1UniversalType universalType =
                Asn1UniversalTypes.Get(tagNo)
                ?? throw new ArgumentException(
                    "unsupported UNIVERSAL tag number: " + tagNo,
                    nameof(tagNo)
                );
        ...
        )
        {
            ...
            return maybeExplicit
                ...
                : new DLTaggedObject(
                    ...
                    tagClass,
                    tagNo,
                    DLSequence.FromVector(contentsElements)
                );
        }
        ...
        )
        {
            ...
            return maybeExplicit
                ...
                : new BerTaggedObject(
                    ...
                    tagClass,
                    tagNo,
                    BerSequence.FromVector(contentsElements)
                );
        }
        ...
        internal static Asn1Object CreatePrimitive(int tagClass, int tagNo, byte[] contentsOctets)
        {
            ...
            return new DLTaggedObject(
                ParsedImplicit,
                tagClass,
                tagNo,
                DerOctetString.WithContents(contentsOctets)
            );
        }
        ...
        private static Asn1TaggedObject CheckedCast(Asn1Object asn1Object)
        {
            ...
            throw new InvalidOperationException(
                "unexpected object: " + Platform.GetTypeName(asn1Object)
            );
        }
    }
}
