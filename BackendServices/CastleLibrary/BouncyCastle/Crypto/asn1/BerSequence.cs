...
namespace Org.BouncyCastle.Asn1
{
    public class BerSequence : DLSequence
    {
        ...
        public static new BerSequence FromElement(Asn1Encodable element) =>
            new BerSequence(element);

        public static new BerSequence FromElements(
            Asn1Encodable element1,
        ...
        public static new BerSequence Map(
            Asn1Sequence sequence,
            Func<Asn1Encodable, Asn1Encodable> func
        )
        {
            return sequence.Count < 1
                ? Empty
                : new BerSequence(sequence.MapElements(func), clone: false);
        }
        ...
        public static new BerSequence Map<T>(T[] ts, Func<T, Asn1Encodable> func)
        {
            return ts.Length < 1
                ? Empty
                : new BerSequence(CollectionUtilities.Map(ts, func), clone: false);
        }
        ...
        public static new BerSequence Map<T>(IReadOnlyCollection<T> c, Func<T, Asn1Encodable> func)
        {
            return c.Count < 1
                ? Empty
                : new BerSequence(CollectionUtilities.Map(c, func), clone: false);
        }
        ...
        internal override IAsn1Encoding GetEncoding(int encoding)
        {
            ...
            return new ConstructedILEncoding(
                Asn1Tags.Universal,
                Asn1Tags.Sequence,
        ...
        internal override DerBitString ToAsn1BitString() =>
            new BerBitString(GetConstructedBitStrings());
        ...
        internal override Asn1OctetString ToAsn1OctetString() =>
            new BerOctetString(GetConstructedOctetStrings());
