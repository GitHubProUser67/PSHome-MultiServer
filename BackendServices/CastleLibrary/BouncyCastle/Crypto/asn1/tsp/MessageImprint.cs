...
namespace Org.BouncyCastle.Asn1.Tsp
{
    public class MessageImprint : Asn1Encodable
    {
        ...
        public static MessageImprint GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public MessageImprint(AlgorithmIdentifier hashAlgorithm, Asn1OctetString hashedMessage)
        {
            ...
            m_hashedMessage =
                hashedMessage ?? throw new ArgumentNullException(nameof(hashedMessage));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_hashAlgorithm, m_hashedMessage);
    }
}
