...
namespace Org.BouncyCastle.Asn1.Tsp
{
    ...
    public class EvidenceRecord : Asn1Encodable
    {
         ...
         */
        private static readonly DerObjectIdentifier Oid = new DerObjectIdentifier(
        ...
        public static EvidenceRecord GetInstance(
        ...
        public static EvidenceRecord GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        )
        {
            ...
            m_archiveTimeStampSequence = new ArchiveTimeStampSequence(
                new ArchiveTimeStampChain(archiveTimeStamp)
            );
        }
        ...
        private EvidenceRecord(Asn1Sequence seq)
        {
            ...
            m_cryptoInfos = Asn1Utilities.ReadContextTagged(
                seq,
                ref pos,
                0,
                false,
                CryptoInfos.GetTagged
            );
            m_encryptionInfo = Asn1Utilities.ReadContextTagged(
                seq,
                ref pos,
                1,
                false,
                EncryptionInfo.GetTagged
            );
        ...
        public virtual ArchiveTimeStampSequence ArchiveTimeStampSequence =>
            m_archiveTimeStampSequence;
        ...
        public virtual EvidenceRecord AddArchiveTimeStamp(ArchiveTimeStamp ats, bool newChain)
        {
            ...
            {
                ArchiveTimeStampChain[] chains =
                    m_archiveTimeStampSequence.GetArchiveTimeStampChains();

                AlgorithmIdentifier digAlg = chains[chains.Length - 1]
                    .GetArchiveTimestamps()[0]
                    .GetDigestAlgorithmIdentifier();
                if (!digAlg.Equals(ats.GetDigestAlgorithmIdentifier()))
                    throw new ArgumentException(
                        "mismatch of digest algorithm in AddArchiveTimeStamp"
                    );
