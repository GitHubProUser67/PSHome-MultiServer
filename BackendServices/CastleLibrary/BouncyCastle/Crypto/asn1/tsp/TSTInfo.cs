...
namespace Org.BouncyCastle.Asn1.Tsp
{
    public class TstInfo : Asn1Encodable
    {
        ...
        private TstInfo(Asn1Sequence seq)
        {
            ...
            m_ordering =
                Asn1Utilities.ReadOptional(seq, ref pos, DerBoolean.GetOptional)
                ?? DerBoolean.False;
            m_nonce = Asn1Utilities.ReadOptional(seq, ref pos, DerInteger.GetOptional);
            m_tsa = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                GeneralName.GetTagged
            ); // CHOICE
        ...
        )
        {
            ...
            m_messageImprint =
                messageImprint ?? throw new ArgumentNullException(nameof(messageImprint));
