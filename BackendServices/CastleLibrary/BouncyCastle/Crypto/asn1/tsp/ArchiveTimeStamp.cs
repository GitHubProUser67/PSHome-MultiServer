...
namespace Org.BouncyCastle.Asn1.Tsp
{
    ...
    public class ArchiveTimeStamp : Asn1Encodable
    {
        ...
        public static ArchiveTimeStamp GetInstance(
        ...
        public static ArchiveTimeStamp GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private ArchiveTimeStamp(Asn1Sequence seq)
        {
            ...
            m_digestAlgorithm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_attributes = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
                Attributes.GetTagged
            );
            m_reducedHashTree = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
        ...
        public virtual AlgorithmIdentifier GetDigestAlgorithmIdentifier() =>
            m_digestAlgorithm ?? GetTimeStampInfo().MessageImprint.HashAlgorithm;

        public virtual byte[] GetTimeStampDigestValue() =>
            GetTimeStampInfo().MessageImprint.GetHashedMessage();

        private TstInfo GetTimeStampInfo()
        {
            if (!CmsObjectIdentifiers.SignedData.Equals(m_timeStamp.ContentType))
                throw new InvalidOperationException(
                    "cannot identify algorithm identifier for digest"
                );
            ...
            return TstInfo.GetInstance(
                Asn1OctetString.GetInstance(contentInfo.Content).GetOctets()
            );
        }
