...
namespace Org.BouncyCastle.Asn1.Tsp
{
    ...
    public class EncryptionInfo : Asn1Encodable
    {
        ...
        public static EncryptionInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public EncryptionInfo(
            DerObjectIdentifier encryptionInfoType,
            Asn1Encodable encryptionInfoValue
        )
        {
            m_encryptionInfoType =
                encryptionInfoType ?? throw new ArgumentNullException(nameof(encryptionInfoType));
            m_encryptionInfoValue =
                encryptionInfoValue ?? throw new ArgumentNullException(nameof(encryptionInfoValue));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DLSequence(m_encryptionInfoType, m_encryptionInfoValue);
    }
}
