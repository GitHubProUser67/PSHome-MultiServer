...
namespace Org.BouncyCastle.Asn1
{
    public class DerVideotexString : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerVideotexString), Asn1Tags.VideotexString) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct videotex string from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static DerVideotexString GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
