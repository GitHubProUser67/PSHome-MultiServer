...
{
    public abstract class Asn1Sequence : Asn1Object, IReadOnlyCollection<Asn1Encodable>
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1Sequence), Asn1Tags.Sequence) { }
        ...
        public static Asn1Sequence GetInstance(object obj)
        {
            ...
            {
                if (
                    !(obj is Asn1Object) && asn1Convertible.ToAsn1Object() is Asn1Sequence converted
                )
                    return converted;
            }
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct sequence from byte[]: " + e.Message
                    );
                }
            }
        ...
        private class Asn1SequenceParserImpl : Asn1SequenceParser
        {
        ...
        public virtual T[] MapElements<T>(Func<Asn1Encodable, T> func) =>
            CollectionUtilities.Map(m_elements, func);
        ...
        internal Asn1OctetString[] GetConstructedOctetStrings() =>
            MapElements(Asn1OctetString.GetInstance);
