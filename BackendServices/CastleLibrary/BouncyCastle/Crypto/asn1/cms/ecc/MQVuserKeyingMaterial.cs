...
namespace Org.BouncyCastle.Asn1.Cms.Ecc
{
    public class MQVuserKeyingMaterial : Asn1Encodable
    {
        ...
        public static MQVuserKeyingMaterial GetTagged(
        ...
        )
        {
            m_ephemeralPublicKey =
                ephemeralPublicKey ?? throw new ArgumentNullException(nameof(ephemeralPublicKey));
            m_addedukm = addedukm;
        }
        ...
        private MQVuserKeyingMaterial(Asn1Sequence seq)
        {
            ...
            m_addedukm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
