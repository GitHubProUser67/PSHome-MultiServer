...
namespace Org.BouncyCastle.Asn1.Cms
{
    public class EnvelopedData : Asn1Encodable
    {
        ...
        public static EnvelopedData GetTagged(
        ...
        public EnvelopedData(
            ...
            : this(
                ...
                recipientInfos,
                encryptedContentInfo,
                Asn1Set.GetInstance(unprotectedAttrs)
            ) { }
        ...
        private EnvelopedData(Asn1Sequence seq)
        {
            ...
            m_unprotectedAttrs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
