...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static KeyAgreeRecipientInfo GetTagged(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        )
        {
            ...
            m_recipientEncryptedKeys =
                ...
                ?? throw new ArgumentNullException(nameof(recipientEncryptedKeys));
        }
        ...
        public KeyAgreeRecipientInfo(Asn1Sequence seq)
        {
            ...
            m_originator = Asn1Utilities.ReadContextTagged(
                seq,
                ref pos,
                0,
                true,
                OriginatorIdentifierOrKey.GetTagged
            );
            m_ukm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
