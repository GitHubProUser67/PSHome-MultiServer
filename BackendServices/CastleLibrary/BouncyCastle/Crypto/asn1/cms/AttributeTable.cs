...
{
    public class AttributeTable : IReadOnlyCollection<Attribute>
    {
        ...
        */
        ...
        public IDictionary<DerObjectIdentifier, object> ToDictionary() =>
            BuildAttributes(m_attributes, out var ignore);

        public Asn1EncodableVector ToAsn1EncodableVector() =>
            Asn1EncodableVector.FromCollection(this);
        ...
        private static void AddAttribute(
            Dictionary<DerObjectIdentifier, object> attributes,
            Attribute a
        )
        {
        ...
        private static Dictionary<DerObjectIdentifier, object> BuildAttributes(
            IDictionary<DerObjectIdentifier, object> d,
            out int count
        )
        {
        ...
        private static Dictionary<DerObjectIdentifier, object> BuildAttributes(
            IReadOnlyCollection<Asn1Encodable> c,
            out int count
        )
        {
            count = c.Count;
        ...
        private static int CountAttributesOfType(
            Dictionary<DerObjectIdentifier, object> attributes,
        ...
        private static IEnumerable<Attribute> EnumerateAttributes(
            Dictionary<DerObjectIdentifier, object> attributes
        )
        {
    ...
    public static class AttributeTableExtensions
    {
        public static AttributeTable ToAttributeTable(this Asn1EncodableVector v) =>
            new AttributeTable(v);

        public static AttributeTable ToAttributeTable(
            this IReadOnlyCollection<Attribute> attributes
