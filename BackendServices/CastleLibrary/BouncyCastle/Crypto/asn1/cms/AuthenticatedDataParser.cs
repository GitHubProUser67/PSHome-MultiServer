    ...
    public class AuthenticatedDataParser
    {
            ...
            if (nextObject is Asn1TaggedObjectParser o)
            {
                if (o.HasContextTag(0))
                {
                    Asn1SequenceParser originatorInfo = (Asn1SequenceParser)
                        o.ParseBaseUniversal(false, Asn1Tags.Sequence);
                    nextObject = null;
        ...
        public AlgorithmIdentifier GetDigestAlgorithm()
        {
            ...
            if (nextObject is Asn1TaggedObjectParser parser && parser.HasContextTag(1))
            {
                AlgorithmIdentifier obj = AlgorithmIdentifier.GetTagged(
                    (Asn1TaggedObject)nextObject.ToAsn1Object(),
                    false
                );
                nextObject = null;
                return obj;
        ...
        public Asn1SetParser GetAuthAttrs()
        {
            ...
            if (nextObject is Asn1TaggedObjectParser o)
            {
                ...
                return (Asn1SetParser)
                    Asn1Utilities.ParseContextBaseUniversal(o, 2, false, Asn1Tags.SetOf);
            }
        ...
        public Asn1SetParser GetUnauthAttrs()
        {
            ...
            if (nextObject != null)
            {
                ...
                nextObject = null;
                return (Asn1SetParser)
                    Asn1Utilities.ParseContextBaseUniversal(o, 3, false, Asn1Tags.SetOf);
            }
