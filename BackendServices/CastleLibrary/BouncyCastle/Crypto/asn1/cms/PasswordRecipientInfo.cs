...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static PasswordRecipientInfo GetTagged(
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public PasswordRecipientInfo(Asn1Sequence seq)
        {
            ...
            m_keyDerivationAlgorithm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
        ...
        public override Asn1Object ToAsn1Object()
        {
            ...
            return new DerSequence(
                m_version,
                new DerTaggedObject(false, 0, m_keyDerivationAlgorithm),
                m_keyEncryptionAlgorithm,
                m_encryptedKey
            );
        }
