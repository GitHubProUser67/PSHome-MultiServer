...
namespace Org.BouncyCastle.Asn1.Cms
{
    ...
    public sealed class KemRecipientInfo : Asn1Encodable
    {
        ...
        public static KemRecipientInfo GetInstance(
        ...
        public static KemRecipientInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private KemRecipientInfo(Asn1Sequence seq)
        {
            ...
            if (!m_cmsVersion.HasValue(0))
                throw new ArgumentException(
                    "Unsupported version (hex): " + m_cmsVersion.Value.ToString(16)
                );
        }
