...
namespace Org.BouncyCastle.Asn1.Cms
{
    ...
    public class SignerInfo : Asn1Encodable
    {
        ...
        private SignerInfo(Asn1Sequence seq)
        {
            ...
            m_signedAttrs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_unsignedAttrs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
        ...
        public SignerInfo(
            ...
            : this(
                sid,
                digAlgorithm,
                authenticatedAttributes?.AttributeSet,
                digEncryptionAlgorithm,
                encryptedDigest,
                unauthenticatedAttributes?.AttributeSet
            ) { }
