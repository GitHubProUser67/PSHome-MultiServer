...
namespace Org.BouncyCastle.Asn1.Cms
{
    public class AuthenticatedData : Asn1Encodable
    {
        ...
        public static AuthenticatedData GetTagged(
        ...
        )
        {
            ...
            m_recipientInfos =
                recipientInfos ?? throw new ArgumentNullException(nameof(recipientInfos));
            m_encapsulatedContentInfo =
                encapsulatedContent ?? throw new ArgumentNullException(nameof(encapsulatedContent));
        ...
        private AuthenticatedData(Asn1Sequence seq)
        {
            ...
            m_originatorInfo = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
                OriginatorInfo.GetTagged
            );
            ...
            m_authAttrs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
            ...
            m_unauthAttrs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                false,
        ...
        public static int CalculateVersion(OriginatorInfo origInfo) =>
            CalculateVersionField(origInfo).IntValueExact;
