...
namespace Org.BouncyCastle.Asn1.Cms
{
    public class TimeStampTokenEvidence : Asn1Encodable
    {
        ...
        public static TimeStampTokenEvidence GetInstance(
            Asn1TaggedObject tagged,
            bool isExplicit
        ) => new TimeStampTokenEvidence(Asn1Sequence.GetInstance(tagged, isExplicit));

        public static TimeStampTokenEvidence GetTagged(
        ...
        public TimeStampTokenEvidence(TimeStampAndCrl[] timeStampAndCrls)
        {
            if (Arrays.IsNullOrContainsNull(timeStampAndCrls))
                throw new NullReferenceException(
                    "'timeStampAndCrls' cannot be null, or contain null"
                );
        ...
        public virtual TimeStampAndCrl[] ToTimeStampAndCrlArray() =>
            (TimeStampAndCrl[])m_timeStampAndCrls.Clone();
