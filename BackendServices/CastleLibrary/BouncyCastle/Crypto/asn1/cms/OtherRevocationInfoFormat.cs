...
namespace Org.BouncyCastle.Asn1.Cms
{
    public class OtherRevocationInfoFormat : Asn1Encodable
    {
        ...
        public static OtherRevocationInfoFormat GetTagged(
        ...
        {
            m_otherRevInfoFormat =
                otherRevInfoFormat ?? throw new ArgumentNullException(nameof(otherRevInfoFormat));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_otherRevInfoFormat, m_otherRevInfo);
    }
}
