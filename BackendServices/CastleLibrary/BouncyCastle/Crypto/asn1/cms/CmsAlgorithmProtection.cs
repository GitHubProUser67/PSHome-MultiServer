...
namespace Org.BouncyCastle.Asn1.Cms
{
    ...
    public class CmsAlgorithmProtection : Asn1Encodable
    {
        ...
        public static CmsAlgorithmProtection GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_digestAlgorithm =
                digestAlgorithm ?? throw new ArgumentNullException(nameof(digestAlgorithm));
        ...
        private CmsAlgorithmProtection(Asn1Sequence seq)
        {
            ...
            m_signatureAlgorithm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_macAlgorithm = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
