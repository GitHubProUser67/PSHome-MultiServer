...
namespace Org.BouncyCastle.Asn1.Cms
{
    public class TimeStampedData : Asn1Encodable
    {
        ...
        public static TimeStampedData GetInstance(
        ...
        public static TimeStampedData GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        )
        {
            ...
            m_content = content;
            m_temporalEvidence =
                temporalEvidence ?? throw new ArgumentNullException(nameof(temporalEvidence));
        }
