...
namespace Org.BouncyCastle.Asn1.Cms
{
    ...
    public class SignedData : Asn1Encodable
    {
        ...
        {
            m_digestAlgorithms =
                digestAlgorithms ?? throw new ArgumentNullException(nameof(digestAlgorithms));
            m_encapContentInfo =
                contentInfo ?? throw new ArgumentNullException(nameof(contentInfo));
            m_certificates = certificates;
            m_crls = crls;
            m_signerInfos = signerInfos ?? throw new ArgumentNullException(nameof(signerInfos));
            m_version = CalculateVersionField(
        ...
        public override Asn1Object ToAsn1Object()
        {
            ...
            if (
                !m_encapContentInfo.IsDefiniteLength
                || m_certsBer
                || m_crlsBer
                || m_digsBer
                || m_sigsBer
        ...
        private static Asn1Set ReadOptionalTaggedSet(
