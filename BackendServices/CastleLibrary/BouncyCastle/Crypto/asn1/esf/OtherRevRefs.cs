...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class OtherRevRefs : Asn1Encodable
    {
        ...
        public static OtherRevRefs GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_otherRevRefType =
                otherRevRefType ?? throw new ArgumentNullException(nameof(otherRevRefType));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_otherRevRefType, m_otherRevRefs);
    }
}
