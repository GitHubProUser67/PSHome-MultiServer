...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class OtherRevVals : Asn1Encodable
    {
        ...
        public static OtherRevVals GetTagged(
        ...
        {
            m_otherRevValType =
                otherRevValType ?? throw new ArgumentNullException(nameof(otherRevValType));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_otherRevValType, m_otherRevVals);
    }
}
