...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class SignaturePolicyId : Asn1Encodable
    {
        ...
        public static SignaturePolicyId GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_sigPolicyIdentifier =
                sigPolicyIdentifier ?? throw new ArgumentNullException(nameof(sigPolicyIdentifier));
            m_sigPolicyHash =
                sigPolicyHash ?? throw new ArgumentNullException(nameof(sigPolicyHash));
        ...
        )
        {
            ...
            {
                m_sigPolicyQualifiers = DerSequence.FromVector(
