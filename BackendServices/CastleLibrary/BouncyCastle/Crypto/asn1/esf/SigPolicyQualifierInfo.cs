...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class SigPolicyQualifierInfo : Asn1Encodable
    {
        ...
        public static SigPolicyQualifierInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_sigPolicyQualifierId =
                sigPolicyQualifierId
                ?? throw new ArgumentNullException(nameof(sigPolicyQualifierId));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_sigPolicyQualifierId, m_sigQualifier);
    }
}
