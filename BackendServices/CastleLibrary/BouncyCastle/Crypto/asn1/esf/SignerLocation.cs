...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    */
    public class SignerLocation : Asn1Encodable
    {
        ...
        public static SignerLocation GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public SignerLocation(Asn1Sequence seq)
        {
            ...
            m_countryName = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_localityName = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            if (m_postalAddress != null)
            {
                ...
                m_postalAddress.MapElements(element =>
                    DirectoryString.GetInstance(element.ToAsn1Object())
                );
            }
        ...
        public SignerLocation(
            ...
            : this(
                DirectoryString.GetInstance(countryName),
                DirectoryString.GetInstance(localityName),
                postalAddress
            ) { }
