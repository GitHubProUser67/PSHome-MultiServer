...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class RevocationValues : Asn1Encodable
    {
        ...
        public static RevocationValues GetTagged(
        ...
        private RevocationValues(Asn1Sequence seq)
        {
            ...
            m_crlVals = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_ocspVals = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_otherRevVals = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
                OtherRevVals.GetTagged
            );
        ...
        public RevocationValues(
            IReadOnlyCollection<CertificateList> crlVals,
            IReadOnlyCollection<BasicOcspResponse> ocspVals,
            OtherRevVals otherRevVals
        )
        {
            if (crlVals != null)
