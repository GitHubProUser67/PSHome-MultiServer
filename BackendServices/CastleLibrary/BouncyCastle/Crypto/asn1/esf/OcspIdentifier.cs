...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class OcspIdentifier : Asn1Encodable
    {
        ...
        public static OcspIdentifier GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_ocspResponderID =
                ocspResponderID ?? throw new ArgumentNullException(nameof(ocspResponderID));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_ocspResponderID, m_producedAt);
    }
}
