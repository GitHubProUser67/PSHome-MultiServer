...
namespace Org.BouncyCastle.Asn1.Esf
{
    public class SignerAttribute : Asn1Encodable
    {
        ...
        public static SignerAttribute GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            Asn1TaggedObject taggedObject = Asn1TaggedObject.GetInstance(
                seq[0],
        ...
        {
            m_claimedAttributes =
                claimedAttributes ?? throw new ArgumentNullException(nameof(claimedAttributes));
        }

        public SignerAttribute(AttributeCertificate certifiedAttributes)
        {
            m_certifiedAttributes =
                certifiedAttributes ?? throw new ArgumentNullException(nameof(certifiedAttributes));
        }
