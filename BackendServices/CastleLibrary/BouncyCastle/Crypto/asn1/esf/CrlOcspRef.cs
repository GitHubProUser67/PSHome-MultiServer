...
namespace Org.BouncyCastle.Asn1.Esf
{
    ...
    public class CrlOcspRef : Asn1Encodable
    {
        ...
        private CrlOcspRef(Asn1Sequence seq)
        {
            ...
            m_crlids = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_ocspids = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
                OcspListID.GetTagged
            );
            m_otherRev = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
                OtherRevRefs.GetTagged
            );
