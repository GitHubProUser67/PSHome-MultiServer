...
namespace Org.BouncyCastle.Asn1
{
     ...
     */
    public class Asn1EncodableVector : IReadOnlyCollection<Asn1Encodable>
    {
        ...
        public static Asn1EncodableVector FromElement(Asn1Encodable element) =>
            new Asn1EncodableVector(1) { element };
        ...
        private static IEnumerable<Asn1Encodable> EnumerateElements(
