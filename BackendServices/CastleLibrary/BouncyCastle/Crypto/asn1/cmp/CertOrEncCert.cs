...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class CertOrEncCert : Asn1Encodable, IAsn1Choice
    {
        ...
        public static CertOrEncCert GetInstance(
        ...
        public static CertOrEncCert GetOptional(Asn1Encodable element)
        {
            ...
            if (taggedObject != null)
            {
                if (taggedObject.HasContextTag(0))
                    return new CertOrEncCert(
                        CmpCertificate.GetInstance(taggedObject.GetExplicitBaseObject())
                    );

                if (taggedObject.HasContextTag(1))
                    return new CertOrEncCert(
                        EncryptedKey.GetInstance(taggedObject.GetExplicitBaseObject())
                    );
            }
        ...
        public static CertOrEncCert GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
