...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class PkiHeader : Asn1Encodable
    {
         ...
         */
        public static readonly GeneralName NULL_NAME = new GeneralName(
        ...
        private PkiHeader(Asn1Sequence seq)
        {
            ...
            m_messageTime = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                Asn1GeneralizedTime.GetTagged
            );
            m_protectionAlg = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_senderKID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
            ...
            m_recipKID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                true,
            ...
            m_transactionID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                4,
                true,
            ...
            m_senderNonce = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                5,
                true,
            ...
            m_recipNonce = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                6,
                true,
            ...
            m_freeText = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                7,
                true,
                PkiFreeText.GetTagged
            );
            m_generalInfo = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                8,
                true,
                Asn1Sequence.GetTagged
            );
        ...
        public virtual InfoTypeAndValue[] GetGeneralInfo() =>
            m_generalInfo?.MapElements(InfoTypeAndValue.GetInstance);
