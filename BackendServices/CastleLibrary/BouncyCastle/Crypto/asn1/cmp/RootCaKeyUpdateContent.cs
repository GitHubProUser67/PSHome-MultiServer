...
namespace Org.BouncyCastle.Asn1.Cmp
{
    ...
    public class RootCaKeyUpdateContent : Asn1Encodable
    {
        ...
        public static RootCaKeyUpdateContent GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private RootCaKeyUpdateContent(Asn1Sequence seq)
        {
            ...
            m_newWithOld = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_oldWithNew = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
