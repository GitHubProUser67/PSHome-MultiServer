...
namespace Org.BouncyCastle.Asn1.Cmp
{
    ...
    public class PbmParameter : Asn1Encodable
    {
        ...
        public static PbmParameter GetInstance(
        ...
        public static PbmParameter GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        )
        {
            ...
            m_iterationCount =
                iterationCount ?? throw new ArgumentNullException(nameof(iterationCount));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_salt, m_owf, m_iterationCount, m_mac);
    }
}
