...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class PkiMessage : Asn1Encodable
    {
        ...
        public static PkiMessage GetInstance(
        ...
        private PkiMessage(Asn1Sequence seq)
        {
            ...
            m_protection = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_extraCerts = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
        ...
        public virtual CmpCertificate[] GetExtraCerts() =>
            m_extraCerts?.MapElements(CmpCertificate.GetInstance);
