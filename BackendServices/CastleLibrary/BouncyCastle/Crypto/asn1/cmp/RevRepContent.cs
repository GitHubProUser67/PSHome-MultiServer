...
namespace Org.BouncyCastle.Asn1.Cmp
{
    ...
    public class RevRepContent : Asn1Encodable
    {
        ...
        public static RevRepContent GetInstance(
        ...
        public static RevRepContent GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private RevRepContent(Asn1Sequence seq)
        {
            ...
            m_revCerts = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
            ...
            m_crls = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
