...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class CertifiedKeyPair : Asn1Encodable
    {
        ...
        public static CertifiedKeyPair GetInstance(
        ...
        public static CertifiedKeyPair GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private CertifiedKeyPair(Asn1Sequence seq)
        {
            ...
            m_privateKey = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                EncryptedKey.GetTagged
            );
            m_publicationInfo = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
                PkiPublicationInfo.GetTagged
            );
        ...
        public CertifiedKeyPair(
            ...
            : this(
                certOrEncCert,
                privateKey == null ? null : new EncryptedKey(privateKey),
                publicationInfo
            ) { }
        ...
        {
            m_certOrEncCert =
                certOrEncCert ?? throw new ArgumentNullException(nameof(certOrEncCert));
