...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class KeyRecRepContent : Asn1Encodable
    {
        ...
        public static KeyRecRepContent GetInstance(
        ...
        public static KeyRecRepContent GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private KeyRecRepContent(Asn1Sequence seq)
        {
            ...
            m_newSigCert = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                CmpCertificate.GetTagged
            );
            m_caCerts = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_keyPairHist = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
        ...
        public virtual CmpCertificate[] GetCACerts() =>
            m_caCerts?.MapElements(CmpCertificate.GetInstance);

        public virtual CertifiedKeyPair[] GetKeyPairHist() =>
            m_keyPairHist?.MapElements(CertifiedKeyPair.GetInstance);
