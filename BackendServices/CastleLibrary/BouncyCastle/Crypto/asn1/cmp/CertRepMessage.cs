...
namespace Org.BouncyCastle.Asn1.Cmp
{
    public class CertRepMessage : Asn1Encodable
    {
        ...
        public static CertRepMessage GetInstance(
        ...
        public static CertRepMessage GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private CertRepMessage(Asn1Sequence seq)
        {
            ...
            m_caPubs = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
        ...
        public virtual CmpCertificate[] GetCAPubs() =>
            m_caPubs?.MapElements(CmpCertificate.GetInstance);

        public virtual CertResponse[] GetResponse() =>
            m_response.MapElements(CertResponse.GetInstance);
