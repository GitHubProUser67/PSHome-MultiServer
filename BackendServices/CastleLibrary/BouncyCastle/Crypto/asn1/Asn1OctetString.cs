...
namespace Org.BouncyCastle.Asn1
{
    public abstract class Asn1OctetString : Asn1Object, Asn1OctetStringParser
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1OctetString), Asn1Tags.OctetString) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct OCTET STRING from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static Asn1OctetString GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
        ...
        internal static Asn1OctetString CreatePrimitive(byte[] contents) =>
            DerOctetString.WithContents(contents);
    }
}
