...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerIA5String : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerIA5String), Asn1Tags.IA5String) { }
        ...
        public static DerIA5String GetInstance(object obj)
        {
            ...
            {
                if (
                    !(obj is Asn1Object) && asn1Convertible.ToAsn1Object() is DerIA5String converted
                )
                    return converted;
            }
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct IA5 string from byte[]: " + e.Message
                    );
                }
            }
