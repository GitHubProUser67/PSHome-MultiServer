...
{
    public class DerBitString : DerStringBase, Asn1BitStringParser
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerBitString), Asn1Tags.BitString) { }
        ...
        public static DerBitString GetInstance(object obj)
        {
            ...
            {
                if (
                    !(obj is Asn1Object) && asn1Convertible.ToAsn1Object() is DerBitString converted
                )
                    return converted;
            }
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct BIT STRING from byte[]: " + e.Message
                    );
                }
            }
        ...
        public virtual int IntValue
        {
            ...
            {
                int value = 0,
                    end = System.Math.Min(5, m_contents.Length - 1);
                for (int i = 1; i < end; ++i)
                {
        ...
        internal override IAsn1Encoding GetEncoding(int encoding)
        {
            ...
            if (padBits != 0)
            {
                ...
                if (lastBer != lastDer)
                    return new PrimitiveEncodingSuffixed(
                        Asn1Tags.Universal,
                        Asn1Tags.BitString,
                        m_contents,
                        lastDer
        ...
        internal sealed override DerEncoding GetEncodingDer()
        {
            ...
            if (padBits != 0)
            {
                ...
                if (lastBer != lastDer)
                    return new PrimitiveDerEncodingSuffixed(
                        Asn1Tags.Universal,
                        Asn1Tags.BitString,
                        m_contents,
                        lastDer
        ...
        protected override bool Asn1Equals(Asn1Object asn1Object)
        {
            ...
            byte[] thisContents = this.m_contents,
                thatContents = that.m_contents;
        ...
        private MemoryStream GetMemoryStream() =>
            new MemoryStream(m_contents, 1, m_contents.Length - 1, false);
        ...
        private void CheckOctetAligned()
        {
            if (m_contents[0] != 0x00)
                throw new IOException(
                    "expected octet-aligned bitstring, but found padBits: " + m_contents[0]
                );
        }
