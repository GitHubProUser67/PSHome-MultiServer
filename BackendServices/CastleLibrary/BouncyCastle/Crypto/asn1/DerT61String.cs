...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerT61String : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerT61String), Asn1Tags.T61String) { }
        ...
        public static DerT61String GetInstance(object obj)
        {
            ...
            {
                if (
                    !(obj is Asn1Object) && asn1Convertible.ToAsn1Object() is DerT61String converted
                )
                    return converted;
            }
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct T61 string from byte[]: " + e.Message
                    );
                }
            }
