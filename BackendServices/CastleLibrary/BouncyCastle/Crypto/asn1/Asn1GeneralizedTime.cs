...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class Asn1GeneralizedTime : Asn1Object
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1GeneralizedTime), Asn1Tags.GeneralizedTime) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct generalized time from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static Asn1GeneralizedTime GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
        ...
        {
            // TODO Performance
            return Arrays.GetHashCode(this.GetContents(Asn1OutputStream.EncodingDer));
        }
        ...
        private static string ToStringCanonical(DateTime dateTime)
        {
            return dateTime
                .ToUniversalTime()
                .ToString(@"yyyyMMddHHmmss.FFFFFFFK", DateTimeFormatInfo.InvariantInfo);
        }
    }
}
