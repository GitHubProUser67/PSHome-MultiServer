...
namespace Org.BouncyCastle.Asn1.X509
{
    public class GeneralNames : Asn1Encodable
    {
        ...
        {
            m_names = new GeneralName[] { name ?? throw new ArgumentNullException(nameof(name)) };
        }
        ...
        public override string ToString()
        {
            ...
            {
                buf.Append("    ").Append(name).AppendLine();
            }
            return buf.ToString();
        }
