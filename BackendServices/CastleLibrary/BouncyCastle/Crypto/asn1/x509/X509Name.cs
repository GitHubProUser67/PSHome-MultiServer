...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    */
    ...
    public class X509Name : Asn1Encodable, IAsn1Choice
    {
        /**
        ...
        */
        public static readonly DerObjectIdentifier SerialNumber = new DerObjectIdentifier(
            "2.5.4.5"
        );
        ...
        */
        ...
        public static readonly DerObjectIdentifier UniqueIdentifier = new DerObjectIdentifier(
            "2.5.4.45"
        );

        public static readonly DerObjectIdentifier Description = new DerObjectIdentifier(
            "2.5.4.13"
        );
        ...
        public static readonly DerObjectIdentifier DateOfBirth =
            X509ObjectIdentifiers.id_pda.Branch("1");

        /**
         * RFC 3039 PlaceOfBirth - DirectoryString(SIZE(1..128)
         */
        public static readonly DerObjectIdentifier PlaceOfBirth =
            X509ObjectIdentifiers.id_pda.Branch("2");

        /**
         * RFC 3039 DateOfBirth - PrintableString (SIZE(1)) -- "M", "F", "m" or "f"
         */
        public static readonly DerObjectIdentifier Gender = X509ObjectIdentifiers.id_pda.Branch(
            "3"
        );
        ...
        public static readonly DerObjectIdentifier CountryOfCitizenship =
            X509ObjectIdentifiers.id_pda.Branch("4");
        ...
        public static readonly DerObjectIdentifier CountryOfResidence =
            X509ObjectIdentifiers.id_pda.Branch("5");

        /**
         * ISIS-MTT NameAtBirth - DirectoryString(SIZE(1..64)
         */
        public static readonly DerObjectIdentifier NameAtBirth = new DerObjectIdentifier(
            "1.3.36.8.3.14"
        );
        ...
        */
        public static readonly DerObjectIdentifier UnstructuredName =
            PkcsObjectIdentifiers.Pkcs9AtUnstructuredName;
        ...
        * others...
        */
        public static readonly DerObjectIdentifier DC = new DerObjectIdentifier(
        ...
        */
        ...
        public static readonly DerObjectIdentifier UID = new DerObjectIdentifier(
         ...
         */
        public static readonly DerObjectIdentifier JurisdictionC = new DerObjectIdentifier(
         ...
         * CA/Browser Forum https://cabforum.org/uploads/CA-Browser-Forum-BR-v2.0.0.pdf, Table 78
         */
        public static readonly DerObjectIdentifier JurisdictionST = new DerObjectIdentifier(
         ...
         * CA/Browser Forum https://cabforum.org/uploads/CA-Browser-Forum-BR-v2.0.0.pdf, Table 78
         */
        public static readonly DerObjectIdentifier JurisdictionL = new DerObjectIdentifier(
            ...
            foreach (DerObjectIdentifier oid in ordering)
            {
                if (!attributes.TryGetValue(oid, out var attribute))
                    throw new ArgumentException(
                        "No attribute for object id - " + oid + " - passed to distinguished name"
                    );
        ...
        */
        ...
        )
        {
            ...
            if (
                DerObjectIdentifier.TryFromID(name, out var oid)
