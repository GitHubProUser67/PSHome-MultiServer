...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static AuthorityKeyIdentifier GetTagged(
...
#pragma warning disable CS0618 // Type or member is obsolete
            return new AuthorityKeyIdentifier(
                Asn1Sequence.GetTagged(taggedObject, declaredExplicit)
            );
#pragma warning restore CS0618 // Type or member is obsolete
        }
        ...
        protected internal AuthorityKeyIdentifier(Asn1Sequence seq)
        {
            ...
            m_keyIdentifier = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_authorityCertIssuer = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_authorityCertSerialNumber = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
        ...
        )
        {
            ...
            m_authorityCertSerialNumber =
                serialNumber == null ? null : new DerInteger(serialNumber);
        }
        ...
        {
            string keyID =
                m_keyIdentifier == null ? "null" : Hex.ToHexString(m_keyIdentifier.GetOctets());
