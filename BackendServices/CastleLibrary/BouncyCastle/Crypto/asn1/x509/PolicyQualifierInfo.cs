...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class PolicyQualifierInfo : Asn1Encodable
    {
        ...
        public static PolicyQualifierInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_policyQualifierId =
                policyQualifierId ?? throw new ArgumentNullException(nameof(policyQualifierId));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_policyQualifierId, m_qualifier);
    }
}
