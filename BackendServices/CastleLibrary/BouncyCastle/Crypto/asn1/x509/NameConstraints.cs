...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static NameConstraints GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public NameConstraints(Asn1Sequence seq)
        {
            ...
            m_permitted = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_excluded = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
        ...
        public NameConstraints(
            IReadOnlyCollection<GeneralSubtree> permitted,
        ...
        private static DerSequence CreateSequence(IList<GeneralSubtree> subtrees) =>
            subtrees == null
                ? null
                : DerSequence.FromVector(Asn1EncodableVector.FromEnumerable(subtrees));
