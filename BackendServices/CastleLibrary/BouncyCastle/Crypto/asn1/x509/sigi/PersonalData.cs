...
namespace Org.BouncyCastle.Asn1.X509.SigI
{
    ...
    */
    public class PersonalData : Asn1Encodable
    {
        ...
        public static PersonalData GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        */
        private PersonalData(Asn1Sequence seq)
        {
            ...
            m_nameDistinguisher = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_dateOfBirth = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_placeOfBirth = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
                DirectoryString.GetTagged
            ); //CHOICE
            m_gender = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                false,
                DerPrintableString.GetTagged
            );
            m_postalAddress = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                4,
                true,
        ...
        */
        ...
        )
        {
            ...
            m_nameDistinguisher =
                nameDistinguisher == null ? null : new DerInteger(nameDistinguisher);
