...
namespace Org.BouncyCastle.Asn1.X509
{
    public class AttCertValidityPeriod : Asn1Encodable
    {
        ...
        public static AttCertValidityPeriod GetTagged(
        ...
        {
            m_notBeforeTime =
                notBeforeTime ?? throw new ArgumentNullException(nameof(notBeforeTime));
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_notBeforeTime, m_notAfterTime);
    }
}
