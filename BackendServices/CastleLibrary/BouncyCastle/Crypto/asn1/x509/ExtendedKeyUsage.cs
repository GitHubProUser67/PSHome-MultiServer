...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class ExtendedKeyUsage : Asn1Encodable
    {
        ...
        public static ExtendedKeyUsage GetTagged(
        ...
        {
            return GetInstance(
                X509Extensions.GetExtensionParsedValue(extensions, X509Extensions.ExtendedKeyUsage)
            );
        }

        private readonly HashSet<DerObjectIdentifier> m_usageTable =
        ...
        public bool HasKeyPurposeId(KeyPurposeID keyPurposeId) =>
            m_usageTable.Contains(keyPurposeId);
        ...
        public IList<DerObjectIdentifier> GetAllUsages() =>
            new List<DerObjectIdentifier>(m_usageTable);

        public DerObjectIdentifier[] GetAllUsagesArray() =>
            m_seq.MapElements(DerObjectIdentifier.GetInstance);
