...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    */
    public class CertificatePair : Asn1Encodable
    {
        ...
        public static CertificatePair GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ) => new CertificatePair(Asn1Sequence.GetTagged(taggedObject, declaredExplicit));

        private X509CertificateStructure m_forward,
            m_reverse;
        ...
        */
        private CertificatePair(Asn1Sequence seq)
        {
            ...
            m_forward = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                X509CertificateStructure.GetTagged
            );
            m_reverse = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
