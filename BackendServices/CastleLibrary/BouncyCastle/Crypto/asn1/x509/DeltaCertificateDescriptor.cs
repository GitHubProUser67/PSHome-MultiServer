...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class DeltaCertificateDescriptor : Asn1Encodable
    {
        ...
        public static DeltaCertificateDescriptor GetInstance(
            ...
            new DeltaCertificateDescriptor(
                Asn1Sequence.GetInstance(taggedObject, declaredExplicit)
            );

        public static DeltaCertificateDescriptor GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            return GetInstance(
                X509Extensions.GetExtensionParsedValue(
                    extensions,
                    X509Extensions.DRAFT_DeltaCertificateDescriptor
                )
            );
        }
        ...
        private DeltaCertificateDescriptor(Asn1Sequence seq)
        {
            ...
            m_signature = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
        ...
        public DeltaCertificateDescriptor(
        ...
        )
        {
            ...
            m_validity = validity;
            m_subject = subject;
            m_subjectPublicKeyInfo =
                subjectPublicKeyInfo
                ?? throw new ArgumentNullException(nameof(subjectPublicKeyInfo));
            m_extensions = extensions;
            m_signatureValue =
                signatureValue ?? throw new ArgumentNullException(nameof(signatureValue));
        }
