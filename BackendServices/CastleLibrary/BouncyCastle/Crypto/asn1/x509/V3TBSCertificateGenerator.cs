...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class V3TbsCertificateGenerator
    {
        ...
        public void SetExtensions(X509Extensions extensions)
        {
            ...
            if (extensions != null)
            {
                X509Extension altName = extensions.GetExtension(
        ...
        public Asn1Sequence GeneratePreTbsCertificate()
        {
            if (signature != null)
                throw new InvalidOperationException(
                    "signature field should not be set in PreTBSCertificate"
                );
        ...
        public TbsCertificateStructure GenerateTbsCertificate()
        {
            ...
            return new TbsCertificateStructure(
                version: DerInteger.Two,
                serialNumber,
                signature,
                issuer,
                validity ?? new Validity(startDate, endDate),
                subject ?? X509Name.GetInstance(DerSequence.Empty),
