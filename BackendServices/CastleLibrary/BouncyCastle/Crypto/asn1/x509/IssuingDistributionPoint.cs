...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class IssuingDistributionPoint : Asn1Encodable
    {
        ...
        public static IssuingDistributionPoint GetTagged(
        ...
        {
            int count =
                Convert.ToInt32(onlyContainsUserCerts)
                + Convert.ToInt32(onlyContainsCACerts)
        ...
        private IssuingDistributionPoint(Asn1Sequence seq)
        {
            ...
            m_distributionPoint = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                DistributionPointName.GetTagged
            ); // CHOICE
            m_onlyContainsUserCerts =
                Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    1,
                    false,
                    DerBoolean.GetTagged
                ) ?? DerBoolean.False;
            m_onlyContainsCACerts =
                Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    2,
            ...
            m_onlySomeReasons = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                3,
                false,
        ...
        public override string ToString()
        {
            ...
            if (m_onlyContainsAttributeCerts.IsTrue)
            {
                AppendObject(
                    ...
                    m_onlyContainsAttributeCerts.ToString()
                );
            }
