        ...
        )
        {
            ...
            if (reason != 0)
            {
                ...
                try
                {
                    ...
                    extValues.Add(
                        new X509Extension(false, new DerOctetString(crlReason.GetEncoded()))
                    );
                }
                catch (IOException e)
                {
            ...
            if (invalidityDate != null)
            {
                try
                {
                    ...
                    extValues.Add(
                        new X509Extension(false, new DerOctetString(invalidityDate.GetEncoded()))
                    );
                }
                catch (IOException e)
                {
        ...
        public Asn1Sequence GeneratePreTbsCertList()
        {
            if (signature != null)
                throw new InvalidOperationException(
                    "signature should not be set in PreTBSCertList generator"
                );

            if ((issuer == null) || (thisUpdate == null))
                throw new InvalidOperationException(
                    "Not all mandatory fields set in V2 PreTBSCertList generator"
                );
