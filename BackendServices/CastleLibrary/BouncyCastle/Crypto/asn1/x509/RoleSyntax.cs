    ...
    public class RoleSyntax : Asn1Encodable
    {
        ...
        */
        private RoleSyntax(Asn1Sequence seq)
        {
            ...
            m_roleAuthority = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
            ...
            m_roleName = Asn1Utilities.ReadContextTagged(
                seq,
                ref pos,
                1,
                true,
        ...
        public RoleSyntax(GeneralNames roleAuthority, GeneralName roleName)
        {
            ...
            )
            {
                throw new ArgumentException(
                    "the role name MUST be non empty and MUST "
        ...
        */
        ...
        public override string ToString()
        {
            StringBuilder buff = new StringBuilder(
                "Name: " + this.GetRoleNameAsString() + " - Auth: "
            );
