...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class TbsCertificateStructure : Asn1Encodable
    {
        ...
        public static TbsCertificateStructure GetTagged(
        ...
        private TbsCertificateStructure(Asn1Sequence seq)
        {
            ...
            m_version =
                Asn1Utilities.ReadOptionalContextTagged(seq, ref pos, 0, true, DerInteger.GetTagged)
                ?? DerInteger.Zero;
            ...
            if (!isV1)
            {
                m_issuerUniqueID = Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    1,
                    false,
                ...
                m_subjectUniqueID = Asn1Utilities.ReadOptionalContextTagged(
                    seq,
                    ref pos,
                    2,
                    false,
        ...
        public override Asn1Object ToAsn1Object()
        {
            if (m_seq != null)
            {
                string property = Platform.GetEnvironmentVariable(
