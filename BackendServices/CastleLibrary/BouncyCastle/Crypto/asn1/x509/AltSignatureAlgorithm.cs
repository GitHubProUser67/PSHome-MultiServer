...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class AltSignatureAlgorithm : Asn1Encodable
    {
        ...
        public static AltSignatureAlgorithm GetInstance(
            ...
            new AltSignatureAlgorithm(
                AlgorithmIdentifier.GetInstance(taggedObject, declaredExplicit)
            );

        public static AltSignatureAlgorithm GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ) =>
            new AltSignatureAlgorithm(
                AlgorithmIdentifier.GetTagged(taggedObject, declaredExplicit)
            );
