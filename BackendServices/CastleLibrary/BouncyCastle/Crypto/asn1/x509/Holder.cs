...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class Holder : Asn1Encodable
    {
        ...
        private Holder(Asn1Sequence seq)
        {
            ...
            m_baseCertificateID = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                false,
                IssuerSerial.GetTagged
            );
            m_entityName = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                false,
            ...
            m_objectDigestInfo = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                false,
                ObjectDigestInfo.GetTagged
            );
