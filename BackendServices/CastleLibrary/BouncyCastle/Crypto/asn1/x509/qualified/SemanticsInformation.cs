...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static SemanticsInformation GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public SemanticsInformation(Asn1Sequence seq)
        {
            ...
            m_semanticsIdentifier = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                DerObjectIdentifier.GetOptional
            );
            m_nameRegistrationAuthorities = Asn1Utilities
                .ReadOptional(seq, ref pos, Asn1Sequence.GetOptional)
