...
namespace Org.BouncyCastle.Asn1.X509.Qualified
{
    ...
    */
    public class BiometricData : Asn1Encodable
    {
        ...
        public static BiometricData GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        {
            m_typeOfBiometricData =
                typeOfBiometricData ?? throw new ArgumentNullException(nameof(typeOfBiometricData));
            m_hashAlgorithm =
                hashAlgorithm ?? throw new ArgumentNullException(nameof(hashAlgorithm));
            m_biometricDataHash =
                biometricDataHash ?? throw new ArgumentNullException(nameof(biometricDataHash));
