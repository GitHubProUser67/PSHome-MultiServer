...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class SubjectAltPublicKeyInfo : Asn1Encodable
    {
        ...
        public static SubjectAltPublicKeyInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public static SubjectAltPublicKeyInfo FromExtensions(X509Extensions extensions)
        {
            return GetInstance(
                X509Extensions.GetExtensionParsedValue(
                    extensions,
                    X509Extensions.SubjectAltPublicKeyInfo
                )
            );
        }
        ...
        public SubjectAltPublicKeyInfo(
            AlgorithmIdentifier algorithm,
            DerBitString subjectAltPublicKey
        )
        {
            m_algorithm = algorithm ?? throw new ArgumentNullException(nameof(algorithm));
            m_subjectAltPublicKey =
                subjectAltPublicKey ?? throw new ArgumentNullException(nameof(subjectAltPublicKey));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_algorithm, m_subjectAltPublicKey);
    }
}
