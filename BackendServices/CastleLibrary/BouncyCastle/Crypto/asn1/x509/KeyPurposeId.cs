...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public sealed class KeyPurposeID : DerObjectIdentifier
    {
        ...
        public static readonly KeyPurposeID AnyExtendedKeyUsage = new KeyPurposeID(
            X509Extensions.ExtendedKeyUsage.Id + ".0"
        );
        ...
        public static readonly KeyPurposeID id_kp_sbgpCertAAServerAuth = new KeyPurposeID(
            id_kp + ".11"
        );
        ...
        //
        public static readonly KeyPurposeID id_kp_smartcardlogon = new KeyPurposeID(
        ...
        public static readonly KeyPurposeID id_kp_msSGC = new KeyPurposeID(
        ...
        public static readonly KeyPurposeID id_pkinit_DHKeyData = new KeyPurposeID(
            id_pkinit + ".2"
        );
        public static readonly KeyPurposeID id_pkinit_rkeyData = new KeyPurposeID(id_pkinit + ".3");
        public static readonly KeyPurposeID keyPurposeClientAuth = new KeyPurposeID(
            id_pkinit + ".4"
        );
