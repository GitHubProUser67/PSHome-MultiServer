...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public CrlEntry(Asn1Sequence seq)
        {
            ...
            m_crlEntryExtensions = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                X509Extensions.GetOptional
            );
    ...
    {
        private class RevokedCertificatesEnumeration : IEnumerable<CrlEntry>
        {
            ...
            public IEnumerator<CrlEntry> GetEnumerator() =>
                new RevokedCertificatesEnumerator(m_en.GetEnumerator());

            private sealed class RevokedCertificatesEnumerator : IEnumerator<CrlEntry>
            {
        ...
        public static TbsCertificateList GetTagged(
        ...
        private TbsCertificateList(Asn1Sequence seq)
        {
            ...
            m_version =
                Asn1Utilities.ReadOptional(seq, ref pos, DerInteger.GetOptional) ?? DerInteger.Zero;
            ...
            m_revokedCertificates = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                Asn1Sequence.GetOptional
            );
            m_crlExtensions = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
