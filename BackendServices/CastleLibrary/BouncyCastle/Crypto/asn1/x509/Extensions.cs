...
namespace Org.BouncyCastle.Asn1.X509
{
     ...
     * </pre>
     */
    public sealed class Extensions : Asn1Encodable
    {
        ...
        private readonly Dictionary<DerObjectIdentifier, Extension> m_extensions =
            new Dictionary<DerObjectIdentifier, Extension>();
        ...
        public Extensions(Extension[] extensions)
        {
            if (Arrays.IsNullOrEmpty(extensions))
                throw new ArgumentException(
                    "extension array cannot be null or empty",
                    nameof(extensions)
                );
