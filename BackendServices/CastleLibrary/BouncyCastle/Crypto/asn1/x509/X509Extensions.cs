...
namespace Org.BouncyCastle.Asn1.X509
{
    public class X509Extensions : Asn1Encodable
    {
        ...
        public static readonly DerObjectIdentifier AuthorityInfoAccess =
            X509ObjectIdentifiers.IdPE.Branch("1");

        /**
         * BiometricInfo
         */
        public static readonly DerObjectIdentifier BiometricInfo =
            X509ObjectIdentifiers.IdPE.Branch("2");

        /**
         * QCStatements
         */
        public static readonly DerObjectIdentifier QCStatements = X509ObjectIdentifiers.IdPE.Branch(
            "3"
        );
        ...
        public static readonly DerObjectIdentifier AuditIdentity =
            X509ObjectIdentifiers.IdPE.Branch("4");

        /**
         * Subject Info Access
         */
        public static readonly DerObjectIdentifier SubjectInfoAccess =
            X509ObjectIdentifiers.IdPE.Branch("11");

        /**
         * Logo Type
         */
        public static readonly DerObjectIdentifier LogoType = X509ObjectIdentifiers.IdPE.Branch(
            "12"
        );
         ...
         */
        public static readonly DerObjectIdentifier AltSignatureAlgorithm = new DerObjectIdentifier(
            "2.5.29.73"
        );
         ...
         */
        public static readonly DerObjectIdentifier AltSignatureValue = new DerObjectIdentifier(
            "2.5.29.74"
        );
        ...
        public static Asn1Object GetExtensionParsedValue(
            X509Extensions extensions,
            DerObjectIdentifier oid
        ) => extensions?.GetExtensionParsedValue(oid);

        public static Asn1OctetString GetExtensionValue(
            X509Extensions extensions,
            DerObjectIdentifier oid
        ...
        public static X509Extensions GetInstance(object obj)
        {
            ...
            if (obj is Asn1TaggedObject taggedObject)
                return GetInstance(
                    Asn1Utilities.CheckContextTagClass(taggedObject).GetBaseObject().ToAsn1Object()
                );

            throw new ArgumentException(
                "unknown object in factory: " + Platform.GetTypeName(obj),
                nameof(obj)
            );
        }
        ...
        public static X509Extensions GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public IEnumerable<DerObjectIdentifier> ExtensionOids =>
            CollectionUtilities.Proxy(m_ordering);
