...
namespace Org.BouncyCastle.Asn1.X509
{
    ...
    public class PolicyMappings : Asn1Encodable
    {
        public class Element : Asn1Encodable
        {
            ...
            {
                m_issuerDomainPolicy =
                    issuerDomainPolicy
                    ?? throw new ArgumentNullException(nameof(issuerDomainPolicy));
                m_subjectDomainPolicy =
                    subjectDomainPolicy
                    ?? throw new ArgumentNullException(nameof(subjectDomainPolicy));
            }
            ...
            public override Asn1Object ToAsn1Object() =>
                new DLSequence(m_issuerDomainPolicy, m_subjectDomainPolicy);
        }
