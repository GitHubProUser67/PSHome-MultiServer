...
namespace Org.BouncyCastle.Asn1.Nist
{
    ...
    public sealed class NistObjectIdentifiers
    {
        ...
        public static readonly DerObjectIdentifier NistAlgorithm = new DerObjectIdentifier(
            "2.16.840.1.101.3.4"
        );
        ...
        public static readonly DerObjectIdentifier IdRsassaPkcs1V15WithSha3_224 = SigAlgs.Branch(
            "13"
        );

        /// <summary> 2.16.840.1.101.3.4.3.14 </summary>
        public static readonly DerObjectIdentifier IdRsassaPkcs1V15WithSha3_256 = SigAlgs.Branch(
            "14"
        );

        /// <summary> 2.16.840.1.101.3.4.3.15 </summary>
        public static readonly DerObjectIdentifier IdRsassaPkcs1V15WithSha3_384 = SigAlgs.Branch(
            "15"
        );

        /// <summary> 2.16.840.1.101.3.4.3.16 </summary>
        public static readonly DerObjectIdentifier IdRsassaPkcs1V15WithSha3_512 = SigAlgs.Branch(
            "16"
        );
        ...
        public static readonly DerObjectIdentifier id_hash_ml_dsa_44_with_sha512 = SigAlgs.Branch(
            "32"
        );

        /** 2.16.840.1.101.3.4.3.33 */
        public static readonly DerObjectIdentifier id_hash_ml_dsa_65_with_sha512 = SigAlgs.Branch(
            "33"
        );

        /** 2.16.840.1.101.3.4.3.34 */
        public static readonly DerObjectIdentifier id_hash_ml_dsa_87_with_sha512 = SigAlgs.Branch(
            "34"
        );
        ...
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_128s_with_sha256 =
            SigAlgs.Branch("35");

        /** 2.16.840.1.101.3.4.3.36 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_128f_with_sha256 =
            SigAlgs.Branch("36");

        /** 2.16.840.1.101.3.4.3.37 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_192s_with_sha512 =
            SigAlgs.Branch("37");

        /** 2.16.840.1.101.3.4.3.38 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_192f_with_sha512 =
            SigAlgs.Branch("38");

        /** 2.16.840.1.101.3.4.3.39 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_256s_with_sha512 =
            SigAlgs.Branch("39");

        /** 2.16.840.1.101.3.4.3.40 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_sha2_256f_with_sha512 =
            SigAlgs.Branch("40");

        /** 2.16.840.1.101.3.4.3.41 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_128s_with_shake128 =
            SigAlgs.Branch("41");

        /** 2.16.840.1.101.3.4.3.42 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_128f_with_shake128 =
            SigAlgs.Branch("42");

        /** 2.16.840.1.101.3.4.3.43 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_192s_with_shake256 =
            SigAlgs.Branch("43");

        /** 2.16.840.1.101.3.4.3.44 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_192f_with_shake256 =
            SigAlgs.Branch("44");

        /** 2.16.840.1.101.3.4.3.45 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_256s_with_shake256 =
            SigAlgs.Branch("45");

        /** 2.16.840.1.101.3.4.3.46 */
        public static readonly DerObjectIdentifier id_hash_slh_dsa_shake_256f_with_shake256 =
            SigAlgs.Branch("46");
