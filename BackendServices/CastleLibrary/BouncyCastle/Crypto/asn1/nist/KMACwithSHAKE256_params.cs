...
namespace Org.BouncyCastle.Asn1.Nist
{
    ...
    public class KMacWithShake256Params : Asn1Encodable
    {
        ...
        public static readonly DerInteger DefaultOutputLength = DerInteger.ValueOf(
        ...
        public static KMacWithShake256Params GetInstance(
        ...
        public static KMacWithShake256Params GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        private KMacWithShake256Params(Asn1Sequence seq)
        {
            ...
            m_outputLength =
                Asn1Utilities.ReadOptional(seq, ref pos, DerInteger.GetOptional)
                ?? DefaultOutputLength;
            m_customizationString =
                Asn1Utilities.ReadOptional(seq, ref pos, Asn1OctetString.GetOptional)
