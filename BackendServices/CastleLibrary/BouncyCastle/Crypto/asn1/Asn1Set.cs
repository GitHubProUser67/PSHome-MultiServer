...
{
    public abstract class Asn1Set : Asn1Object, IReadOnlyCollection<Asn1Encodable>
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1Set), Asn1Tags.Set) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct set from byte[]: " + e.Message
                    );
                }
            }
        ...
        private class Asn1SetParserImpl : Asn1SetParser
        {
