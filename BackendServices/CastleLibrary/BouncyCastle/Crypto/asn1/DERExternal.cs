    ...
    */
    public class DerExternal : Asn1Object
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerExternal), Asn1Tags.External) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct external from byte[]: " + e.Message
                    );
                }
            }
        ...
        */
        ...
        internal override IAsn1Encoding GetEncodingImplicit(
            int encoding,
            int tagClass,
            int tagNo
        ...
        */
        ...
        private static Asn1ObjectDescriptor CheckDataValueDescriptor(Asn1Object dataValueDescriptor)
        {
            ...
            throw new ArgumentException(
                "incompatible type for data-value-descriptor",
                "dataValueDescriptor"
            );
        }
        ...
        private static Asn1Object GetExternalContent(Asn1TaggedObject encoding)
        {
            ...
            switch (encoding.TagNo)
            {
                ...
                default:
                    throw new ArgumentException(
                        "unknown tag: " + Asn1Utilities.GetTagText(encoding),
                        nameof(encoding)
                    );
            }
        }
