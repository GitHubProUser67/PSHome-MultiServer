...
namespace Org.BouncyCastle.Asn1
{
    ...
    public abstract class Asn1Utilities
    {
        ...
        public static Asn1TaggedObjectParser CheckContextTag(
        ...
        public static Asn1TaggedObjectParser CheckContextTagClass(
            Asn1TaggedObjectParser taggedObjectParser
        )
        {
        ...
        public static Asn1TaggedObject CheckTag(
        ...
        )
        {
            if (!taggedObject.HasTag(tagClass, tagNo))
            {
                ...
                throw new InvalidOperationException(
                    "Expected " + expected + " tag but found " + found
                );
            }
            return taggedObject;
        }

        public static Asn1TaggedObjectParser CheckTag(
            Asn1TaggedObjectParser taggedObjectParser,
            int tagClass,
            int tagNo
        )
        ...
        public static Asn1TaggedObjectParser CheckTagClass(
            Asn1TaggedObjectParser taggedObjectParser,
            int tagClass
        )
        {
        ...
        public static TChoice GetInstanceChoice<TChoice>(
            object obj,
            Func<Asn1Encodable, TChoice> optionalConstructor
        )
            where TChoice : Asn1Encodable, IAsn1Choice
        {
            ...
            if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    ...
                    throw new ArgumentException(
                        $"failed to construct {choiceName} from byte[]: " + e.Message
                    );
                }
            }
            ...
            throw new ArgumentException(
                "Invalid object: " + Platform.GetTypeName(obj),
                nameof(obj)
            );
        }
        ...
        public static TChoice GetTaggedChoice<TChoice>(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit,
            Func<Asn1Encodable, TChoice> constructor
        )
        ...
        public static Asn1Encodable GetExplicitContextBaseObject(
            Asn1TaggedObject taggedObject,
            int tagNo
        ...
        {
            return TryGetExplicitBaseObject(
                taggedObject,
        ...
        public static TResult GetOptionalContextTagged<TState, TResult>(
            Asn1Encodable element,
            int tagNo,
            TState state,
        ...
        public static TResult GetOptionalTagged<TState, TResult>(
            Asn1Encodable element,
            int tagClass,
            int tagNo,
            TState state,
        ...
        public static bool TryGetOptionalContextTagged<TState, TResult>(
            Asn1Encodable element,
            int tagNo,
            TState state,
            out TResult result,
        ...
        public static bool TryGetOptionalTagged<TState, TResult>(
            Asn1Encodable element,
            int tagClass,
            int tagNo,
            TState state,
        ...
        {
            return TryGetExplicitBaseTagged(
                taggedObject,
                Asn1Tags.ContextSpecific,
                tagNo,
                out baseTagged
        ...
        {
            return CheckTag(taggedObject, tagClass, tagNo)
                .GetImplicitBaseTagged(baseTagClass, baseTagNo);
        }
        ...
        )
        {
            bool result = taggedObject.HasTag(tagClass, tagNo);
            baseTagged = result
                ? taggedObject.GetImplicitBaseTagged(baseTagClass, baseTagNo)
                : null;
            return result;
        }
        ...
        {
            return TryGetImplicitBaseTagged(
                taggedObject,
                Asn1Tags.ContextSpecific,
                tagNo,
                baseTagClass,
        ...
        {
            return CheckTag(taggedObject, tagClass, tagNo)
                .GetBaseUniversal(declaredExplicit, baseTagNo);
        }
        ...
        {
            bool result = taggedObject.HasTag(tagClass, tagNo);
            baseUniversal = result
                ? taggedObject.GetBaseUniversal(declaredExplicit, baseTagNo)
                : null;
            return result;
        }
        ...
        {
            return TryParseExplicitBaseTagged(
                taggedObjectParser,
                Asn1Tags.ContextSpecific,
                out baseTagged
            );
        ...
        {
            return CheckTag(taggedObjectParser, tagClass, tagNo)
                .ParseImplicitBaseTagged(baseTagClass, baseTagNo);
        }
        ...
        {
            return ParseImplicitBaseTagged(
                taggedObjectParser,
                Asn1Tags.ContextSpecific,
                tagNo,
                baseTagClass,
        ...
        )
        {
            bool result = taggedObjectParser.HasTag(tagClass, tagNo);
            baseTagged = result
                ? taggedObjectParser.ParseImplicitBaseTagged(baseTagClass, baseTagNo)
                : null;
            return result;
        }
        ...
        {
            return TryParseImplicitBaseTagged(
                taggedObjectParser,
                Asn1Tags.ContextSpecific,
                tagNo,
                baseTagClass,
        ...
        {
            return CheckTag(taggedObjectParser, tagClass, tagNo)
                .ParseBaseUniversal(declaredExplicit, baseTagNo);
        }
        ...
        )
        {
            bool result = taggedObjectParser.HasTag(tagClass, tagNo);
            baseUniversal = result
                ? taggedObjectParser.ParseBaseUniversal(declaredExplicit, baseTagNo)
                : null;
            return result;
        }
        ...
        {
            return TryParseExplicitBaseObject(
                taggedObjectParser,
                Asn1Tags.ContextSpecific,
                tagNo,
                out baseObject
        ...
        public static TResult ReadContextTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagNo,
            TState state,
            Func<Asn1TaggedObject, TState, TResult> constructor
        )
        ...
        public static TResult ReadTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagClass,
            int tagNo,
        ...
        )
        {
             ...
             */
            var tagged = Asn1TaggedObject.GetInstance(
        ...
        public static TResult ReadOptional<TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
        ...
        public static TResult ReadOptionalContextTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagNo,
            TState state,
        ...
        public static TResult ReadOptionalTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagClass,
            int tagNo,
        ...
        {
            if (
                sequencePosition < sequence.Count
                && TryGetOptionalTagged(
                    sequence[sequencePosition],
                    tagClass,
                    tagNo,
                    state,
        ...
        public static bool TryReadOptionalContextTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagNo,
            TState state,
        ...
        public static bool TryReadOptionalTagged<TState, TResult>(
            Asn1Sequence sequence,
            ref int sequencePosition,
            int tagClass,
            int tagNo,
