...
namespace Org.BouncyCastle.Asn1.Icao
{
    ...
    */
    public class DataGroupHash : Asn1Encodable
    {
        ...
        public static DataGroupHash GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        public DataGroupHash(int dataGroupNumber, Asn1OctetString dataGroupHashValue)
        {
            ...
            m_dataGroupHashValue =
                dataGroupHashValue ?? throw new ArgumentNullException(nameof(dataGroupHashValue));
        }
        ...
        public override Asn1Object ToAsn1Object() =>
            new DerSequence(m_dataGroupNumber, m_dataGroupHashValue);
    }
}
