...
namespace Org.BouncyCastle.Asn1
{
    public sealed class Asn1ObjectDescriptor : Asn1Object
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1ObjectDescriptor), Asn1Tags.ObjectDescriptor) { }

            internal override Asn1Object FromImplicitPrimitive(DerOctetString octetString)
            {
                return new Asn1ObjectDescriptor(
                    (DerGraphicString)
                        DerGraphicString.Meta.Instance.FromImplicitPrimitive(octetString)
                );
            }
            ...
            internal override Asn1Object FromImplicitConstructed(Asn1Sequence sequence)
            {
                return new Asn1ObjectDescriptor(
                    (DerGraphicString)
                        DerGraphicString.Meta.Instance.FromImplicitConstructed(sequence)
                );
            }
        }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct object descriptor from byte[]: " + e.Message
                    );
                }
            }
        ...
        {
            return (Asn1ObjectDescriptor)
                Meta.Instance.GetContextTagged(taggedObject, declaredExplicit);
        }
        ...
        public static Asn1ObjectDescriptor GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
        ...
        {
            return m_baseGraphicString.GetEncodingImplicit(
                encoding,
                Asn1Tags.Universal,
                Asn1Tags.ObjectDescriptor
            );
        }
        ...
        {
            return m_baseGraphicString.GetEncodingDerImplicit(
                Asn1Tags.Universal,
                Asn1Tags.ObjectDescriptor
            );
        }
        ...
        protected override bool Asn1Equals(Asn1Object asn1Object)
        {
            ...
            return null != that && this.m_baseGraphicString.Equals(that.m_baseGraphicString);
        }
