...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerUniversalString : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerUniversalString), Asn1Tags.UniversalString) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct universal string from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static DerUniversalString GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
        ...
        protected override bool Asn1Equals(Asn1Object asn1Object)
        {
            ...
            return null != that && Arrays.AreEqual(this.m_contents, that.m_contents);
        }
