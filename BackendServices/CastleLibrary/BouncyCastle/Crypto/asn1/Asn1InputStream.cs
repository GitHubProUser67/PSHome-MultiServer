...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class Asn1InputStream : FilterStream
    {
        ...
        internal static int GetMemoryStreamLimit(MemoryStream input) =>
            Convert.ToInt32(input.Length - input.Position);
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        internal static int ReadLength(Stream s, int limit, bool isParsing)
        {
            ...
            if (length >= limit && !isParsing) // after all we must have read at least 1 byte
                throw new IOException(
                    "corrupted stream - out of bounds length found: " + length + " >= " + limit
                );
        ...
        private static DerBmpString CreateDerBmpString(DefiniteLengthInputStream defIn)
        {
            ...
            return DerBmpString.CreatePrimitive(
                length,
                defIn,
                (str, defIn) =>
                {
