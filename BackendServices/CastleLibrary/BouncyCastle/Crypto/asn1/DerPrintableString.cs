...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerPrintableString : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerPrintableString), Asn1Tags.PrintableString) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct printable string from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static DerPrintableString GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
