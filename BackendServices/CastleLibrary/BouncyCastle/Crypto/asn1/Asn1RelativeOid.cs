...
namespace Org.BouncyCastle.Asn1
{
    public class Asn1RelativeOid : Asn1Object
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(Asn1RelativeOid), Asn1Tags.RelativeOid) { }
            ...
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct relative OID from byte[]: " + e.Message
                    );
                }
            }
        ...
        public static Asn1RelativeOid GetInstance(
        ...
        public static Asn1RelativeOid GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
        ...
        internal static void WriteField(Stream outputStream, BigInteger fieldValue)
        {
            ...
            else
            {
                ...
                Span<byte> tmp = byteCount <= 16 ? stackalloc byte[byteCount] : new byte[byteCount];
