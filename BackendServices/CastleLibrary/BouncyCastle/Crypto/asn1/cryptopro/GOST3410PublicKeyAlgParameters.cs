...
namespace Org.BouncyCastle.Asn1.CryptoPro
{
    public class Gost3410PublicKeyAlgParameters : Asn1Encodable
    {
        ...
        public static Gost3410PublicKeyAlgParameters GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ) =>
            new Gost3410PublicKeyAlgParameters(
        ...
        private Gost3410PublicKeyAlgParameters(Asn1Sequence seq)
        {
            ...
            m_encryptionParamSet = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
        ...
        {
            m_publicKeyParamSet =
                publicKeyParamSet ?? throw new ArgumentNullException(nameof(publicKeyParamSet));
            m_digestParamSet =
                digestParamSet ?? throw new ArgumentNullException(nameof(digestParamSet));
