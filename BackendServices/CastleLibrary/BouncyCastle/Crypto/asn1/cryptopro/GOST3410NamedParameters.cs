...
namespace Org.BouncyCastle.Asn1.CryptoPro
{
    ...
    public static class Gost3410NamedParameters
    {
        private static readonly Gost3410ParamSetParameters cryptoProA =
            new Gost3410ParamSetParameters(
                1024,
                new BigInteger(
        ...
        > parameters = new Dictionary<DerObjectIdentifier, Gost3410ParamSetParameters>();
        ...
        {
            DefineParameters(
                "GostR3410-94-CryptoPro-A",
                CryptoProObjectIdentifiers.GostR3410x94CryptoProA,
                cryptoProA
            );
            DefineParameters(
                "GostR3410-94-CryptoPro-B",
                CryptoProObjectIdentifiers.GostR3410x94CryptoProB,
                cryptoProB
            );
            DefineParameters(
                "GostR3410-94-CryptoPro-XchA",
                CryptoProObjectIdentifiers.GostR3410x94CryptoProXchA,
                cryptoProXchA
            );
        }
