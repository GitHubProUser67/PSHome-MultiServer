    ...
    */
    public class AdditionalInformationSyntax : Asn1Encodable
    {
        ...
        public static AdditionalInformationSyntax GetInstance(
            ...
            new AdditionalInformationSyntax(
                DirectoryString.GetInstance(taggedObject, declaredExplicit)
            );

        public static AdditionalInformationSyntax GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ) =>
            new AdditionalInformationSyntax(
                DirectoryString.GetTagged(taggedObject, declaredExplicit)
            );
