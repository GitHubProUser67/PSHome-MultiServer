...
namespace Org.BouncyCastle.Asn1.IsisMtt.X509
{
    ...
    */
    public class AdmissionSyntax : Asn1Encodable
    {
        ...
        public static AdmissionSyntax GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        */
        private AdmissionSyntax(Asn1Sequence seq)
        {
            ...
            m_admissionAuthority = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                GeneralName.GetOptional
            );
        ...
        */
        public AdmissionSyntax(GeneralName admissionAuthority, Asn1Sequence contentsOfAdmissions)
        {
            ...
            m_contentsOfAdmissions =
                contentsOfAdmissions
                ?? throw new ArgumentNullException(nameof(contentsOfAdmissions));
        }
