    ...
    */
    public class NamingAuthority : Asn1Encodable
    {
        ...
        */
        ...
        public static NamingAuthority GetTagged(
        ...
        */
        private NamingAuthority(Asn1Sequence seq)
        {
            ...
            m_namingAuthorityID = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                DerObjectIdentifier.GetOptional
            );
            m_namingAuthorityUrl = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                DerIA5String.GetOptional
            );
            m_namingAuthorityText = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                DirectoryString.GetOptional
            );
        ...
        */
        ...
        )
        {
            ...
            m_namingAuthorityUrl =
                namingAuthorityUrl == null ? null : new DerIA5String(namingAuthorityUrl, true);
