...
namespace Org.BouncyCastle.Asn1.IsisMtt.X509
{
    ...
    */
    public class ProcurationSyntax : Asn1Encodable
    {
        ...
        public static ProcurationSyntax GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        */
        private ProcurationSyntax(Asn1Sequence seq)
        {
            ...
            m_country = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                1,
                true,
            ...
            m_typeOfSubstitution = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                2,
                true,
            ...
            m_signingFor = Asn1Utilities.ReadContextTagged(
                seq,
                ref pos,
                3,
                true,
        ...
        */
        ...
        private static Asn1Encodable GetTaggedSigningFor(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        )
        {
