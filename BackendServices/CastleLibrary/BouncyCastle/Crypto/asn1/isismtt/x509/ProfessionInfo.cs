    ...
    */
    public class ProfessionInfo : Asn1Encodable
    {
        ...
        */
        ...
        public static ProfessionInfo GetTagged(
            Asn1TaggedObject taggedObject,
            bool declaredExplicit
        ...
        */
        private ProfessionInfo(Asn1Sequence seq)
        {
            ...
            m_namingAuthority = Asn1Utilities.ReadOptionalContextTagged(
                seq,
                ref pos,
                0,
                true,
                NamingAuthority.GetTagged
            );
            ...
            m_registrationNumber = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                DerPrintableString.GetOptional
            );
            m_addProfessionInfo = Asn1Utilities.ReadOptional(
                seq,
                ref pos,
                Asn1OctetString.GetOptional
            );
        ...
        )
        {
            ...
            m_registrationNumber =
                registrationNumber == null
                    ? null
                    : new DerPrintableString(registrationNumber, true);
        ...
        */
        public virtual DerObjectIdentifier[] GetProfessionOids() =>
            m_professionOids?.MapElements(DerObjectIdentifier.GetInstance)
            ?? new DerObjectIdentifier[0];
