...
namespace Org.BouncyCastle.Asn1.IsisMtt.Ocsp
{
    ...
    public class RequestedCertificate : Asn1Encodable, IAsn1Choice
    {
        ...
        public static RequestedCertificate GetOptional(Asn1Encodable element)
        {
            ...
            Asn1TaggedObject taggedObject = Asn1TaggedObject.GetOptional(
                element,
            ...
            {
                if (
                    taggedObject.TagNo == (int)Choice.PublicKeyCertificate
        ...
        public static RequestedCertificate GetTagged(
