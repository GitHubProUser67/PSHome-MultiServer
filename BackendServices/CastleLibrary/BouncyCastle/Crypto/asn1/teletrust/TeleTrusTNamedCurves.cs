    ...
    public static class TeleTrusTNamedCurves
    {
        ...
        internal class BrainpoolP160r1Holder : X9ECParametersHolder
        {
            ...
            protected override X9ECParameters CreateParameters()
            {
                ...
                X9ECPoint G = ConfigureBasepoint(
                    curve,
        ...
        private static readonly Dictionary<string, DerObjectIdentifier> objIds = new Dictionary<
            string,
            DerObjectIdentifier
