...
namespace Org.BouncyCastle.Asn1.TeleTrust
{
    ...
    public sealed class TeleTrusTObjectIdentifiers
    {
        ...
        public static readonly DerObjectIdentifier RsaSignatureWithRipeMD160 = rsaSignature.Branch(
            "2"
        );
        public static readonly DerObjectIdentifier RsaSignatureWithRipeMD128 = rsaSignature.Branch(
            "3"
        );
        public static readonly DerObjectIdentifier RsaSignatureWithRipeMD256 = rsaSignature.Branch(
            "4"
        );
        ...
        public static readonly DerObjectIdentifier EllipticCurve = ecStdCurvesAndGeneration.Branch(
            "1"
        );
