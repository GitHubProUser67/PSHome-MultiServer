...
namespace Org.BouncyCastle.Asn1
{
    ...
    public class DerBmpString : DerStringBase
    {
        internal class Meta : Asn1UniversalType
        {
            ...
            private Meta()
                : base(typeof(DerBmpString), Asn1Tags.BmpString) { }
        ...
        public static DerBmpString GetInstance(object obj)
        {
            ...
            {
                if (
                    !(obj is Asn1Object) && asn1Convertible.ToAsn1Object() is DerBmpString converted
                )
                    return converted;
            }
            else if (obj is byte[] bytes)
            {
                ...
                catch (IOException e)
                {
                    throw new ArgumentException(
                        "failed to construct BMP string from byte[]: " + e.Message
                    );
                }
            }
        ...
        protected override bool Asn1Equals(Asn1Object asn1Object)
        {
            ...
            return null != that && this.m_str.Equals(that.m_str);
        }
        ...
        internal static DerBmpString CreatePrimitive<TState>(
            int length,
            TState state,
