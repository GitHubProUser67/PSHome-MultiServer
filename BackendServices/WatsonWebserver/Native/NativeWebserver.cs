namespace WatsonWebserver.Native
{
    ...
    /// Watson webserver.
    /// </summary>
    public class NativeWebserver : WebserverBase, IDisposable
    {
        ...
        public NativeWebserver(WebserverSettings settings, Func<HttpContextBase, Task> defaultRoute, int MaxConcurrentListeners = 10) : base(settings, defaultRoute)
        {
        ...
        public override void Start(CancellationToken token = default)
        {
            ...
            if (Settings.Ssl.Enable)
                throw new NotSupportedException("SSL support is disabled on the native HttpListener backend!");
