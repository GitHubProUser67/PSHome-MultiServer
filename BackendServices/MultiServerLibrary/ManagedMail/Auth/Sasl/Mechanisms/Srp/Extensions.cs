...
namespace MultiServerLibrary.ManagedMail.Auth.Sasl.Mechanisms.Srp
{
    ...
    internal static class BinaryReaderExtensions
    {
        ...
        public static uint ReadUInt32(this BinaryReader reader, bool bigEndian)
        {
            ...
            return bigEndian ? EndianTools.EndianUtils.ReverseUint(result) : result;
        }
        ...
        public static ushort ReadUInt16(this BinaryReader reader, bool bigEndian)
        {
            ...
            return bigEndian ? EndianTools.EndianUtils.ReverseUshort(result) : result;
        }
        ...
        public static Utf8String ReadUtf8String(this BinaryReader reader)
        {
            return new Utf8String(
                Encoding.UTF8.GetString(reader.ReadBytes(reader.ReadUInt16(true)))
            );
        }
    }
}
