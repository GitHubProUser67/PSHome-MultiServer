...
namespace MultiServerLibrary.ManagedMail.Auth.Sasl.Mechanisms.Ntlm
{
    ...
    internal class Type1Message
    {
        ...
        {
            get { return domainOffset + domain.Length; }
        }
        ...
        {
            get { return Convert.ToInt16(workstation.Length); }
        }
        ...
        public Type1Message(string domain, string workstation)
        {
            ...
            if (this.domain.Length >= Int16.MaxValue)
            {
                throw new ArgumentOutOfRangeException(
                    "The supplied domain name must " + "not be longer than " + Int16.MaxValue
                );
            }
            ...
            {
                throw new ArgumentOutOfRangeException(
                    "The supplied workstation name " + "must not be longer than " + Int16.MaxValue
                );
            }
