namespace MultiServerLibrary.ManagedMail.Auth.Sasl
{
    /// <summary>
    ...
    internal static class SaslFactory
    {
        ...
        /// </summary>
        static Dictionary<string, Type> Mechanisms { get; set; }
        ...
        public static SaslMechanism Create(string name)
        {
            ...
            if (!Mechanisms.TryGetValue(name, out var t))
            {
                throw new SaslException(
                    "A Sasl mechanism with the specified name "
        ...
        public static void Add(string name, Type t)
        {
            ...
            if (!t.IsSubclassOf(typeof(SaslMechanism)))
            {
                throw new ArgumentException(
                    "The type t must be a subclass " + "of Sasl.SaslMechanism"
                );
            }
            try
            {
