...
namespace MultiServerLibrary.ManagedMail
{
    ...
    /// </summary>
    internal partial class Reader : StringReader
    {
        /// <summary>
        ...
        public override int Read()
        {
            ...
            return character == -1 ? throw new EndOfStringException() : character;
        }
        ...
        public Dictionary<string, string> ReadList()
        {
            ...
            var matches = MyRegex().Matches(pairs.ToString());
        ...
        {
            var Disp = new ContentDisposition();
            char c;
            var last = new char[3];
            while ((c = (char)Read()) != '(')
            {
            ...
            if (Disp.Attributes.TryGetValue("Filename", out var value))
                Disp.Filename = value;
            return Disp;
        }
    ...
    internal class EndOfStringException : Exception
    {
        ...
        public EndOfStringException(string message, Exception inner)
            : base(message, inner) { }
