namespace MultiServerLibrary.ManagedMail
{
    ...
    public class MailboxInfo
    {
        ...
        internal MailboxInfo(
            string Name,
            IEnumerable<MailboxFlag> Flags,
            int Messages,
            int Unread,
            uint NextUID,
            UInt64 UsedStorage,
        ...
        /// </summary>
        public uint NextUID { get; private set; }
        ...
        /// </remarks>
        public UInt64 UsedStorage { get; private set; }
        ...
        /// </remarks>
        public UInt64 FreeStorage { get; private set; }
    }
}
