...
public static class PrometheusConstants
{
    ...
    public const string TextContentTypeWithVersionAndEncoding =
        TextContentType + "; version=0.0.4; charset=utf-8";
    public const string OpenMetricsContentTypeWithVersionAndEncoding =
        OpenMetricsContentType + "; version=1.0.0; charset=utf-8";

    // ASP.NET requires a MediaTypeHeaderValue object
    public static readonly MediaTypeHeaderValue ExporterContentTypeValue =
        MediaTypeHeaderValue.Parse(TextContentTypeWithVersionAndEncoding);
    ...
    public static readonly Encoding ExportEncoding = new UTF8Encoding(
