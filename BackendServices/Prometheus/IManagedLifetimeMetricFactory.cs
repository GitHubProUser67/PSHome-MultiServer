...
public interface IManagedLifetimeMetricFactory
{
    ...
    /// </summary>
    IManagedLifetimeMetricHandle<ICounter> CreateCounter(
        string name,
        string help,
    ...
    /// A timeseries will expire N seconds after the last lease is released, with N determined at factory create-time.
    /// </summary>
    IManagedLifetimeMetricHandle<IGauge> CreateGauge(
        string name,
        string help,
        string[]? labelNames = null,
    ...
    /// A timeseries will expire N seconds after the last lease is released, with N determined at factory create-time.
    /// </summary>
    IManagedLifetimeMetricHandle<IHistogram> CreateHistogram(
        string name,
        string help,
        string[]? labelNames = null,
    ...
    /// A timeseries will expire N seconds after the last lease is released, with N determined at factory create-time.
    /// </summary>
    IManagedLifetimeMetricHandle<ISummary> CreateSummary(
        string name,
        string help,
        string[]? labelNames = null,
