...
internal sealed class HttpClientInProgressHandler(
    HttpClientInProgressOptions? options,
    HttpClientIdentity identity
) : HttpClientDelegatingHandlerBase<ICollector<IGauge>, IGauge>(options, options?.Gauge, identity)
{
