...
) : IManagedLifetimeMetricHandle<ICounter>
{
    ...
    internal readonly IManagedLifetimeMetricHandle<ICounter> _inner = inner;
    private readonly string[] _enrichWithLabelValues = enrichWithLabelValues;

    public ICollector<ICounter> WithExtendLifetimeOnUse()
    {
        return new LabelEnrichingAutoLeasingMetric<ICounter>(
    ...
    public Task<TResult> WithLeaseAsync<TResult>(
        Func<ICounter, Task<TResult>> action,
        params string[] labelValues
    )
    {
