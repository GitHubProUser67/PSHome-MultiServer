...
dotnet build PSHMultiServer.slnx --configuration Debug --property WarningLevel=0
dotnet build PSHMultiServer.slnx --configuration Release --property WarningLevel=0
...
xcopy /E /Y /I "Win32GUI/RemoteControl/bin/Debug/net10.0-windows7.0" "~BuildOutput/Debug"
xcopy /E /Y /I "Win32GUI/RemoteControl/bin/Release/net10.0-windows7.0" "~BuildOutput/Release"
xcopy /E /Y /I "Win32GUI/Json Editor/bin/Debug/net10.0-windows7.0" "~BuildOutput/Debug"
xcopy /E /Y /I "Win32GUI/Json Editor/bin/Release/net10.0-windows7.0" "~BuildOutput/Release"
