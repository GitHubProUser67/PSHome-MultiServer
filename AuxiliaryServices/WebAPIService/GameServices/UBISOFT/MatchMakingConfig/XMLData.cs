namespace WebAPIService.GameServices.UBISOFT.MatchMakingConfig
{
    public class XMLData
    {
        public static readonly string DFS_PS3_NTSC_EN_XMLPayload =
            "<RESPONSE xmlns=\"\">"
        ...
        public static readonly string DFS_PC_EN_XMLPayload =
            @"<RESPONSE xmlns="">
        ...
        public static readonly string PB_PS3_EN_XMLPayload =
            @"<RESPONSE xmlns="">
