using System.Text;
using WebAPIService.GameServices.PSHOME.HELLFIRE.HFProcessors;

namespace WebAPIService.GameServices.PSHOME.HELLFIRE
{
    public class HELLFIREClass(string method, string absolutepath, string workpath)
    {
        ...
        public byte[] ProcessRequest(byte[] PostData, string ContentType, bool https)
        {
            ...
            switch (method)
            {
                    ...
                    switch (absolutepath)
                    {
                        ...
                        case "/HomeTycoon/Main_SCEE.php":
                            return Encoding.UTF8.GetBytes(
                                TycoonRequestProcessor.ProcessMainPHP(
                                    PostData,
                                    ContentType,
                                    null,
                                    workpath,
                        ...
                        case "/ClearasilSkater/Main.php":
                            return Encoding.UTF8.GetBytes(
                                ClearasilSkaterRequestProcessor.ProcessMainPHP(
                                    PostData,
                                    ContentType,
                                    null,
                                    workpath
                        ...
                        case "/SlimJim/Main.php":
                            return Encoding.UTF8.GetBytes(
                                SlimJimRequestProcessor.ProcessMainPHP(
                                    PostData,
                                    ContentType,
                                    null,
                                    workpath
                        ...
                        case "/Main.php":
                            return Encoding.UTF8.GetBytes(
                                NovusPrimeRequestProcessor.ProcessMainPHP(
                                    PostData,
                                    ContentType,
                                    null,
                                    workpath
                        ...
                        case "/PokerServer/PokerMain.php":
                            return Encoding.UTF8.GetBytes(
                                PokerServerRequestProcessor.ProcessPokerMainPHP(
                                    PostData,
                                    ContentType,
                                    null,
                                    workpath
                ...
                case "GET":
                    ...
                    {
                        var parts = Path.GetFileName(absolutepath).Split('.');

                        if (parts.Length == 3)
                        {
                            var jpgPostCardFilePath =
                                $"{workpath}/HomeTycoon/TownsData/{parts[0]}/{parts[1]}.{parts[2]}";
