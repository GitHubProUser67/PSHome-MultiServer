...
namespace WebAPIService.GameServices.PSHOME.VEEMEE.audi_vrun
{
    internal class VrunScoreBoardData(
        ...
        object obj = null
    ) : ScoreboardService<VrunScoreboardEntry>(options)
    {
        ...
        public override async Task<string> SerializeToString(string gameName, int max = 8)
        {
            ...
            var data = new StringBuilder(
                $"<XML><PAGE><RECT X=\"0\" Y=\"1\" W=\"0\" H=\"0\" col=\"#C0C0C0\" /><RECT X=\"0\" Y=\"0\" W=\"1280\" H=\"720\" col=\"#000000\" /><TEXT X=\"57\" Y=\"42\" col=\"#FFFFFF\" size=\"4\">{gameName}</TEXT>"
            );
            ...
            {
                data.AppendFormat(
                    "<RECT X=\"57\" Y=\"" + iY + "\" W=\"50\" H=\"50\" col=\"#662020\" />"
                );
                data.AppendFormat(
                    "<RECT X=\"57\" Y=\"" + (iY + 45) + "\" W=\"50\" H=\"4\" col=\"#873030\" />"
                );
                data.AppendFormat(
                    "<RECT X=\"973\" Y=\"" + iY + "\" W=\"254\" H=\"50\" col=\"#662020\" />"
                );
                data.AppendFormat(
                    "<RECT X=\"973\" Y=\"" + (iY + 45) + "\" W=\"254\" H=\"4\" col=\"#873030\" />"
                );
                data.AppendFormat(
                    "<RECT X=\"107\" Y=\"" + iY + "\" W=\"867\" H=\"50\" col=\"#313131\" />"
                );
                data.AppendFormat(
                    "<RECT X=\"107\" Y=\"" + (iY + 45) + "\" W=\"867\" H=\"4\" col=\"#4D4D4D\" />"
                );
                data.AppendFormat(
                    "<TEXT X=\"70\" Y=\"{0}\" col=\"#FFFFFF\" size=\"3\">{1}</TEXT>",
                    iY + 5,
                    i + 1
                );
                ...
                data.AppendFormat(
                    "<TEXT X=\"1015\" Y=\"{0}\" col=\"#FFFFFF\" size=\"3\">{1} m</TEXT>",
                    iY + 5,
                    entries[i].Score
                );
