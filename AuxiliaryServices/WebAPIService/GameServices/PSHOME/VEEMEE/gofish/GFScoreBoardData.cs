...
namespace WebAPIService.GameServices.PSHOME.VEEMEE.gofish
{
    internal class GFScoreBoardData(
        ...
        object obj = null
    ) : ScoreboardService<GFScoreboardEntry>(options)
    {
        ...
        )
        {
            ...
            var fishcount = (string)extraData[0];
            var biggestfishweight = (string)extraData[1];
            var totalfishweight = (string)extraData[2];
