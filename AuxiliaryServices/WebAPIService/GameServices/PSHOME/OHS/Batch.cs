                            ...
                            if (command != null && command.Data != null)
                            {
                                ...
                                switch (method)
                                {
                                    ...
                                    case "leaderboard/requestbyusers/":
                                        resultfromcommand = Leaderboard.Leaderboard_RequestByUsers(directorypath, PostData, ContentType, project, data, game);
                                        break;
                                    case "leaderboard/requestbyrank/":
                                        resultfromcommand = Leaderboard.Leaderboard_RequestByRank(directorypath, PostData, ContentType, project, data, game);
                                        break;
                                    case "leaderboard/update/":
                                        resultfromcommand = Leaderboard.Leaderboard_Update(directorypath, PostData, ContentType, project, data, game, false);
                                        break;
                                    case "leaderboard/updatessameentry/":
                                        resultfromcommand = Leaderboard.Leaderboard_UpdatesSameEntry(directorypath, PostData, ContentType, project, data, game, false);
                                        break;
                                    case "levelboard/getall/":
                                        resultfromcommand = Leaderboard.Levelboard_GetAll(project, game, true);
                                        break;
                                    case "levelboard/update/":
                                        resultfromcommand = Leaderboard.Leaderboard_Update(directorypath, PostData, ContentType, project, data, game, true);
                                        break;
