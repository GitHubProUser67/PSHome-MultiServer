...
namespace WebAPIService.GameServices.PSHOME.OHS
{
    public class Batch
    {
        public static string Batch_Process(
            byte[] PostData,
            string ContentType,
                    ...
                    if (commands != null)
                    {
                        ...
                        foreach (var command in commands)
                        {
                            ...
                            if (command != null && command.Data != null)
                            {
                                ...
                                var data = command.Data.ToString(Formatting.None);
                                ...
                                LoggerAccessor.LogInfo(
                                    $"[OHS] : Client Requested a /batch/ method, here are the details : method[{i}] | {method} - project | {project} - data | {data}"
                                );

                                switch (method)
                                {
                                    case "community/getscore/":
                                        resultfromcommand = Community.Community_Getscore(
                                            PostData,
                                            ContentType,
                                    ...
                                    case "community/updatescore/":
                                        resultfromcommand = Community.Community_UpdateScore(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                        ...
                                        break;
                                    case "global/getall/":
                                        resultfromcommand = User.Get_All(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "global/set/":
                                        ...
                                        break;
                                    case "userid/":
                                        resultfromcommand = User.User_Id(
                                            PostData,
                                            ContentType,
                                            data,
                                            game
                                    ...
                                    case "user/gets/":
                                        ...
                                        break;
                                    case "user/getmany/":
                                        resultfromcommand = User.GetMany(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "user/clearentry/":
                                        resultfromcommand = User.ClearEntry(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "user/getwritekey/":
                                        resultfromcommand = User.User_GetWritekey(
                                            PostData,
                                            ContentType,
                                            data,
                                            game
                                    ...
                                    case "leaderboard/requestbyusers/":
                                        resultfromcommand = Leaderboard.Leaderboard_RequestByUsers(
                                            directorypath,
                                            PostData,
                                            ContentType,
                                            project,
                                    ...
                                    case "leaderboard/requestbyrank/":
                                        resultfromcommand = Leaderboard.Leaderboard_RequestByRank(
                                            directorypath,
                                            PostData,
                                            ContentType,
                                            project,
                                    ...
                                    case "leaderboard/update/":
                                        resultfromcommand = Leaderboard.Leaderboard_Update(
                                            directorypath,
                                            PostData,
                                            ContentType,
                                            project,
                                    ...
                                    case "levelboard/getall/":
                                        resultfromcommand = Leaderboard.Levelboard_GetAll(
                                            project,
                                            game,
                                            true
                                        );
                                    ...
                                    case "usercounter/set/":
                                        resultfromcommand = UserCounter.Set(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "usercounter/increment/v2/":
                                        resultfromcommand = UserCounter.Increment(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "usercounter/getall/":
                                        resultfromcommand = UserCounter.Get_All(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "usercounter/get/":
                                        resultfromcommand = UserCounter.Get(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "usercounter/incrementmany/":
                                        resultfromcommand = UserCounter.Increment_Many(
                                            PostData,
                                            ContentType,
                                            directorypath,
                                            data,
                                    ...
                                    case "usercounter/increment_setentry/":
                                        resultfromcommand = UserCounter.IncrementSetEntry(
                                            PostData,
                                            ContentType,
                                            directorypath,
                                            data,
                                    ...
                                    case "userinventory/addglobalitems/":
                                        resultfromcommand = UserInventory.AddGlobalItems(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "userinventory/getglobalitems/":
                                        resultfromcommand = UserInventory.GetGlobalItems(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "userinventory/updateuserinventory/":
                                        resultfromcommand = UserInventory.UpdateUserInventory(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "userinventory/getuserinventory/":
                                        resultfromcommand = UserInventory.GetUserInventory(
                                            PostData,
                                            ContentType,
                                            directorypath + $"/{project}/",
                                            data,
                                    ...
                                    case "voucher/":
                                        resultfromcommand =
                                            "{ [\"voucher\"] = \"xxxx-xxxx-xxxx\", [\"fresh\"] = true, [\"exhausted\"] = true }";
                                        break;
                                    default:
                                        LoggerAccessor.LogWarn(
                                            $"[OHS] - Batch requested a method I don't know about, please report it to GITHUB {method} in {project} with data {data}"
                                        );
                                        break;
                                }
                                ...
                                if (resultBuilder.Length == 0)
                                    resultBuilder.Append(
                                        $"{{ [\"status\"] = \"success\", [\"value\"] = {{ [{i}] = {resultfromcommand}"
                                    );
                                else
