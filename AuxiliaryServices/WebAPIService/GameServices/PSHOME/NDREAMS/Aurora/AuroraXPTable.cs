namespace WebAPIService.GameServices.PSHOME.NDREAMS.Aurora
{
    public static class AuroraXPTable
    {
        ...
        private static readonly Dictionary<int, string> XpRewards = new()
        {
            ...
            {
                831978,
                "Captain Barber's Propeller wall hanging, The Face Melter chair, and Clux-Fapacitor chair"
            },
        ...
        {
            var closestHigherXP = 1050755;
            foreach (var exp in LevelsNxp)
            {
        ...
        public static int GetClosestLowerRewardXP(int xp)
        {
            ...
            var closestLowerXP = 0;
            foreach (var key in XpRewards.Keys)
            {
