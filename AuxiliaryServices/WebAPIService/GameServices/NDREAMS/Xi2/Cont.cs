...
namespace WebAPIService.GameServices.NDREAMS.Xi2
{
    public class Cont
    {
                    ...
                    if (!string.IsNullOrEmpty(func))
                    {
                        ...
                        switch (func)
                        {
                            case "xoff":
                                ...
                                ExpectedHash = Teaser.Xoff_VerifyKey(territory, day);
                                ...
                                if (key == ExpectedHash)
                                {
                                    ...
                                    return $"<xml><success>true</success><result><day>{MockedDay}</day><hash>{Teaser.Xoff_GetSignature(int.Parse(day), MockedDay)}</hash></result></xml>";
                                }
                                else
                                {
