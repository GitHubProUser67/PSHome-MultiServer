...
namespace WebAPIService.GameServices.JUGGERNAUT.farm.animal
{
    public class animal_collect_renew
    {
        public static string ProcessCollectRenew(IDictionary<string, string> QueryParameters, string apiPath)
        {
