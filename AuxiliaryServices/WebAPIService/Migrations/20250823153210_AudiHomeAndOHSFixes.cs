...
namespace WebAPIService.Migrations
{
    ...
    public partial class AudiHomeAndOHSFixes : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "InterGalacticScoreboardEntry");

            migrationBuilder.DropTable(name: "OHSScoreboardEntry");

            migrationBuilder.DropTable(name: "SledMpScoreboardEntry");

            migrationBuilder.DropTable(name: "SledScoreboardEntry");

            migrationBuilder.DropTable(name: "VrunScoreboardEntry");
        }
    }
}
