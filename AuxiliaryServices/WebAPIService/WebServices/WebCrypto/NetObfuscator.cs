...
namespace WebAPIService.WebServices.WebCrypto
{
    ...
    {
        public static readonly byte[] GenSalt =
        [
            0x1A,
            0xFF,
            0xB3,
        ...
        public static readonly byte[] SecSalt =
        [
            0x7A,
            0xC3,
            0x1F,
        ...
        {
            var base64 = new StringBuilder(Base64.ToBase64String(data));
        ...
        {
            var decoded = new StringBuilder(encodedData);
            for (var i = 0; i < decoded.Length; i++)
                decoded[i] = (char)(decoded[i] - 3);
            return decoded.ToString().IsBase64().DecodedBytes;
        }
        ...
        {
            return XORCipher(
                RandomSalt(ShiftAndReverse(Base64CustomDecode(encodedData), -7), salt),
                xorKey
            );
        }
