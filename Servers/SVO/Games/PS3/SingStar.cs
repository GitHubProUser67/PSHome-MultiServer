...
{
    public partial class SingStar
    {
        public static async Task Singstar_SVO(
                            ...
                            switch (method)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var domain = "singstar.svo.online.com";
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var singOnlnInit = Encoding.UTF8.GetBytes(
                                            @"<?xml version=""1.0"" encoding=""UTF-8""?> 
                                        <SVML>
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var startedInit = Encoding.UTF8.GetBytes(
                                            $@"<?xml version=""1.0"" encoding=""UTF-8""?>
                                        <SVML>
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var onlnRoot = Encoding.UTF8.GetBytes(
                                            @"<?xml version=""1.0"" encoding=""UTF-8""?>
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        response.Headers.Set("X-SVOMac", serverMac);
                                        var VideoInit = Encoding.UTF8.GetBytes(
                                            $@"<?xml version=""1.0"" encoding=""UTF-8""?>
                                        <SVML>
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var successRoot = Encoding.UTF8.GetBytes(
                                            @"
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var failRoot = Encoding.UTF8.GetBytes(
                                            @"
