...
{
    public partial class Warhawk
    {
        public static async Task Warhawk_SVO(
                            ...
                            switch (method)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        response.Headers.Set(
                                            "Location",
                                            $"http://{domain}:10060/WARHAWK_SVML/index1.jsp"
                                        );
                                        response.Headers.Set(
                                            "Content-Type",
                            ...
                            switch (method)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var domain = "warhawk-prod3.svo.online.scea.com";
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var GameCreateResponse = Encoding.UTF8.GetBytes(
                                            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n"
                                                + "<XML>\r\n\t"
                                                + "<GamePlayer>\r\n\t\t"
                                                + "<status>\r\n\t\t\t"
                            ...
                            switch (request.HttpMethod)
                            {
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        var whstatsResponse = Encoding.UTF8.GetBytes(
                                            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n<SVML>\r\n\t"
