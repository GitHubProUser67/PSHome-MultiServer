...
{
    public partial class Killzone2
    {
            ...
            using (var response = context.Response)
            {
                                ...
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        LoggerAccessor.LogInfo(
                                            $"Start URIStore for Killzone 2 SENT!"
                                        );
#endif
                                    }
                                    break;
                                ...
                                case "GET":
                                    ...
                                    else
                                    {
                                        ...
                                        resp.OutputStream.Write(
                                            Encoding.ASCII.GetBytes(xmlMessage)
                                        );
#if DEBUG
...
#if DEBUG
                                        LoggerAccessor.LogInfo(
                                            $"Start game create for Killzone 2 SENT!"
                                        );
#endif
                                    }
                                    break;
                ...
                catch (Exception ex)
                {
                    LoggerAccessor.LogError(
                        $"[SVO] - Killzone2_SVOAsync thrown an assertion - {ex}"
                    );
