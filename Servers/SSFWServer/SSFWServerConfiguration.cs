...
public static class SSFWServerConfiguration
{
    ...
    public static string SSFWSessionIdKey { get; set; } =
        StringUtils.GenerateRandomBase64KeyAsync().Result;
    public static string SSFWLayoutsFolder { get; set; } =
        $"{Directory.GetCurrentDirectory()}/static/layouts";
    public static string SSFWStaticFolder { get; set; } =
        $"{Directory.GetCurrentDirectory()}/static/wwwssfwroot";
    public static string HTTPSCertificateFile { get; set; } =
        $"{Directory.GetCurrentDirectory()}/static/SSL/SSFW.pfx";
    ...
    public static string ScenelistFile { get; set; } =
        $"{Directory.GetCurrentDirectory()}/static/wwwssfwroot/SceneList.xml";
    ...
    public static readonly ConcurrentBag<string> homeEnvs =
    [
        "cprod",
        "cprodts",
        "cpreprod",
