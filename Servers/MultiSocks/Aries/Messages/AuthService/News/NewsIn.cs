...
namespace MultiSocks.Aries.Messages.AuthService.News
{
    public class NewsIn : AbstractMessage
    {
        ...
        public override void Process(AbstractAriesServer context, AriesClient client)
        {
            ...
            string? NAME = GetInputCacheValue("NAME") ?? string.Empty;

            if (NAME == "client.cfg") // BOP
            {
                if ("PS3".Equals(context.SKU))
                {
            ...
            {
                if (!string.IsNullOrEmpty(context.Project) && (context.Project.Contains("PS2/MM06") || context.Project.Contains("MARVEL06")))
