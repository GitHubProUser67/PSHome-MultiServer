namespace MultiSocks.Aries.Components.AuthService.News.Burnout
{
    public class BOPNewsOut : AbstractMessage
    {
        ...
        public string? EACONNECT_WEBOFFER_URL { get; set; } =
        ...
        public string? CAR_OLD_ROAD_RULES_TAGFIELD { get; set; } =
            "\"RULES,RULES1,RULES2,RULES3,RULES4,RULES5,RULES6,RULES7,RULES8,RULES9,RULES10,RULES11,RULES12,RULES13,RULES14,RULES15,RULES16\"";
        public string? CAR_ROAD_RULES_TAGFIELD { get; set; } = "\"RULES17\"";
        public string? BIKE_DAY_OLD_ROAD_RULES_TAGFIELD { get; set; } =
            "\"BIKEDAYRULES1,BIKEDAYRULES2\"";
        public string? BIKE_DAY_ROAD_RULES_TAGFIELD { get; set; } = "\"BIKEDAYRULES3\"";
        public string? BIKE_NIGHT_OLD_ROAD_RULES_TAGFIELD { get; set; } =
            "\"BIKENIGHTRULES1,BIKENIGHTRULES2\"";
        ...
        public string? FEVER_CARRIERS { get; set; } =
            "FritzBraun,EricWimp,Matazone,NutKC,FlufflesDaBunny,Flinnster,Molen,LingBot,DDangerous,Technocrat,The PLB,Chipper1977,Bazmobile,CustardKid,The Wibbler,AlexBowser,Blanks 82,Maxreboh,Jackhamma,MajorMajorMajor,Riskjockey,ChiefAV,Charnjit,Zietto,BurntOutDave,Belj,Cupster,Krisis1969,OrangeGopher,Phaigoman,Drastic Surgeon,Tom Underdown,Discodoktor,Cargando,Gaztech,PompeyPaul,TheSoldierBoy,louben17,Colonel Gambas,EliteBeatAgent,Uaintdown,SynergisticFX,InfamousGRouse,EAPR,EAPR 02,Jga360 JP2,EAJproduct";
        ...
        public string? BUNDLE_PATH { get; set; } =
            "\"http://gos.ea.com/easo/editorial/Burnout/2008/livedata/bundle/\"";
        public string? NEWS_DATE { get; set; } = "2008.6.11 21:00:00";
        public string? NEWS_URL { get; set; }
        public string? AVAIL_DLC_URL { get; set; } =
            "\"http://gos.ea.com/easo/editorial/Burnout/2008/livedata/Ents.txt\" ";
        public string? AVATAR_URL { get; set; } =
            "\"http://www.criteriongames.com/pcstore/avatar.php?persona=%s\"";
        ...
        public string? ETOKEN_URL { get; set; } =
            "\"http://gos.ea.com/easo/editorial/common/2008/nucleus/nkeyToNucleusEncryptedToken.jsp?nkey=%s&signature=%s\"";
        public string? USE_ETOKEN { get; set; } = "0";
        public string? LIVE_NEWS_URL { get; set; }
        public string? LIVE_NEWS2_URL { get; set; }
        public string? PRODUCT_DETAILS_URL { get; set; } =
            "\"http://pctrial.burnoutweb.ea.com/t2b/page/ofb_pricepoints.php?productID=%s&env=live\"";
        public string? PRODUCT_SEARCH_URL { get; set; } =
            "\"http://pctrial.burnoutweb.ea.com/t2b/page/ofb_DLCSearch.php?env=live\"";
    }
}
