...
namespace ApacheNet.BuildIn.RouteHandlers.GameRoutes
{
    ...
    {
        #region Domains
        public readonly static List<string> HPDDomains =
        [
        ...
        public static readonly List<string> CAPONEDomains =
        [
        ...
        public static readonly List<string> nDreamsDomains =
        [
            "pshome.ndreams.net",
            "www.ndreamshs.com",
        ...
        public static readonly List<string> HellFireGamesDomains =
        [
        ...
        public static readonly List<string> HTSDomains = ["samples.hdk.scee.net"];

        public static readonly List<string> ILoveSonyDomains = ["www.myresistance.net"];

        #endregion

        public static List<Route> frontend =
        [
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    if (!File.Exists(ctx.FilePath))
                    {
                        ...
                        return ctx
                            .Response.Send(
                                Path.GetFileName(ctx.FilePath)?.StartsWith("clientconfig0001")
                                == true
                                    ? ClientConfig0001.GenerateXML()
                                    : CoreHztFmpQrx0002.GenerateXML()
                            )
                            .Result;
                    }
                    return false;
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    try
                    {
                        var instanceId = ctx.Request.DataAsString;
                        if (instanceId.Length == 21)
                        {
                            // Parse World ID (8 hex)
                            var worldId = uint.Parse(instanceId[..8], NumberStyles.HexNumber);

                            // Parse Local ID (5 decimal)
                            var localId = int.Parse(instanceId.Substring(8, 5));

                            // Parse Packed Address (8 hex)
                            var Address = InternetProtocolUtils.GetIPAddressFromUInt(
                                uint.Parse(instanceId.Substring(13, 8), NumberStyles.HexNumber)
                            );
            ...
            new()
            {
                ...
                Method = "POST",
                Hosts = ["master10.doublefusion.com"],
                Callable = (ctx) =>
                {
            ...
            new()
            {
                ...
                Method = "GET",
                Hosts = ["onlineconfigservice.ubi.com"],
                Callable = (ctx) =>
                {
                    ctx.Response.StatusCode = (int)HttpStatusCode.OK;
                    ctx.Response.ContentType = "application/json; charset=utf-8";
                    return ctx
                        .Response.Send(
                            JsonData.GetOnlineConfigPSN(
                                ctx.Request.RetrieveQueryValue("onlineConfigID")
                            )
                        )
                        .Result;
                },
            ...
            new()
            {
                ...
                Method = "GET",
                Hosts = ["gconnect.ubi.com"],
                Callable = (ctx) =>
                {
                    var action = ctx.Request.RetrieveQueryValue("action");
                    var gid = ctx.Request.RetrieveQueryValue("gid");
                    var locale = ctx.Request.RetrieveQueryValue("locale");
                    var format = ctx.Request.RetrieveQueryValue("format");
                                            ...
                                            default:
                                                if (format == "xml")
                                                {
                                                    ...
                                                    ctx.Response.ContentType =
                                                        "text/html; charset=utf-8"; // Not an error, packet shows this content type...
                                                    return ctx
                                                        .Response.Send(
                                                            XMLData.DFS_PS3_NTSC_EN_XMLPayload
                                                        )
                                                        .Result;
                                                }
                                                break;
                                            ...
                                            default:
                                                if (format == "xml")
                                                {
                                                    ...
                                                    ctx.Response.ContentType =
                                                        "text/html; charset=utf-8"; // Not an error, packet shows this content type...
                                                    return ctx
                                                        .Response.Send(XMLData.DFS_PC_EN_XMLPayload)
                                                        .Result;
                                                }
                                                break;
                                        }
                                            ...
                                            default:
                                                if (format == "xml")
                                                {
                                                    ...
                                                    ctx.Response.ContentType =
                                                        "text/html; charset=utf-8"; // Not an error, packet shows this content type...
                                                    return ctx
                                                        .Response.Send(XMLData.PB_PS3_EN_XMLPayload)
                                                        .Result;
                                                }
                                                break;
                                        }
            ...
            new()
            {
                ...
                UrlRegex = "^/index.php",
                Method = "POST",
                Hosts = ["sonyhome.thqsandbox.com"],
                Callable = (ctx) =>
                {
                    var UFCResult = UFC2010PsHomeClass.ProcessUFCUserData(
                        ctx.Request.DataAsBytes,
                        HTTPProcessor.ExtractBoundary(ctx.Request.ContentType),
                        ApacheNetServerConfiguration.APIStaticFolder
                    );
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    var RCHOMEResult = new RCHOMEClass(
            ...
            new()
            {
                ...
                Method = "POST",
                Hosts = ["ec2-174-129-44-204.compute-1.amazonaws.com"],
                Callable = (ctx) =>
                {
                    var COGSResult = new COGSClass(
                        ctx.Request.Method.ToString(),
                        ApacheNetServerConfiguration.APIStaticFolder
                    ).ProcessRequest(ctx.Request.DataAsBytes, ctx.Request.ContentType);
            ...
            new()
            {
                ...
                Method = "POST",
                Hosts = ["sonyhome.codeglue.com"],
                Callable = (ctx) =>
                {
                    var Wipoeut2DResult = new WipeoutShooterClass(
                        ctx.Request.Method.ToString(),
                        ApacheNetServerConfiguration.APIStaticFolder
                    ).ProcessRequest(
                        HTTPProcessor.GetQueryParameters(
                            HTTPProcessor.DecodeUrl(ctx.Request.Url.RawWithQuery)
                        ),
                        ctx.Request.DataAsBytes,
            ...
            new()
            {
                ...
                Method = "POST",
                Hosts = ["homeleaderboards.software.eu.playstation.com"],
                Callable = (ctx) =>
                {
                    var EntryBareResult = HOMELEADERBOARDSClass.ProcessEntryBare(
                        ctx.Request.DataAsBytes,
                        HTTPProcessor.ExtractBoundary(ctx.Request.ContentType),
                        ApacheNetServerConfiguration.APIStaticFolder
                    );
            ...
            new()
            {
                ...
                Method = "GET",
                Hosts = ["ndreams.stats.s3.amazonaws.com"],
                Callable = (ctx) =>
                {
                    ctx.Response.StatusCode = (int)HttpStatusCode.OK;
                    ctx.Response.ContentType = "text/xml";
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    return ctx
                        .Response.Send(
                            File.Exists(ctx.FilePath)
                                ? File.ReadAllText(ctx.FilePath)
                                : HTTPProcessor.RequestURLGET(
                                    $"https://{ctx.GetHost()}{ctx.Request.Url.RawWithQuery}",
                                    true
                                )
                        )
                        .Result;
        ...
        public static List<Route> backend =
        [
            new()
            {
                Name = "VEEMEE API",
                ...
                Callable = (ctx) =>
                {
                    ...
                    if (
                        (
                            (
                                ctx.AbsolutePath.EndsWith(".php")
                                && Directory.Exists(ApacheNetServerConfiguration.PHPStaticFolder)
                            ) || ctx.AbsolutePath.EndsWith(".xml")
                        ) && (File.Exists(ctx.FilePath) || File.Exists(ctx.ApiPath))
                    )
                    {
                    ...
                    {
                        var res = new VEEMEEClass(
                            ctx.Request.Method.ToString(),
                            ctx.AbsolutePath
                        ).ProcessRequest(
                            ctx.Request.ContentLength > 0 ? ctx.Request.DataAsBytes : null,
                            ctx.Request.ContentType,
                            ApacheNetServerConfiguration.APIStaticFolder
                        );
                        ...
                        ctx.Response.ContentType = !string.IsNullOrEmpty(res.Item2)
                            ? res.Item2
                            : "text/plain";
                        return ctx.Response.ChunkedTransfer
                            ? ctx.Response.SendChunk(res.Item1, true).Result
                            : ctx.Response.Send(res.Item1).Result;
                    }
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    {
                        var res = new NDREAMSClass(
                            ctx.CurrentDate,
                            ctx.Request.Method.ToString(),
                            ctx.ApiPath,
                            $"{(ctx.Secure ? "https" : "http")}://nDreams-multiserver-cdn/",
                            $"{(ctx.Secure ? "https" : "http")}://{ctx.GetHost()}{ctx.FullUrl}",
                            ctx.AbsolutePath,
                            ApacheNetServerConfiguration.APIStaticFolder,
                            ctx.GetHost()
                        ).ProcessRequest(
                            ctx.Request.Query.Elements.ToDictionary(),
                            ctx.Request.DataAsBytes,
                            ctx.Request.ContentType
                        );
                        ...
                        return ctx.Response.ChunkedTransfer
                            ? ctx
                                .Response.SendChunk(
                                    !string.IsNullOrEmpty(res) ? Encoding.UTF8.GetBytes(res) : null,
                                    true
                                )
                                .Result
                            : ctx.Response.Send(res).Result;
                    }
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    else
                    {
                        ...
                        ctx.Response.StatusCode = (int)statusCode;
                        return ctx.Response.ChunkedTransfer
                            ? ctx.Response.SendChunk(res, true).Result
                            : ctx.Response.Send(res).Result;
                    }
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    ctx.Response.StatusCode = (int)statusCode;
                    return ctx.Response.ChunkedTransfer
                        ? ctx.Response.SendChunk(Encoding.UTF8.GetBytes(res), true).Result
                        : ctx.Response.Send(res).Result;
                },
            },
            new()
            {
                ...
                [
                    ...
                    "www.outso-srv1.com",
                    "ec2-184-72-239-107.compute-1.amazonaws.com",
                ],
                Callable = (ctx) =>
                {
                    HttpStatusCode statusCode;
                    ...
                    if (!ctx.Secure)
                    {
                        var versionMap = new Dictionary<int, (string, bool)[]>
                        {
                            [2] =
                            [
                    ...
                    var res = new OHSClass(
                        ctx.Request.Method.ToString(),
                        absolutepath,
                        version ?? 0
                    ).ProcessRequest(ctx.Request.DataAsBytes, ctx.Request.ContentType, ctx.ApiPath);
                    if (string.IsNullOrEmpty(res))
                    {
                        ctx.Response.ContentType = "text/plain";
                        statusCode = HttpStatusCode.InternalServerError;
            ...
            {
                Name = "OUWF Debug API",
                Hosts = ["ouwf.outso-srv1.com"],
                Callable = (ctx) =>
                {
                    HttpStatusCode statusCode;
                    ctx.Response.ChunkedTransfer = ApacheContext.AcceptChunked;

                    var res = new OuWFClass(
                        ctx.Request.Method.ToString(),
                        ctx.AbsolutePath,
            ...
            {
                Name = "LOOT API",
                Hosts = ["server.lootgear.com", "alpha.lootgear.com"],
                Callable = (ctx) =>
                {
                    HttpStatusCode statusCode;
                    ctx.Response.ChunkedTransfer = ApacheContext.AcceptChunked;

                    var res = new LOOTClass(
                        ctx.Request.Method.ToString(),
                        ctx.AbsolutePath,
                        ApacheNetServerConfiguration.APIStaticFolder
                    ).ProcessRequest(
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    {
                        string? res = null;
                        JUGGERNAUTClass juggernaut = new(
                            ctx.Request.Method.ToString(),
                            ctx.AbsolutePath
                        );
                        res =
                            ctx.Request.ContentLength > 0
                                ? juggernaut.ProcessRequest(
                                    HTTPProcessor.GetQueryParameters(ctx.FullUrl),
                                    ApacheNetServerConfiguration.APIStaticFolder,
                                    ctx.Request.DataAsBytes,
                                    ctx.Request.ContentType
                                )
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    var res = new PREMIUMAGENCYClass(
                        ctx.Request.Method.ToString(),
                        ctx.AbsolutePath,
                        ApacheNetServerConfiguration.APIStaticFolder,
                        ctx.FullUrl
            ...
            new()
            {
                ...
                Hosts = ["acvd-ps3ww-cdn.fromsoftware.jp"],
                Callable = (ctx) =>
                {
                    HttpStatusCode statusCode;
                    ctx.Response.ChunkedTransfer = ApacheContext.AcceptChunked;

                    (byte[]?, string?, string[][]?) res = res = new FROMSOFTWAREClass(
                        ctx.Request.Method.ToString(),
                        ctx.AbsolutePath,
                        ApacheNetServerConfiguration.APIStaticFolder
                    ).ProcessRequest(ctx.Request.DataAsBytes, ctx.Request.ContentType);
                    ...
                    if (
                        res.Item1 == null
                        || string.IsNullOrEmpty(res.Item2)
                        || res.Item3?.Length == 0
                    )
                        statusCode = HttpStatusCode.InternalServerError;
                    else
                    {
                        ...
                        statusCode = HttpStatusCode.OK;
                        foreach (var innerArray in res.Item3!)
                        {
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    var Authorization = ctx.Request.RetrieveHeaderValue("Authorization");
                    ...
                    if (!string.IsNullOrEmpty(Authorization))
                    {
                        ...
                        {
                            (bool, byte[]) base64Data = Authorization
                                .Replace("psn t=", string.Empty)
                                .IsBase64();

                            if (base64Data.Item1)
                            {
                                // get ticket
                                var ticket = XI5Ticket.ReadFromBytes(base64Data.Item2);
                                ...
                                if (!ticket.Valid)
                                {
                                    ...
                                    LoggerAccessor.LogWarn(
                                        $"[HERMES] - User {username} tried to alter their ticket data"
                                    );
                                ...
                                if (ticket.IsSignedByRPCN)
                                    LoggerAccessor.LogInfo(
                                        $"[HERMES] - User {username} connected at: {DateTime.Now} and is on RPCN"
                                    );
                                else if (username.EndsWith($"@{XI5Ticket.RPCNSigner}"))
                                {
                                    LoggerAccessor.LogError(
                                        $"[HERMES] - User {username} was caught using a RPCN suffix while not on it!"
                                    );
                                    ...
                                    LoggerAccessor.LogInfo(
                                        $"[HERMES] - User {username} connected at: {DateTime.Now} and is on PSN"
                                    );
                            }
                        }
                        ...
                        var res = new HERMESClass(
                            ctx.Request.Method.ToString(),
                            ctx.AbsolutePath,
                            ctx.Request.RetrieveHeaderValue("Ubi-AppId"),
                            ctx.Request.RetrieveHeaderValue("Ubi-RequestedPlatformType"),
                            ctx.Request.RetrieveHeaderValue("ubi-appbuildid"),
                            ctx.ClientIP,
                            GeoIP.GetISOCodeFromIP(IPAddress.Parse(ctx.ClientIP)),
                            Authorization.Replace("psn t=", string.Empty),
                            ApacheNetServerConfiguration.APIStaticFolder
                        ).ProcessRequest(ctx.Request.DataAsBytes, ctx.Request.ContentType);
                        ...
                        else
                        {
                            ...
                            ctx.Response.Headers.Add(
                                "Ubi-Forwarded-By",
                                "ue1-p-us-public-nginx-056b582ac580ba328"
                            );
                            ctx.Response.Headers.Add(
                                "Ubi-TransactionId",
                        ...
                        return ctx.Response.ChunkedTransfer
                            ? ctx
                                .Response.SendChunk(
                                    !string.IsNullOrEmpty(res.Item1)
                                        ? Encoding.UTF8.GetBytes(res.Item1)
                                        : null,
                                    true
                                )
                                .Result
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    res =
                        ctx.Request.ContentLength > 0
                            ? gsconn.ProcessRequest(
                                ctx.Request.Query.Elements.ToDictionary(),
                                ctx.Request.DataAsBytes,
                                ctx.Request.ContentType
                            )
                            : gsconn.ProcessRequest(ctx.Request.Query.Elements.ToDictionary());
                    ...
                    else
                    {
                        ...
                        if (res.Item3 != null)
                        {
                            foreach (var header in res.Item3)
                            {
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    var res = new CAPONEClass(
                        ctx.Request.Method.ToString(),
                        ctx.AbsolutePath,
                        ApacheNetServerConfiguration.APIStaticFolder
                    ).ProcessRequest(ctx.Request.DataAsBytes, ctx.Request.ContentType, ctx.Secure);
                    if (string.IsNullOrEmpty(res))
                    {
                        ctx.Response.ContentType = "text/plain";
                        statusCode = HttpStatusCode.InternalServerError;
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    var res =
                        WebAPIService.GameServices.PSHOME.NDREAMS.Xi1.StatusBuilder.BuildStatusXml();
                    ctx.Response.Headers.Add("Date", DateTime.Now.ToString("r"));
                    ctx.Response.ContentType = "text/xml";
            ...
            new()
            {
                ...
                Callable = (ctx) =>
                {
                    ...
                    else
                    {
                        ...
                        ctx.Response.ContentType = "text/plain";
                        return ctx.Response.ChunkedTransfer
                            ? ctx.Response.SendChunk(Encoding.UTF8.GetBytes("false"), true).Result
                            : ctx.Response.Send("false").Result;
                    }
