...
namespace Horizon.DME.Extensions.PSHome
{
    public class NewIGA
    {
        ...
        private static readonly byte[] KickCMD = new byte[]
        {
            0x02,
            0x0B,
            0x00,
        ...
        private static readonly byte[] ReleaseCMD = new byte[]
        {
            0x02,
            0x0B,
            0x00,
        ...
        private static readonly byte[] MuteCMD = new byte[]
        {
            0x02,
            0x0B,
            0x00,
        ...
        private static readonly byte[] MuteNFreezeCMD = new byte[]
        {
            0x02,
            0x0B,
            0x00,
        ...
        private static readonly byte[] FreezeCMD = new byte[]
        {
            0x02,
            0x0B,
            0x00,
        ...
        {
            var homeDmeServer = retail
                ? Program.DmeServer.GetServerPerAppId(20374)
                : Program.DmeServer.GetServerPerAppId(20371);
            if (homeDmeServer != null && homeDmeServer.DmeWorld != null)
            {
                var worldToSearchIn = World.GetWorldByMediusWorldId(WorldId);
                var client = worldToSearchIn?.Clients.FirstOrDefault(c => c.DmeId == DmeId);
                if (client != null)
                {
                    _ = Task.Run(() =>
                    {
                        var payload = new byte[KickCMD.Length];
                        Array.Copy(KickCMD, 0, payload, 0, payload.Length);
                        payload[6] =
                            client.mumClient.ProtocolVersion != byte.MaxValue
                                ? client.mumClient.ProtocolVersion
        ...
        public static string ReleaseClient(short DmeId, int WorldId, bool retail)
        {
            ...
            if (homeDmeServer != null && homeDmeServer.DmeWorld != null)
            {
                ...
                if (client != null)
                {
                    _ = Task.Run(() =>
                    {
                        var payload = new byte[ReleaseCMD.Length];
        ...
        public static string MuteClient(short DmeId, int WorldId, bool retail)
        {
            ...
            if (homeDmeServer != null && homeDmeServer.DmeWorld != null)
            {
                ...
                if (client != null)
                {
                    _ = Task.Run(() =>
                    {
                        var payload = new byte[MuteCMD.Length];
        ...
        public static string MuteAndFreezeClient(short DmeId, int WorldId, bool retail)
        {
            ...
            if (homeDmeServer != null && homeDmeServer.DmeWorld != null)
            {
                ...
                if (client != null)
                {
                    _ = Task.Run(() =>
                    {
                        var payload = new byte[MuteNFreezeCMD.Length];
        ...
        public static string FreezeClient(short DmeId, int WorldId, bool retail)
        {
            ...
            if (homeDmeServer != null && homeDmeServer.DmeWorld != null)
            {
                ...
                if (client != null)
                {
                    _ = Task.Run(() =>
                    {
                        var payload = new byte[FreezeCMD.Length];
