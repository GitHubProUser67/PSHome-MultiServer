...
partial class SoftFloatSpecialize
{
    public sealed class X86 : SoftFloatSpecialize
    {
        ...
        internal override SpecializeNaNIntegerKind UInt32NaNKind =>
            SpecializeNaNIntegerKind.NaNIsPosAndNegOverflow;
        ...
        )
        {
            ...
            return uiMagA < uiMagB ? (ushort)uiNonsigB
                : uiMagB < uiMagA ? (ushort)uiNonsigA
                : (ushort)((uiNonsigA < uiNonsigB) ? uiNonsigA : uiNonsigB);
        }
        ...
        )
        {
            ...
            return uiMagA < uiMagB ? uiNonsigB
                : uiMagB < uiMagA ? uiNonsigA
                : (uiNonsigA < uiNonsigB) ? uiNonsigA
                : uiNonsigB;
        }
        ...
        public override UInt128 DefaultNaNExtFloat80Bits =>
            new(upper: 0xFFFF, lower: 0xC000000000000000);
        ...
        public override UInt128 DefaultNaNFloat128Bits =>
            new(upper: 0xFFFF800000000000, lower: 0x0000000000000000);
