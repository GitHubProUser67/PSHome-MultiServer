...
partial class SoftFloatSpecialize
{
    public sealed class ArmVfp2DefaultNaN : SoftFloatSpecialize
    {
        ...
        internal override SpecializeNaNIntegerKind UInt32NaNKind =>
            SpecializeNaNIntegerKind.NaNIsNegOverflow;

        internal override SpecializeNaNIntegerKind Int32NaNKind =>
            SpecializeNaNIntegerKind.NaNIsUnique;
        ...
        public override void Float16BitsToCommonNaN(
        ...
        public override ushort CommonNaNToFloat16Bits(in SoftFloatCommonNaN commonNaN) =>
            DefaultNaNFloat16Bits;

        public override ushort PropagateNaNFloat16Bits(
            SoftFloatContext context,
            uint bitsA,
            uint bitsB
        )
        ...
        public override void Float32BitsToCommonNaN(
            SoftFloatContext context,
            uint bits,
            out SoftFloatCommonNaN commonNaN
        )
        ...
        public override uint CommonNaNToFloat32Bits(in SoftFloatCommonNaN commonNaN) =>
            DefaultNaNFloat32Bits;

        public override uint PropagateNaNFloat32Bits(
            SoftFloatContext context,
            uint bitsA,
            uint bitsB
        )
        ...
        public override void Float64BitsToCommonNaN(
            SoftFloatContext context,
            ulong bits,
            out SoftFloatCommonNaN commonNaN
        )
        ...
        public override ulong CommonNaNToFloat64Bits(in SoftFloatCommonNaN commonNaN) =>
            DefaultNaNFloat64Bits;

        public override ulong PropagateNaNFloat64Bits(
            SoftFloatContext context,
            ulong bitsA,
            ulong bitsB
        )
        ...
        public override UInt128 DefaultNaNExtFloat80Bits =>
            new(upper: 0x7FFF, lower: 0xC000000000000000);

        public override void ExtFloat80BitsToCommonNaN(
            SoftFloatContext context,
            uint bits64,
            ulong bits0,
            out SoftFloatCommonNaN commonNaN
        ...
        public override UInt128 CommonNaNToExtFloat80Bits(in SoftFloatCommonNaN commonNaN) =>
            DefaultNaNExtFloat80Bits;

        public override UInt128 PropagateNaNExtFloat80Bits(
            SoftFloatContext context,
            uint bitsA64,
            ulong bitsA0,
            uint bitsB64,
        ...
        {
            if (
                IsSignalingNaNExtFloat80Bits(bitsA64, bitsA0)
                || IsSignalingNaNExtFloat80Bits(bitsB64, bitsB0)
            )
                context.RaiseFlags(ExceptionFlags.Invalid);
        ...
        public override UInt128 DefaultNaNFloat128Bits =>
            new(upper: 0x7FFF800000000000, lower: 0x0000000000000000);

        public override void Float128BitsToCommonNaN(
            SoftFloatContext context,
            ulong bits64,
            ulong bits0,
            out SoftFloatCommonNaN commonNaN
        ...
        public override UInt128 CommonNaNToFloat128Bits(in SoftFloatCommonNaN commonNaN) =>
            DefaultNaNFloat128Bits;

        public override UInt128 PropagateNaNFloat128Bits(
            SoftFloatContext context,
            ulong bitsA64,
            ulong bitsA0,
            ulong bitsB64,
        ...
        {
            if (
                IsSignalingNaNFloat128Bits(bitsA64, bitsA0)
                || IsSignalingNaNFloat128Bits(bitsB64, bitsB0)
            )
                context.RaiseFlags(ExceptionFlags.Invalid);
