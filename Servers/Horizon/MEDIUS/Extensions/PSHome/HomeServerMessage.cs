...
namespace Horizon.MEDIUS.Extensions.PSHome
{
    public static class HomeServerMessage
    {
        ...
        internal static byte[] ModeratorBroadcastMessageCmd = BitConverter.GetBytes(
            EndianTools.EndianAwareConverter.isLittleEndianSystem
                ? EndianTools.EndianUtils.ReverseUshort(10)
                : (ushort)10
        );
        ...
        private static Task<bool> SendCommand(
        ...
        {
            return string.IsNullOrEmpty(regionCode) || regionCode.Length != 4
                ? Task.FromResult(false)
                : HomeRTMTools.SendRemoteCommand(
                    targetClientIp,
                    accessToken,
                    (lc ? LcRexecMsgPrefix : RexecMsgPrefix)
                        + Base64.ToBase64String(
                            ByteUtils.CombineByteArrays(
                                Encoding.ASCII.GetBytes(regionCode),
                                cmd,
                                payload
                            )
                        )
        ...
        private static Task<bool> BroadcastCommand(
            string? regionCode,
            byte[] cmd,
            byte[] payload,
            bool lc,
        ...
        )
        {
            return string.IsNullOrEmpty(regionCode) || regionCode.Length != 4
                ? Task.FromResult(false)
                : HomeRTMTools.BroadcastRemoteCommand(
                    (lc ? LcRexecMsgPrefix : RexecMsgPrefix)
                        + Base64.ToBase64String(
                            ByteUtils.CombineByteArrays(
                                Encoding.ASCII.GetBytes(regionCode),
        ...
        private static Task<bool> SendAdminMessageCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            int worldId,
                                ...
                                ByteUtils.CombineByteArray(
                                    ...
                                    EndianTools.EndianAwareConverter.isLittleEndianSystem
                                        ? EndianTools.EndianUtils.EndianSwap(
                                            BitConverter.GetBytes(worldId)
                                        )
                                        : BitConverter.GetBytes(worldId)
                                ),
                                ByteUtils.CombineByteArray(
                                    "00 44 45 56 00 4D 55 4C 54 49 53 45 52 56 45 52 00".HexStrToBytes(),
                                    ByteUtils.CombineByteArray(
        ...
        private static Task<bool> BroadcastAdminMessageCommand(
            string? regionCode,
            string payload,
            bool lc,
            bool retail
                    ...
                    (lc ? LcRexecMsgPrefix : RexecMsgPrefix)
                        + Base64.ToBase64String(
                            ByteUtils.CombineByteArrays(
                                Encoding.ASCII.GetBytes(regionCode),
                                ByteUtils.CombineByteArray(
                                    ModeratorBroadcastMessageCmd,
                                    "44455600".HexStrToBytes()
                                ),
                                ByteUtils.CombineByteArray(
                                    "4D 55 4C 54 49 53 45 52 56 45 52 00".HexStrToBytes(),
                                    ByteUtils.CombineByteArray(
                                        Encoding.UTF8.GetBytes(payload),
                                        Encoding.ASCII.GetBytes("\0")
                                    )
        ...
        public static Task<bool> SendAdminMessage(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            int worldId,
        ...
        public static Task<bool> BroadcastAdminMessage(
            string? regionCode,
            string message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendLogOffCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastLogOffCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendSimpleRelocate(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastSimpleRelocate(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendAdvancedRelocate(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastAdvancedRelocate(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendAdminModeCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastAdminModeCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendStealthModeCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastStealthModeCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendStickUserCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastStickUserCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendFastMoveCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastFastMoveCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendActivateAppCommand(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastActivateAppCommand(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
        ...
        public static Task<bool> SendModeratorBroadcastMessage(
            string targetClientIp,
            string? accessToken,
            string? regionCode,
            byte[] message,
        ...
        public static Task<bool> BroadcastModeratorBroadcastMessage(
            string? regionCode,
            byte[] message,
            bool lc,
            bool retail
