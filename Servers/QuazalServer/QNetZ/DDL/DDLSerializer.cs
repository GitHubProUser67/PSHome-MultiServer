...
namespace QuazalServer.QNetZ.DDL
{
    public class DDLSerializer
    {
        ...
        public static T? ReadObject<T>(Stream s)
            where T : class
        {
        ...
        public static object? ReadObject(Type currentType, Stream str)
        {
            ...
            else if (currentType == typeof(byte[])) // This is Quazal.Buffer with 32 bit size
            {
                ...
                var arrayLen = Helper.ReadU32(str);
            ...
            {
                var newObjectFunc = Expression
                    .Lambda<Func<IAnyData>>(
            ...
            else // read complex object
            {
                ...
                var allPropertyTypes = allProperties.Select(x =>
                    x.CanWrite ? x.PropertyType : null
                );
        ...
        public static void WriteObject<T>(T obj, Stream s)
            where T : class
        {
