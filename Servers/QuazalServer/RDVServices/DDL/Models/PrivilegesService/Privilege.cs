namespace QuazalServer.RDVServices.DDL.Models
{
    ...
    public static class DeluxePrivileges
    {
        ...
        public static Privilege[] ChallengeIds = new Privilege[]
        {
            ...
            new(1, "Unique Challenge - Team Colors Tutorial"),
            new(2, "Unique Challenge - Smoke Trail"),
            new(3, "Unique Challenge - Relay Race"),
            new(4, "Unique Challenge - Mass Chase"),
            // new Privilege(5, "Unique Vehicle"), // not defined in the game's Lua!
            new(6, "Uplay Challenge - Time Trial"),
            new(7, "Uplay Challenges"),
        };
        public static Privilege[] VehicleIds = new Privilege[]
        {
            new(8, "2010 Chevrolet Camaro SS"),
            new(9, "1966 Shelby Cobra 427"),
            new(10, "1972 Lamborghini Miura"),
            new(11, "1963 Aston Martin DB5"),
            new(12, "1968 Ford Mustang Fastback GT390"),
            new(13, "2009 Alfa Romeo Mito"),
            new(14, "1959 Cadillac Eldorado"),
            new(15, "1973 Chevrolet El Camino"),
            new(16, "1963 Volkswagen Kafer/Beetle"),
            new(17, "1959 Cadillac Eldorado in Purple Royal"),
        };
    }
}
