namespace QuazalServer.RDVServices.DDL.Models
{
    ...
    public class StatisticsBoardValue
    {
        ...
        public StatisticsBoardValue(StatisticDesc desc)
            : this()
        {
            value.typeValue =
                sliceScore.typeValue =
                scoreLostForNextSlice.typeValue =
                    (byte)desc.statType;
        }

        public StatisticsBoardValue(StatisticValueVariant initialValue)
            : this()
        {
            value = initialValue;
        }
