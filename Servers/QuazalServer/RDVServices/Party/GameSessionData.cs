...
namespace QuazalServer.RDVServices
{
    public static class GameSessions
    {
        ...
        public static void UpdateSessionParticipation(
            PlayerInfo playerInfo,
            GameSessionKey? newSessionKey,
            bool privateSlot
        )
        {
            ...
            if (newSessionKey != null)
            {
                ...
                if (newSession != null)
                {
                    ...
                    newSession.Attributes[(uint)GameSessionAttributeType.FilledPrivateSlots] =
                        (uint)newSession.Participants.Count;
                }
            }
            ...
            SessionList.RemoveAll(gathering =>
            {
                ...
                LoggerAccessor.LogInfo(
                    $"[GameSessionData] - UpdateSessionParticipation: Auto-deleted session {gathering.Id}"
                );
                return true;
            });
    ...
    public class GameSessionData
    {
        ...
        {
            get => Participants.Count + PublicParticipants.Count;
        }
        public uint[] AllParticipants
        {
            get => Participants.Concat(PublicParticipants).ToArray();
        }
    }
}
